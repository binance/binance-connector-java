...
public class GetOptionTransactionHistoryDownloadLinkByIdExample {
     ...
     */
    public void getOptionTransactionHistoryDownloadLinkByIdExample() throws ApiException {
        String downloadId = "1";
        Long recvWindow = 5000L;
        ApiResponse<GetOptionTransactionHistoryDownloadLinkByIdResponse> response =
                getApi().getOptionTransactionHistoryDownloadLinkById(downloadId, recvWindow);
