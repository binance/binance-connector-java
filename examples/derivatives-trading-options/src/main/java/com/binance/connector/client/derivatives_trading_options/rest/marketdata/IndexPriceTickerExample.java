...
public class IndexPriceTickerExample {
     ...
     */
    public void indexPriceTickerExample() throws ApiException {
        String underlying = "";
        ApiResponse<IndexPriceTickerResponse> response = getApi().indexPriceTicker(underlying);
