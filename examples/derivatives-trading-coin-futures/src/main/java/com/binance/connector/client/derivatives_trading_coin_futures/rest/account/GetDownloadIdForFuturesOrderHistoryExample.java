...
public class GetDownloadIdForFuturesOrderHistoryExample {
     ...
     */
    public void getDownloadIdForFuturesOrderHistoryExample() throws ApiException, IOException {
        Long startTime = 1623319461670L;
        Long endTime = 1641782889000L;
        Long recvWindow = 5000L;
        ApiResponse<GetDownloadIdForFuturesOrderHistoryResponse> response =
                getApi().getDownloadIdForFuturesOrderHistory(startTime, endTime, recvWindow);
