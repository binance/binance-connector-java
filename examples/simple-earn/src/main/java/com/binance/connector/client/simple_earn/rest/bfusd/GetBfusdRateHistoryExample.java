...
public class GetBfusdRateHistoryExample {
     ...
     */
    public void getBfusdRateHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetBfusdRateHistoryResponse> response =
                getApi().getBfusdRateHistory(startTime, endTime, current, size, recvWindow);
