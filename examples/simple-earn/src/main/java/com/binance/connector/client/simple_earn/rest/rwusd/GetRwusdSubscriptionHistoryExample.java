...
public class GetRwusdSubscriptionHistoryExample {
     ...
     */
    public void getRwusdSubscriptionHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetRwusdSubscriptionHistoryResponse> response =
                getApi().getRwusdSubscriptionHistory(
