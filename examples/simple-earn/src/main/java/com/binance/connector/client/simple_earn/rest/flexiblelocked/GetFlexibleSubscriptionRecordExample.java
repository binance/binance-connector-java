...
public class GetFlexibleSubscriptionRecordExample {
     ...
     */
    public void getFlexibleSubscriptionRecordExample() throws ApiException, IOException {
        String productId = "1";
        String purchaseId = "1";
        String asset = "USDC";
        ...
        ApiResponse<GetFlexibleSubscriptionRecordResponse> response =
                getApi().getFlexibleSubscriptionRecord(
                                productId,
                                purchaseId,
                                asset,
                                startTime,
