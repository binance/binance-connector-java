...
public class GetLockedSubscriptionRecordExample {
     ...
     */
    public void getLockedSubscriptionRecordExample() throws ApiException, IOException {
        String purchaseId = "1";
        String asset = "USDC";
        ...
        ApiResponse<GetLockedSubscriptionRecordResponse> response =
                getApi().getLockedSubscriptionRecord(
