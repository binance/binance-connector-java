...
public class GetRwusdRewardsHistoryExample {
     ...
     */
    public void getRwusdRewardsHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetRwusdRewardsHistoryResponse> response =
                getApi().getRwusdRewardsHistory(startTime, endTime, current, size, recvWindow);
