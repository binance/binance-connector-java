...
public class GetBfusdRedemptionHistoryExample {
     ...
     */
    public void getBfusdRedemptionHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetBfusdRedemptionHistoryResponse> response =
                getApi().getBfusdRedemptionHistory(startTime, endTime, current, size, recvWindow);
