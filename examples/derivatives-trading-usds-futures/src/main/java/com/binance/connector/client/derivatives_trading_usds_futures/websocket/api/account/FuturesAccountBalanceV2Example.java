...
public class FuturesAccountBalanceV2Example {
    ...
    public void futuresAccountBalanceV2ExampleAsync() {
        ...
        CompletableFuture<FuturesAccountBalanceV2Response> future =
                getApi().futuresAccountBalanceV2(futuresAccountBalanceV2Request);
        future.handle(
                (response, error) -> {
                    if (error != null) {
    ...
    public void futuresAccountBalanceV2ExampleSync() {
        ...
        CompletableFuture<FuturesAccountBalanceV2Response> future =
                getApi().futuresAccountBalanceV2(futuresAccountBalanceV2Request);
        FuturesAccountBalanceV2Response response = future.join();
        System.out.println(response);
    }
}
