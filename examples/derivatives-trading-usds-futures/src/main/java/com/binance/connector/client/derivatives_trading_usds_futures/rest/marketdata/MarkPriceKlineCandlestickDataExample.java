...
public class MarkPriceKlineCandlestickDataExample {
     ...
     */
    public void markPriceKlineCandlestickDataExample() throws ApiException, IOException {
        ...
        ApiResponse<MarkPriceKlineCandlestickDataResponse> response =
                getApi().markPriceKlineCandlestickData(symbol, interval, startTime, endTime, limit);
