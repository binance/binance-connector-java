...
public class CmPositionAdlQuantileEstimationExample {
     ...
     */
    public void cmPositionAdlQuantileEstimationExample() throws ApiException, IOException {
        String symbol = "BTCUSD_201225";
        Long recvWindow = 5000L;
        ApiResponse<CmPositionAdlQuantileEstimationResponse> response =
                getApi().cmPositionAdlQuantileEstimation(symbol, recvWindow);
