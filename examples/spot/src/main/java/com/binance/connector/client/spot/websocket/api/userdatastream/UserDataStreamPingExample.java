...
public class UserDataStreamPingExample {
    ...
    public void userDataStreamPingExampleAsync() {
        ...
        userDataStreamPingRequest.listenKey("listenKey");
        CompletableFuture<UserDataStreamPingResponse> future =
                getApi().userDataStreamPing(userDataStreamPingRequest);
        future.handle(
                (response, error) -> {
                    if (error != null) {
    ...
    public void userDataStreamPingExampleSync() {
        ...
        CompletableFuture<UserDataStreamPingResponse> future =
                getApi().userDataStreamPing(userDataStreamPingRequest);
        UserDataStreamPingResponse response = future.join();
        System.out.println(response);
    }
}
