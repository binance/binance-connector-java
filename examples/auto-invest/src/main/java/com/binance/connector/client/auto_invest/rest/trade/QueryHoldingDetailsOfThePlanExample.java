...
public class QueryHoldingDetailsOfThePlanExample {
     ...
     */
    public void queryHoldingDetailsOfThePlanExample() throws ApiException {
        Long planId = 1L;
        String requestId = "1";
        Long recvWindow = 5000L;
        ApiResponse<QueryHoldingDetailsOfThePlanResponse> response =
                getApi().queryHoldingDetailsOfThePlan(planId, requestId, recvWindow);
