...
public class QueryOneTimeTransactionStatusExample {
     ...
     */
    public void queryOneTimeTransactionStatusExample() throws ApiException {
        Long transactionId = 1L;
        String requestId = "1";
        Long recvWindow = 5000L;
        ApiResponse<QueryOneTimeTransactionStatusResponse> response =
                getApi().queryOneTimeTransactionStatus(transactionId, requestId, recvWindow);
