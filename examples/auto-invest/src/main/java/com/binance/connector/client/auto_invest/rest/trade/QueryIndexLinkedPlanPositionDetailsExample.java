...
public class QueryIndexLinkedPlanPositionDetailsExample {
     ...
     */
    public void queryIndexLinkedPlanPositionDetailsExample() throws ApiException {
        Long indexId = 1L;
        Long recvWindow = 5000L;
        ApiResponse<QueryIndexLinkedPlanPositionDetailsResponse> response =
                getApi().queryIndexLinkedPlanPositionDetails(indexId, recvWindow);
