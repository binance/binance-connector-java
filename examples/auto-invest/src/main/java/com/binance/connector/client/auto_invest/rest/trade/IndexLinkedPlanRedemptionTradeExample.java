...
public class IndexLinkedPlanRedemptionTradeExample {
     ...
     */
    public void indexLinkedPlanRedemptionTradeExample() throws ApiException {
        Long requestId = 1L;
        ...
        ApiResponse<IndexLinkedPlanRedemptionTradeResponse> response =
                getApi().indexLinkedPlanRedemptionTrade(
