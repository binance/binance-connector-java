...
public class GetWbethWrapHistoryExample {
     ...
     */
    public void getWbethWrapHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetWbethWrapHistoryResponse> response =
                getApi().getWbethWrapHistory(startTime, endTime, current, size, recvWindow);
