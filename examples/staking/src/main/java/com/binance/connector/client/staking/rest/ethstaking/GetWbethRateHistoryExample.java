...
public class GetWbethRateHistoryExample {
     ...
     */
    public void getWbethRateHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetWbethRateHistoryResponse> response =
                getApi().getWbethRateHistory(startTime, endTime, current, size, recvWindow);
