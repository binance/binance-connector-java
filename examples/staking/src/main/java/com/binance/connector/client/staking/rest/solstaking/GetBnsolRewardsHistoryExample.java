...
public class GetBnsolRewardsHistoryExample {
     ...
     */
    public void getBnsolRewardsHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetBnsolRewardsHistoryResponse> response =
                getApi().getBnsolRewardsHistory(startTime, endTime, current, size, recvWindow);
