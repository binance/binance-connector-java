...
public class GetWbethRewardsHistoryExample {
     ...
     */
    public void getWbethRewardsHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetWbethRewardsHistoryResponse> response =
                getApi().getWbethRewardsHistory(startTime, endTime, current, size, recvWindow);
