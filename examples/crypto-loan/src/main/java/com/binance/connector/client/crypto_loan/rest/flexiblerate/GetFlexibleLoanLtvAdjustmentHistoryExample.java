...
public class GetFlexibleLoanLtvAdjustmentHistoryExample {
     ...
     */
    public void getFlexibleLoanLtvAdjustmentHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetFlexibleLoanLtvAdjustmentHistoryResponse> response =
                getApi().getFlexibleLoanLtvAdjustmentHistory(
                                loanCoin,
                                collateralCoin,
                                startTime,
                                endTime,
