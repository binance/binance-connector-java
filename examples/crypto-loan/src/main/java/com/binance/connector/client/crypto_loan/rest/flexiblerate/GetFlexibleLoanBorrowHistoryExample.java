...
public class GetFlexibleLoanBorrowHistoryExample {
     ...
     */
    public void getFlexibleLoanBorrowHistoryExample() throws ApiException, IOException {
        ...
        ApiResponse<GetFlexibleLoanBorrowHistoryResponse> response =
                getApi().getFlexibleLoanBorrowHistory(
                                loanCoin,
                                collateralCoin,
                                startTime,
                                endTime,
