package com.binance.connector.client.derivatives_trading_portfolio_margin_pro.websocket.stream.api;
...
import com.binance.connector.client.derivatives_trading_portfolio_margin_pro.websocket.stream.model.UserDataStreamEventsResponse;
...
public class DerivativesTradingPortfolioMarginProWebSocketStreams {
    private static final String USER_AGENT =
            String.format(
                    "binance-derivatives-trading-portfolio-margin-pro/3.0.0 (Java/%s; %s; %s)",
                    SystemUtil.getJavaVersion(), SystemUtil.getOs(), SystemUtil.getArch());

    private final StreamConnectionInterface connection;

    public DerivativesTradingPortfolioMarginProWebSocketStreams(
    ...
    public DerivativesTradingPortfolioMarginProWebSocketStreams(
            StreamConnectionInterface connection) {
