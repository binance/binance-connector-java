...
public class TransferLdusdtRwusdForPortfolioMarginResponse {
    ...
    public TransferLdusdtRwusdForPortfolioMarginResponse() {}

    public TransferLdusdtRwusdForPortfolioMarginResponse msg(
    ...
    public boolean equals(Object o) {
        ...
        TransferLdusdtRwusdForPortfolioMarginResponse
                transferLdusdtRwusdForPortfolioMarginResponse =
                        (TransferLdusdtRwusdForPortfolioMarginResponse) o;
        return Objects.equals(this.msg, transferLdusdtRwusdForPortfolioMarginResponse.msg);
    }
    ...
    public String toString() {
        ...
        sb.append("class TransferLdusdtRwusdForPortfolioMarginResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TransferLdusdtRwusdForPortfolioMarginResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " TransferLdusdtRwusdForPortfolioMarginResponse is not found"
                                    + " in the empty JSON string",
                                TransferLdusdtRwusdForPortfolioMarginResponse.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TransferLdusdtRwusdForPortfolioMarginResponse.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'TransferLdusdtRwusdForPortfolioMarginResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TransferLdusdtRwusdForPortfolioMarginResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(TransferLdusdtRwusdForPortfolioMarginResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TransferLdusdtRwusdForPortfolioMarginResponse>() {
                        @Override
                        public void write(
