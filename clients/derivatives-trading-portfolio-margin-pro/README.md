# Binance Java Derivatives Trading Portfolio Margin Pro Connector
...
- [REST API](./src/main/java/com/binance/connector/client/derivatives_trading_portfolio_margin_pro/rest/api)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/derivatives/portfolio-margin-pro/).

### REST APIs

All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/derivatives_trading_portfolio_margin_pro/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/derivatives-trading-portfolio-margin-pro/src/main/java/com/binance/connector/client/derivatives_trading_portfolio_margin_pro/rest) folder.
