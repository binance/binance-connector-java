# Binance Java DerivativesTradingPortfolioMarginPro Connector
...
More examples can be found in the [`examples/rest-api`](./examples/derivatives-trading-portfolio-margin-pro/src/main/java/com/binance/connector/client/derivatives-trading-portfolio-margin-pro/rest) folder.
