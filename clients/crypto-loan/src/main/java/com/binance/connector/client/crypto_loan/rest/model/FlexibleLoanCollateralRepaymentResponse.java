...
public class FlexibleLoanCollateralRepaymentResponse {
    ...
    public FlexibleLoanCollateralRepaymentResponse() {}

    public FlexibleLoanCollateralRepaymentResponse loanCoin(
    ...
    public FlexibleLoanCollateralRepaymentResponse collateralCoin(
    ...
    public FlexibleLoanCollateralRepaymentResponse remainingDebt(
    ...
    public FlexibleLoanCollateralRepaymentResponse remainingCollateral(
    ...
    public FlexibleLoanCollateralRepaymentResponse fullRepayment(
    ...
    public FlexibleLoanCollateralRepaymentResponse currentLTV(
    ...
    public FlexibleLoanCollateralRepaymentResponse repayStatus(
    ...
    public boolean equals(Object o) {
        ...
        FlexibleLoanCollateralRepaymentResponse flexibleLoanCollateralRepaymentResponse =
                (FlexibleLoanCollateralRepaymentResponse) o;
        return Objects.equals(this.loanCoin, flexibleLoanCollateralRepaymentResponse.loanCoin)
                && Objects.equals(
                        this.collateralCoin, flexibleLoanCollateralRepaymentResponse.collateralCoin)
                && Objects.equals(
                        this.remainingDebt, flexibleLoanCollateralRepaymentResponse.remainingDebt)
                && Objects.equals(
                        this.remainingCollateral,
                        flexibleLoanCollateralRepaymentResponse.remainingCollateral)
                && Objects.equals(
                        this.fullRepayment, flexibleLoanCollateralRepaymentResponse.fullRepayment)
                && Objects.equals(
                        this.currentLTV, flexibleLoanCollateralRepaymentResponse.currentLTV)
                && Objects.equals(
                        this.repayStatus, flexibleLoanCollateralRepaymentResponse.repayStatus);
    }
    ...
    public String toString() {
        ...
        sb.append("class FlexibleLoanCollateralRepaymentResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FlexibleLoanCollateralRepaymentResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " FlexibleLoanCollateralRepaymentResponse is not found in the"
                                    + " empty JSON string",
                                FlexibleLoanCollateralRepaymentResponse.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!FlexibleLoanCollateralRepaymentResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `FlexibleLoanCollateralRepaymentResponse` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FlexibleLoanCollateralRepaymentResponse.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes 'FlexibleLoanCollateralRepaymentResponse'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FlexibleLoanCollateralRepaymentResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(FlexibleLoanCollateralRepaymentResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FlexibleLoanCollateralRepaymentResponse>() {
                        @Override
                        public void write(
                                JsonWriter out, FlexibleLoanCollateralRepaymentResponse value)
                                throws IOException {
                        ...
                        @Override
                        public FlexibleLoanCollateralRepaymentResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of FlexibleLoanCollateralRepaymentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FlexibleLoanCollateralRepaymentResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     FlexibleLoanCollateralRepaymentResponse
     */
    public static FlexibleLoanCollateralRepaymentResponse fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, FlexibleLoanCollateralRepaymentResponse.class);
    }

    /**
     * Convert an instance of FlexibleLoanCollateralRepaymentResponse to an JSON string
     *
     * @return JSON string
     */
