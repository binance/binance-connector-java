...
public class FlexibleLoanBorrowResponse {
    ...
    public FlexibleLoanBorrowResponse() {}

    public FlexibleLoanBorrowResponse loanCoin(@jakarta.annotation.Nullable String loanCoin) {
    ...
    public FlexibleLoanBorrowResponse loanAmount(@jakarta.annotation.Nullable String loanAmount) {
    ...
    public FlexibleLoanBorrowResponse collateralCoin(
    ...
    public FlexibleLoanBorrowResponse collateralAmount(
    ...
    public FlexibleLoanBorrowResponse status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        FlexibleLoanBorrowResponse flexibleLoanBorrowResponse = (FlexibleLoanBorrowResponse) o;
        return Objects.equals(this.loanCoin, flexibleLoanBorrowResponse.loanCoin)
                && Objects.equals(this.loanAmount, flexibleLoanBorrowResponse.loanAmount)
                && Objects.equals(this.collateralCoin, flexibleLoanBorrowResponse.collateralCoin)
                && Objects.equals(
                        this.collateralAmount, flexibleLoanBorrowResponse.collateralAmount)
                && Objects.equals(this.status, flexibleLoanBorrowResponse.status);
    }
    ...
    public String toString() {
        ...
        sb.append("class FlexibleLoanBorrowResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to FlexibleLoanBorrowResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FlexibleLoanBorrowResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FlexibleLoanBorrowResponse is not"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FlexibleLoanBorrowResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FlexibleLoanBorrowResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FlexibleLoanBorrowResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(FlexibleLoanBorrowResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FlexibleLoanBorrowResponse>() {
                        @Override
                        ...
                        @Override
                        public FlexibleLoanBorrowResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of FlexibleLoanBorrowResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FlexibleLoanBorrowResponse
     * @throws IOException if the JSON string is invalid with respect to FlexibleLoanBorrowResponse
     */
    public static FlexibleLoanBorrowResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FlexibleLoanBorrowResponse.class);
    }

    /**
     * Convert an instance of FlexibleLoanBorrowResponse to an JSON string
     *
     * @return JSON string
     */
