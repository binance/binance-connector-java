...
public class FlexibleLoanCollateralRepaymentRequest {
    ...
    public FlexibleLoanCollateralRepaymentRequest() {}

    public FlexibleLoanCollateralRepaymentRequest loanCoin(
            @jakarta.annotation.Nonnull String loanCoin) {
    ...
    public FlexibleLoanCollateralRepaymentRequest collateralCoin(
    ...
    public FlexibleLoanCollateralRepaymentRequest repayAmount(
            @jakarta.annotation.Nonnull Double repayAmount) {
    ...
    public FlexibleLoanCollateralRepaymentRequest fullRepayment(
    ...
    public FlexibleLoanCollateralRepaymentRequest recvWindow(
    ...
    public boolean equals(Object o) {
        ...
        FlexibleLoanCollateralRepaymentRequest flexibleLoanCollateralRepaymentRequest =
                (FlexibleLoanCollateralRepaymentRequest) o;
        return Objects.equals(this.loanCoin, flexibleLoanCollateralRepaymentRequest.loanCoin)
                && Objects.equals(
                        this.collateralCoin, flexibleLoanCollateralRepaymentRequest.collateralCoin)
                && Objects.equals(
                        this.repayAmount, flexibleLoanCollateralRepaymentRequest.repayAmount)
                && Objects.equals(
                        this.fullRepayment, flexibleLoanCollateralRepaymentRequest.fullRepayment)
                && Objects.equals(
                        this.recvWindow, flexibleLoanCollateralRepaymentRequest.recvWindow);
    }

    @Override
    public int hashCode() {
        return Objects.hash(loanCoin, collateralCoin, repayAmount, fullRepayment, recvWindow);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class FlexibleLoanCollateralRepaymentRequest {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FlexibleLoanCollateralRepaymentRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FlexibleLoanCollateralRepaymentRequest"
                                        + " is not found in the empty JSON string",
                                FlexibleLoanCollateralRepaymentRequest.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!FlexibleLoanCollateralRepaymentRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `FlexibleLoanCollateralRepaymentRequest` properties. JSON:"
                                    + " %s",
        ...
        for (String requiredField : FlexibleLoanCollateralRepaymentRequest.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FlexibleLoanCollateralRepaymentRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FlexibleLoanCollateralRepaymentRequest'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FlexibleLoanCollateralRepaymentRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(FlexibleLoanCollateralRepaymentRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FlexibleLoanCollateralRepaymentRequest>() {
                        @Override
                        public void write(
                                JsonWriter out, FlexibleLoanCollateralRepaymentRequest value)
                                throws IOException {
                        ...
                        @Override
                        public FlexibleLoanCollateralRepaymentRequest read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of FlexibleLoanCollateralRepaymentRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FlexibleLoanCollateralRepaymentRequest
     * @throws IOException if the JSON string is invalid with respect to
     *     FlexibleLoanCollateralRepaymentRequest
     */
    public static FlexibleLoanCollateralRepaymentRequest fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, FlexibleLoanCollateralRepaymentRequest.class);
    }

    /**
     * Convert an instance of FlexibleLoanCollateralRepaymentRequest to an JSON string
     *
     * @return JSON string
     */
