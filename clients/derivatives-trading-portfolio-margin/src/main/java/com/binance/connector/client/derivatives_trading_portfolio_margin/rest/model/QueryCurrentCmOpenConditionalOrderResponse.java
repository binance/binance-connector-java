...
public class QueryCurrentCmOpenConditionalOrderResponse {
    ...
    public QueryCurrentCmOpenConditionalOrderResponse() {}

    public QueryCurrentCmOpenConditionalOrderResponse newClientStrategyId(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse strategyId(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse strategyStatus(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse strategyType(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse origQty(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse price(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse reduceOnly(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse side(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse positionSide(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse stopPrice(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse symbol(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse bookTime(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse updateTime(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse timeInForce(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse activatePrice(
    ...
    public QueryCurrentCmOpenConditionalOrderResponse priceRate(
    ...
    public boolean equals(Object o) {
        ...
        QueryCurrentCmOpenConditionalOrderResponse queryCurrentCmOpenConditionalOrderResponse =
                (QueryCurrentCmOpenConditionalOrderResponse) o;
        return Objects.equals(
                        this.newClientStrategyId,
                        queryCurrentCmOpenConditionalOrderResponse.newClientStrategyId)
                && Objects.equals(
                        this.strategyId, queryCurrentCmOpenConditionalOrderResponse.strategyId)
                && Objects.equals(
                        this.strategyStatus,
                        queryCurrentCmOpenConditionalOrderResponse.strategyStatus)
                && Objects.equals(
                        this.strategyType, queryCurrentCmOpenConditionalOrderResponse.strategyType)
                && Objects.equals(this.origQty, queryCurrentCmOpenConditionalOrderResponse.origQty)
                && Objects.equals(this.price, queryCurrentCmOpenConditionalOrderResponse.price)
                && Objects.equals(
                        this.reduceOnly, queryCurrentCmOpenConditionalOrderResponse.reduceOnly)
                && Objects.equals(this.side, queryCurrentCmOpenConditionalOrderResponse.side)
                && Objects.equals(
                        this.positionSide, queryCurrentCmOpenConditionalOrderResponse.positionSide)
                && Objects.equals(
                        this.stopPrice, queryCurrentCmOpenConditionalOrderResponse.stopPrice)
                && Objects.equals(this.symbol, queryCurrentCmOpenConditionalOrderResponse.symbol)
                && Objects.equals(
                        this.bookTime, queryCurrentCmOpenConditionalOrderResponse.bookTime)
                && Objects.equals(
                        this.updateTime, queryCurrentCmOpenConditionalOrderResponse.updateTime)
                && Objects.equals(
                        this.timeInForce, queryCurrentCmOpenConditionalOrderResponse.timeInForce)
                && Objects.equals(
                        this.activatePrice,
                        queryCurrentCmOpenConditionalOrderResponse.activatePrice)
                && Objects.equals(
                        this.priceRate, queryCurrentCmOpenConditionalOrderResponse.priceRate);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryCurrentCmOpenConditionalOrderResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryCurrentCmOpenConditionalOrderResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " QueryCurrentCmOpenConditionalOrderResponse is not found in"
                                    + " the empty JSON string",
                                QueryCurrentCmOpenConditionalOrderResponse.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!QueryCurrentCmOpenConditionalOrderResponse.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `QueryCurrentCmOpenConditionalOrderResponse` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryCurrentCmOpenConditionalOrderResponse.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'QueryCurrentCmOpenConditionalOrderResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryCurrentCmOpenConditionalOrderResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(QueryCurrentCmOpenConditionalOrderResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryCurrentCmOpenConditionalOrderResponse>() {
                        @Override
                        public void write(
                                JsonWriter out, QueryCurrentCmOpenConditionalOrderResponse value)
                                throws IOException {
                        ...
                        @Override
                        public QueryCurrentCmOpenConditionalOrderResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of QueryCurrentCmOpenConditionalOrderResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryCurrentCmOpenConditionalOrderResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryCurrentCmOpenConditionalOrderResponse
     */
    public static QueryCurrentCmOpenConditionalOrderResponse fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, QueryCurrentCmOpenConditionalOrderResponse.class);
    }

    /**
     * Convert an instance of QueryCurrentCmOpenConditionalOrderResponse to an JSON string
     *
     * @return JSON string
     */
