...
public class CancelMarginAccountOcoOrdersResponseOrderReportsInner {
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner() {}

    public CancelMarginAccountOcoOrdersResponseOrderReportsInner symbol(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner origClientOrderId(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner orderId(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner orderListId(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner clientOrderId(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner price(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner origQty(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner executedQty(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner cummulativeQuoteQty(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner status(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner timeInForce(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner type(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner side(
    ...
    public CancelMarginAccountOcoOrdersResponseOrderReportsInner stopPrice(
    ...
    public boolean equals(Object o) {
        ...
        CancelMarginAccountOcoOrdersResponseOrderReportsInner
                cancelMarginAccountOcoOrdersResponseOrderReportsInner =
                        (CancelMarginAccountOcoOrdersResponseOrderReportsInner) o;
        return Objects.equals(
                        this.symbol, cancelMarginAccountOcoOrdersResponseOrderReportsInner.symbol)
                && Objects.equals(
                        this.origClientOrderId,
                        cancelMarginAccountOcoOrdersResponseOrderReportsInner.origClientOrderId)
                && Objects.equals(
                        this.orderId, cancelMarginAccountOcoOrdersResponseOrderReportsInner.orderId)
                && Objects.equals(
                        this.orderListId,
                        cancelMarginAccountOcoOrdersResponseOrderReportsInner.orderListId)
                && Objects.equals(
                        this.clientOrderId,
                        cancelMarginAccountOcoOrdersResponseOrderReportsInner.clientOrderId)
                && Objects.equals(
                        this.price, cancelMarginAccountOcoOrdersResponseOrderReportsInner.price)
                && Objects.equals(
                        this.origQty, cancelMarginAccountOcoOrdersResponseOrderReportsInner.origQty)
                && Objects.equals(
                        this.executedQty,
                        cancelMarginAccountOcoOrdersResponseOrderReportsInner.executedQty)
                && Objects.equals(
                        this.cummulativeQuoteQty,
                        cancelMarginAccountOcoOrdersResponseOrderReportsInner.cummulativeQuoteQty)
                && Objects.equals(
                        this.status, cancelMarginAccountOcoOrdersResponseOrderReportsInner.status)
                && Objects.equals(
                        this.timeInForce,
                        cancelMarginAccountOcoOrdersResponseOrderReportsInner.timeInForce)
                && Objects.equals(
                        this.type, cancelMarginAccountOcoOrdersResponseOrderReportsInner.type)
                && Objects.equals(
                        this.side, cancelMarginAccountOcoOrdersResponseOrderReportsInner.side)
                && Objects.equals(
                        this.stopPrice,
                        cancelMarginAccountOcoOrdersResponseOrderReportsInner.stopPrice);
    }
    ...
    public String toString() {
        ...
        sb.append("class CancelMarginAccountOcoOrdersResponseOrderReportsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CancelMarginAccountOcoOrdersResponseOrderReportsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " CancelMarginAccountOcoOrdersResponseOrderReportsInner is"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CancelMarginAccountOcoOrdersResponseOrderReportsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CancelMarginAccountOcoOrdersResponseOrderReportsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'CancelMarginAccountOcoOrdersResponseOrderReportsInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CancelMarginAccountOcoOrdersResponseOrderReportsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(
                                    CancelMarginAccountOcoOrdersResponseOrderReportsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CancelMarginAccountOcoOrdersResponseOrderReportsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                CancelMarginAccountOcoOrdersResponseOrderReportsInner value)
                                throws IOException {
                        ...
                        @Override
                        public CancelMarginAccountOcoOrdersResponseOrderReportsInner read(
    ...
    /**
     * Create an instance of CancelMarginAccountOcoOrdersResponseOrderReportsInner given an JSON
     * string
     *
     * @param jsonString JSON string
     * @return An instance of CancelMarginAccountOcoOrdersResponseOrderReportsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     CancelMarginAccountOcoOrdersResponseOrderReportsInner
     */
    public static CancelMarginAccountOcoOrdersResponseOrderReportsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, CancelMarginAccountOcoOrdersResponseOrderReportsInner.class);
    }

    /**
     * Convert an instance of CancelMarginAccountOcoOrdersResponseOrderReportsInner to an JSON
     * string
     *
     * @return JSON string
     */
