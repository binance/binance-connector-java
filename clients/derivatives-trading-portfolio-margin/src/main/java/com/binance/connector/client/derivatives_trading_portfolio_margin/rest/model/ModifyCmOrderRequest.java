...
public class ModifyCmOrderRequest {
    ...
    public ModifyCmOrderRequest() {}

    public ModifyCmOrderRequest orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public ModifyCmOrderRequest origClientOrderId(
    ...
    public ModifyCmOrderRequest symbol(@jakarta.annotation.Nonnull String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public ModifyCmOrderRequest side(@jakarta.annotation.Nonnull Side side) {
        this.side = side;
        return this;
    }
    ...
    public ModifyCmOrderRequest quantity(@jakarta.annotation.Nonnull Double quantity) {
    ...
    public ModifyCmOrderRequest price(@jakarta.annotation.Nonnull Double price) {
        this.price = price;
        return this;
    }
    ...
    public ModifyCmOrderRequest priceMatch(@jakarta.annotation.Nullable PriceMatch priceMatch) {
    ...
    public ModifyCmOrderRequest modifyId(@jakarta.annotation.Nullable Long modifyId) {
    ...
    public ModifyCmOrderRequest recvWindow(@jakarta.annotation.Nullable Long recvWindow) {
    ...
    public boolean equals(Object o) {
        ...
        ModifyCmOrderRequest modifyCmOrderRequest = (ModifyCmOrderRequest) o;
        return Objects.equals(this.orderId, modifyCmOrderRequest.orderId)
                && Objects.equals(this.origClientOrderId, modifyCmOrderRequest.origClientOrderId)
                && Objects.equals(this.symbol, modifyCmOrderRequest.symbol)
                && Objects.equals(this.side, modifyCmOrderRequest.side)
                && Objects.equals(this.quantity, modifyCmOrderRequest.quantity)
                && Objects.equals(this.price, modifyCmOrderRequest.price)
                && Objects.equals(this.priceMatch, modifyCmOrderRequest.priceMatch)
                && Objects.equals(this.modifyId, modifyCmOrderRequest.modifyId)
                && Objects.equals(this.recvWindow, modifyCmOrderRequest.recvWindow);
    }
    ...
    public String toString() {
        ...
        sb.append("class ModifyCmOrderRequest {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to ModifyCmOrderRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ModifyCmOrderRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ModifyCmOrderRequest is not found in"
                                        + " the empty JSON string",
                                ModifyCmOrderRequest.openapiRequiredFields.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : ModifyCmOrderRequest.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ModifyCmOrderRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ModifyCmOrderRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ModifyCmOrderRequest> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(ModifyCmOrderRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ModifyCmOrderRequest>() {
                        @Override
                        public void write(JsonWriter out, ModifyCmOrderRequest value)
                                throws IOException {
                        ...
                        @Override
                        public ModifyCmOrderRequest read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of ModifyCmOrderRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ModifyCmOrderRequest
     * @throws IOException if the JSON string is invalid with respect to ModifyCmOrderRequest
     */
    public static ModifyCmOrderRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ModifyCmOrderRequest.class);
    }

    /**
     * Convert an instance of ModifyCmOrderRequest to an JSON string
     *
     * @return JSON string
     */
