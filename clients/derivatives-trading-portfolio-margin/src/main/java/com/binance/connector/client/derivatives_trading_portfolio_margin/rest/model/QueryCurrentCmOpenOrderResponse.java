...
public class QueryCurrentCmOpenOrderResponse {
    ...
    public QueryCurrentCmOpenOrderResponse() {}

    public QueryCurrentCmOpenOrderResponse avgPrice(@jakarta.annotation.Nullable String avgPrice) {
    ...
    public QueryCurrentCmOpenOrderResponse clientOrderId(
    ...
    public QueryCurrentCmOpenOrderResponse cumBase(@jakarta.annotation.Nullable String cumBase) {
    ...
    public QueryCurrentCmOpenOrderResponse executedQty(
    ...
    public QueryCurrentCmOpenOrderResponse orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public QueryCurrentCmOpenOrderResponse origQty(@jakarta.annotation.Nullable String origQty) {
    ...
    public QueryCurrentCmOpenOrderResponse origType(@jakarta.annotation.Nullable String origType) {
    ...
    public QueryCurrentCmOpenOrderResponse price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public QueryCurrentCmOpenOrderResponse reduceOnly(
    ...
    public QueryCurrentCmOpenOrderResponse side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public QueryCurrentCmOpenOrderResponse positionSide(
    ...
    public QueryCurrentCmOpenOrderResponse status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public QueryCurrentCmOpenOrderResponse symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public QueryCurrentCmOpenOrderResponse pair(@jakarta.annotation.Nullable String pair) {
        this.pair = pair;
        return this;
    }
    ...
    public QueryCurrentCmOpenOrderResponse time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public QueryCurrentCmOpenOrderResponse timeInForce(
    ...
    public QueryCurrentCmOpenOrderResponse type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public QueryCurrentCmOpenOrderResponse updateTime(
    ...
    public boolean equals(Object o) {
        ...
        QueryCurrentCmOpenOrderResponse queryCurrentCmOpenOrderResponse =
                (QueryCurrentCmOpenOrderResponse) o;
        return Objects.equals(this.avgPrice, queryCurrentCmOpenOrderResponse.avgPrice)
                && Objects.equals(this.clientOrderId, queryCurrentCmOpenOrderResponse.clientOrderId)
                && Objects.equals(this.cumBase, queryCurrentCmOpenOrderResponse.cumBase)
                && Objects.equals(this.executedQty, queryCurrentCmOpenOrderResponse.executedQty)
                && Objects.equals(this.orderId, queryCurrentCmOpenOrderResponse.orderId)
                && Objects.equals(this.origQty, queryCurrentCmOpenOrderResponse.origQty)
                && Objects.equals(this.origType, queryCurrentCmOpenOrderResponse.origType)
                && Objects.equals(this.price, queryCurrentCmOpenOrderResponse.price)
                && Objects.equals(this.reduceOnly, queryCurrentCmOpenOrderResponse.reduceOnly)
                && Objects.equals(this.side, queryCurrentCmOpenOrderResponse.side)
                && Objects.equals(this.positionSide, queryCurrentCmOpenOrderResponse.positionSide)
                && Objects.equals(this.status, queryCurrentCmOpenOrderResponse.status)
                && Objects.equals(this.symbol, queryCurrentCmOpenOrderResponse.symbol)
                && Objects.equals(this.pair, queryCurrentCmOpenOrderResponse.pair)
                && Objects.equals(this.time, queryCurrentCmOpenOrderResponse.time)
                && Objects.equals(this.timeInForce, queryCurrentCmOpenOrderResponse.timeInForce)
                && Objects.equals(this.type, queryCurrentCmOpenOrderResponse.type)
                && Objects.equals(this.updateTime, queryCurrentCmOpenOrderResponse.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryCurrentCmOpenOrderResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryCurrentCmOpenOrderResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in QueryCurrentCmOpenOrderResponse is not"
                                        + " found in the empty JSON string",
                                QueryCurrentCmOpenOrderResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!QueryCurrentCmOpenOrderResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `QueryCurrentCmOpenOrderResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryCurrentCmOpenOrderResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'QueryCurrentCmOpenOrderResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryCurrentCmOpenOrderResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(QueryCurrentCmOpenOrderResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryCurrentCmOpenOrderResponse>() {
                        @Override
                        public void write(JsonWriter out, QueryCurrentCmOpenOrderResponse value)
                                throws IOException {
                        ...
                        @Override
                        public QueryCurrentCmOpenOrderResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of QueryCurrentCmOpenOrderResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryCurrentCmOpenOrderResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryCurrentCmOpenOrderResponse
     */
    public static QueryCurrentCmOpenOrderResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, QueryCurrentCmOpenOrderResponse.class);
    }

    /**
     * Convert an instance of QueryCurrentCmOpenOrderResponse to an JSON string
     *
     * @return JSON string
     */
