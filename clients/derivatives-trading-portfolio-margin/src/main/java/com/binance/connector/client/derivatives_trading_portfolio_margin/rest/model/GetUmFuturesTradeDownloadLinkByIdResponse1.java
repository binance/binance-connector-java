...
public class GetUmFuturesTradeDownloadLinkByIdResponse1 {
    ...
    public GetUmFuturesTradeDownloadLinkByIdResponse1 downloadId(
    ...
    public GetUmFuturesTradeDownloadLinkByIdResponse1 status(
    ...
    public GetUmFuturesTradeDownloadLinkByIdResponse1 url(@jakarta.annotation.Nullable String url) {
        this.url = url;
        return this;
    }
    ...
    public GetUmFuturesTradeDownloadLinkByIdResponse1 s3Link(
    ...
    public GetUmFuturesTradeDownloadLinkByIdResponse1 notified(
    ...
    public GetUmFuturesTradeDownloadLinkByIdResponse1 expirationTimestamp(
    ...
    public GetUmFuturesTradeDownloadLinkByIdResponse1 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetUmFuturesTradeDownloadLinkByIdResponse1 getUmFuturesTradeDownloadLinkByIdResponse1 =
                (GetUmFuturesTradeDownloadLinkByIdResponse1) o;
        return Objects.equals(
                        this.downloadId, getUmFuturesTradeDownloadLinkByIdResponse1.downloadId)
                && Objects.equals(this.status, getUmFuturesTradeDownloadLinkByIdResponse1.status)
                && Objects.equals(this.url, getUmFuturesTradeDownloadLinkByIdResponse1.url)
                && Objects.equals(this.s3Link, getUmFuturesTradeDownloadLinkByIdResponse1.s3Link)
                && Objects.equals(
                        this.notified, getUmFuturesTradeDownloadLinkByIdResponse1.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getUmFuturesTradeDownloadLinkByIdResponse1.expirationTimestamp)
                && Objects.equals(
                        this.isExpired, getUmFuturesTradeDownloadLinkByIdResponse1.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetUmFuturesTradeDownloadLinkByIdResponse1 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetUmFuturesTradeDownloadLinkByIdResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetUmFuturesTradeDownloadLinkByIdResponse1 is not found in"
                                    + " the empty JSON string",
                                GetUmFuturesTradeDownloadLinkByIdResponse1.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetUmFuturesTradeDownloadLinkByIdResponse1.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `GetUmFuturesTradeDownloadLinkByIdResponse1` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUmFuturesTradeDownloadLinkByIdResponse1.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetUmFuturesTradeDownloadLinkByIdResponse1' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetUmFuturesTradeDownloadLinkByIdResponse1> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetUmFuturesTradeDownloadLinkByIdResponse1.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetUmFuturesTradeDownloadLinkByIdResponse1>() {
                        @Override
                        public void write(
                                JsonWriter out, GetUmFuturesTradeDownloadLinkByIdResponse1 value)
                                throws IOException {
                        ...
                        @Override
                        public GetUmFuturesTradeDownloadLinkByIdResponse1 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetUmFuturesTradeDownloadLinkByIdResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetUmFuturesTradeDownloadLinkByIdResponse1
     * @throws IOException if the JSON string is invalid with respect to
     *     GetUmFuturesTradeDownloadLinkByIdResponse1
     */
    public static GetUmFuturesTradeDownloadLinkByIdResponse1 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetUmFuturesTradeDownloadLinkByIdResponse1.class);
    }

    /**
     * Convert an instance of GetUmFuturesTradeDownloadLinkByIdResponse1 to an JSON string
     *
     * @return JSON string
     */
