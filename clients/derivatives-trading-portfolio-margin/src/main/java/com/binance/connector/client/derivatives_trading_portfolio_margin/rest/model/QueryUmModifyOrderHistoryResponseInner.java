...
public class QueryUmModifyOrderHistoryResponseInner {
    ...
    public QueryUmModifyOrderHistoryResponseInner() {}

    public QueryUmModifyOrderHistoryResponseInner amendmentId(
    ...
    public QueryUmModifyOrderHistoryResponseInner symbol(
    ...
    public QueryUmModifyOrderHistoryResponseInner pair(@jakarta.annotation.Nullable String pair) {
        this.pair = pair;
        return this;
    }
    ...
    public QueryUmModifyOrderHistoryResponseInner orderId(
    ...
    public QueryUmModifyOrderHistoryResponseInner clientOrderId(
    ...
    public QueryUmModifyOrderHistoryResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public QueryUmModifyOrderHistoryResponseInner amendment(
            @jakarta.annotation.Nullable
    ...
    public QueryUmModifyOrderHistoryResponseInner priceMatch(
    ...
    public boolean equals(Object o) {
        ...
        QueryUmModifyOrderHistoryResponseInner queryUmModifyOrderHistoryResponseInner =
                (QueryUmModifyOrderHistoryResponseInner) o;
        return Objects.equals(this.amendmentId, queryUmModifyOrderHistoryResponseInner.amendmentId)
                && Objects.equals(this.symbol, queryUmModifyOrderHistoryResponseInner.symbol)
                && Objects.equals(this.pair, queryUmModifyOrderHistoryResponseInner.pair)
                && Objects.equals(this.orderId, queryUmModifyOrderHistoryResponseInner.orderId)
                && Objects.equals(
                        this.clientOrderId, queryUmModifyOrderHistoryResponseInner.clientOrderId)
                && Objects.equals(this.time, queryUmModifyOrderHistoryResponseInner.time)
                && Objects.equals(this.amendment, queryUmModifyOrderHistoryResponseInner.amendment)
                && Objects.equals(
                        this.priceMatch, queryUmModifyOrderHistoryResponseInner.priceMatch);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                amendmentId, symbol, pair, orderId, clientOrderId, time, amendment, priceMatch);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class QueryUmModifyOrderHistoryResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryUmModifyOrderHistoryResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in QueryUmModifyOrderHistoryResponseInner"
                                        + " is not found in the empty JSON string",
                                QueryUmModifyOrderHistoryResponseInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!QueryUmModifyOrderHistoryResponseInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `QueryUmModifyOrderHistoryResponseInner` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryUmModifyOrderHistoryResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'QueryUmModifyOrderHistoryResponseInner'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryUmModifyOrderHistoryResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(QueryUmModifyOrderHistoryResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryUmModifyOrderHistoryResponseInner>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public QueryUmModifyOrderHistoryResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of QueryUmModifyOrderHistoryResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryUmModifyOrderHistoryResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryUmModifyOrderHistoryResponseInner
     */
    public static QueryUmModifyOrderHistoryResponseInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, QueryUmModifyOrderHistoryResponseInner.class);
    }

    /**
     * Convert an instance of QueryUmModifyOrderHistoryResponseInner to an JSON string
     *
     * @return JSON string
     */
