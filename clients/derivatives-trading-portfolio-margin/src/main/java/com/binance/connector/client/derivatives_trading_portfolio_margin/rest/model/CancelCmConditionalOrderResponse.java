...
public class CancelCmConditionalOrderResponse {
    ...
    public CancelCmConditionalOrderResponse() {}

    public CancelCmConditionalOrderResponse newClientStrategyId(
    ...
    public CancelCmConditionalOrderResponse strategyId(
    ...
    public CancelCmConditionalOrderResponse strategyStatus(
    ...
    public CancelCmConditionalOrderResponse strategyType(
    ...
    public CancelCmConditionalOrderResponse origQty(@jakarta.annotation.Nullable String origQty) {
    ...
    public CancelCmConditionalOrderResponse price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public CancelCmConditionalOrderResponse reduceOnly(
    ...
    public CancelCmConditionalOrderResponse side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public CancelCmConditionalOrderResponse positionSide(
    ...
    public CancelCmConditionalOrderResponse stopPrice(
    ...
    public CancelCmConditionalOrderResponse symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public CancelCmConditionalOrderResponse timeInForce(
    ...
    public CancelCmConditionalOrderResponse activatePrice(
    ...
    public CancelCmConditionalOrderResponse priceRate(
    ...
    public CancelCmConditionalOrderResponse bookTime(@jakarta.annotation.Nullable Long bookTime) {
    ...
    public CancelCmConditionalOrderResponse updateTime(
    ...
    public CancelCmConditionalOrderResponse workingType(
    ...
    public CancelCmConditionalOrderResponse priceProtect(
    ...
    public boolean equals(Object o) {
        ...
        CancelCmConditionalOrderResponse cancelCmConditionalOrderResponse =
                (CancelCmConditionalOrderResponse) o;
        return Objects.equals(
                        this.newClientStrategyId,
                        cancelCmConditionalOrderResponse.newClientStrategyId)
                && Objects.equals(this.strategyId, cancelCmConditionalOrderResponse.strategyId)
                && Objects.equals(
                        this.strategyStatus, cancelCmConditionalOrderResponse.strategyStatus)
                && Objects.equals(this.strategyType, cancelCmConditionalOrderResponse.strategyType)
                && Objects.equals(this.origQty, cancelCmConditionalOrderResponse.origQty)
                && Objects.equals(this.price, cancelCmConditionalOrderResponse.price)
                && Objects.equals(this.reduceOnly, cancelCmConditionalOrderResponse.reduceOnly)
                && Objects.equals(this.side, cancelCmConditionalOrderResponse.side)
                && Objects.equals(this.positionSide, cancelCmConditionalOrderResponse.positionSide)
                && Objects.equals(this.stopPrice, cancelCmConditionalOrderResponse.stopPrice)
                && Objects.equals(this.symbol, cancelCmConditionalOrderResponse.symbol)
                && Objects.equals(this.timeInForce, cancelCmConditionalOrderResponse.timeInForce)
                && Objects.equals(
                        this.activatePrice, cancelCmConditionalOrderResponse.activatePrice)
                && Objects.equals(this.priceRate, cancelCmConditionalOrderResponse.priceRate)
                && Objects.equals(this.bookTime, cancelCmConditionalOrderResponse.bookTime)
                && Objects.equals(this.updateTime, cancelCmConditionalOrderResponse.updateTime)
                && Objects.equals(this.workingType, cancelCmConditionalOrderResponse.workingType)
                && Objects.equals(this.priceProtect, cancelCmConditionalOrderResponse.priceProtect);
    }
    ...
    public String toString() {
        ...
        sb.append("class CancelCmConditionalOrderResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CancelCmConditionalOrderResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CancelCmConditionalOrderResponse is"
                                        + " not found in the empty JSON string",
                                CancelCmConditionalOrderResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CancelCmConditionalOrderResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `CancelCmConditionalOrderResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CancelCmConditionalOrderResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CancelCmConditionalOrderResponse' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CancelCmConditionalOrderResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CancelCmConditionalOrderResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CancelCmConditionalOrderResponse>() {
                        @Override
                        public void write(JsonWriter out, CancelCmConditionalOrderResponse value)
                                throws IOException {
                        ...
                        @Override
                        public CancelCmConditionalOrderResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of CancelCmConditionalOrderResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CancelCmConditionalOrderResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     CancelCmConditionalOrderResponse
     */
    public static CancelCmConditionalOrderResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CancelCmConditionalOrderResponse.class);
    }

    /**
     * Convert an instance of CancelCmConditionalOrderResponse to an JSON string
     *
     * @return JSON string
     */
