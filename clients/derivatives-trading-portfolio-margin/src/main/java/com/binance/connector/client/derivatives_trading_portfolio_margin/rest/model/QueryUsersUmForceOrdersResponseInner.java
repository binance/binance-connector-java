...
public class QueryUsersUmForceOrdersResponseInner {
    ...
    public QueryUsersUmForceOrdersResponseInner() {}

    public QueryUsersUmForceOrdersResponseInner orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public QueryUsersUmForceOrdersResponseInner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public QueryUsersUmForceOrdersResponseInner status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public QueryUsersUmForceOrdersResponseInner clientOrderId(
    ...
    public QueryUsersUmForceOrdersResponseInner price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public QueryUsersUmForceOrdersResponseInner avgPrice(
    ...
    public QueryUsersUmForceOrdersResponseInner origQty(
    ...
    public QueryUsersUmForceOrdersResponseInner executedQty(
    ...
    public QueryUsersUmForceOrdersResponseInner cumQuote(
    ...
    public QueryUsersUmForceOrdersResponseInner timeInForce(
    ...
    public QueryUsersUmForceOrdersResponseInner type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public QueryUsersUmForceOrdersResponseInner reduceOnly(
    ...
    public QueryUsersUmForceOrdersResponseInner side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public QueryUsersUmForceOrdersResponseInner positionSide(
    ...
    public QueryUsersUmForceOrdersResponseInner origType(
    ...
    public QueryUsersUmForceOrdersResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public QueryUsersUmForceOrdersResponseInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        QueryUsersUmForceOrdersResponseInner queryUsersUmForceOrdersResponseInner =
                (QueryUsersUmForceOrdersResponseInner) o;
        return Objects.equals(this.orderId, queryUsersUmForceOrdersResponseInner.orderId)
                && Objects.equals(this.symbol, queryUsersUmForceOrdersResponseInner.symbol)
                && Objects.equals(this.status, queryUsersUmForceOrdersResponseInner.status)
                && Objects.equals(
                        this.clientOrderId, queryUsersUmForceOrdersResponseInner.clientOrderId)
                && Objects.equals(this.price, queryUsersUmForceOrdersResponseInner.price)
                && Objects.equals(this.avgPrice, queryUsersUmForceOrdersResponseInner.avgPrice)
                && Objects.equals(this.origQty, queryUsersUmForceOrdersResponseInner.origQty)
                && Objects.equals(
                        this.executedQty, queryUsersUmForceOrdersResponseInner.executedQty)
                && Objects.equals(this.cumQuote, queryUsersUmForceOrdersResponseInner.cumQuote)
                && Objects.equals(
                        this.timeInForce, queryUsersUmForceOrdersResponseInner.timeInForce)
                && Objects.equals(this.type, queryUsersUmForceOrdersResponseInner.type)
                && Objects.equals(this.reduceOnly, queryUsersUmForceOrdersResponseInner.reduceOnly)
                && Objects.equals(this.side, queryUsersUmForceOrdersResponseInner.side)
                && Objects.equals(
                        this.positionSide, queryUsersUmForceOrdersResponseInner.positionSide)
                && Objects.equals(this.origType, queryUsersUmForceOrdersResponseInner.origType)
                && Objects.equals(this.time, queryUsersUmForceOrdersResponseInner.time)
                && Objects.equals(this.updateTime, queryUsersUmForceOrdersResponseInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryUsersUmForceOrdersResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryUsersUmForceOrdersResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in QueryUsersUmForceOrdersResponseInner"
                                        + " is not found in the empty JSON string",
                                QueryUsersUmForceOrdersResponseInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!QueryUsersUmForceOrdersResponseInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `QueryUsersUmForceOrdersResponseInner` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryUsersUmForceOrdersResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'QueryUsersUmForceOrdersResponseInner'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryUsersUmForceOrdersResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(QueryUsersUmForceOrdersResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryUsersUmForceOrdersResponseInner>() {
                        @Override
                        public void write(
                                JsonWriter out, QueryUsersUmForceOrdersResponseInner value)
                                throws IOException {
                        ...
                        @Override
                        public QueryUsersUmForceOrdersResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of QueryUsersUmForceOrdersResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryUsersUmForceOrdersResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryUsersUmForceOrdersResponseInner
     */
    public static QueryUsersUmForceOrdersResponseInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, QueryUsersUmForceOrdersResponseInner.class);
    }

    /**
     * Convert an instance of QueryUsersUmForceOrdersResponseInner to an JSON string
     *
     * @return JSON string
     */
