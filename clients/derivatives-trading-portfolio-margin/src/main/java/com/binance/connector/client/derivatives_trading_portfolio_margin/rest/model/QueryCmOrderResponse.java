...
public class QueryCmOrderResponse {
    ...
    public QueryCmOrderResponse() {}

    public QueryCmOrderResponse avgPrice(@jakarta.annotation.Nullable String avgPrice) {
    ...
    public QueryCmOrderResponse clientOrderId(@jakarta.annotation.Nullable String clientOrderId) {
    ...
    public QueryCmOrderResponse cumBase(@jakarta.annotation.Nullable String cumBase) {
    ...
    public QueryCmOrderResponse executedQty(@jakarta.annotation.Nullable String executedQty) {
    ...
    public QueryCmOrderResponse orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public QueryCmOrderResponse origQty(@jakarta.annotation.Nullable String origQty) {
    ...
    public QueryCmOrderResponse origType(@jakarta.annotation.Nullable String origType) {
    ...
    public QueryCmOrderResponse price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public QueryCmOrderResponse reduceOnly(@jakarta.annotation.Nullable Boolean reduceOnly) {
    ...
    public QueryCmOrderResponse side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public QueryCmOrderResponse status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public QueryCmOrderResponse symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public QueryCmOrderResponse pair(@jakarta.annotation.Nullable String pair) {
        this.pair = pair;
        return this;
    }
    ...
    public QueryCmOrderResponse positionSide(@jakarta.annotation.Nullable String positionSide) {
    ...
    public QueryCmOrderResponse time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public QueryCmOrderResponse timeInForce(@jakarta.annotation.Nullable String timeInForce) {
    ...
    public QueryCmOrderResponse type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public QueryCmOrderResponse updateTime(@jakarta.annotation.Nullable Long updateTime) {
    ...
    public boolean equals(Object o) {
        ...
        QueryCmOrderResponse queryCmOrderResponse = (QueryCmOrderResponse) o;
        return Objects.equals(this.avgPrice, queryCmOrderResponse.avgPrice)
                && Objects.equals(this.clientOrderId, queryCmOrderResponse.clientOrderId)
                && Objects.equals(this.cumBase, queryCmOrderResponse.cumBase)
                && Objects.equals(this.executedQty, queryCmOrderResponse.executedQty)
                && Objects.equals(this.orderId, queryCmOrderResponse.orderId)
                && Objects.equals(this.origQty, queryCmOrderResponse.origQty)
                && Objects.equals(this.origType, queryCmOrderResponse.origType)
                && Objects.equals(this.price, queryCmOrderResponse.price)
                && Objects.equals(this.reduceOnly, queryCmOrderResponse.reduceOnly)
                && Objects.equals(this.side, queryCmOrderResponse.side)
                && Objects.equals(this.status, queryCmOrderResponse.status)
                && Objects.equals(this.symbol, queryCmOrderResponse.symbol)
                && Objects.equals(this.pair, queryCmOrderResponse.pair)
                && Objects.equals(this.positionSide, queryCmOrderResponse.positionSide)
                && Objects.equals(this.time, queryCmOrderResponse.time)
                && Objects.equals(this.timeInForce, queryCmOrderResponse.timeInForce)
                && Objects.equals(this.type, queryCmOrderResponse.type)
                && Objects.equals(this.updateTime, queryCmOrderResponse.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryCmOrderResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to QueryCmOrderResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryCmOrderResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in QueryCmOrderResponse is not found in"
                                        + " the empty JSON string",
                                QueryCmOrderResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!QueryCmOrderResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `QueryCmOrderResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryCmOrderResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'QueryCmOrderResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryCmOrderResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(QueryCmOrderResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryCmOrderResponse>() {
                        @Override
                        public void write(JsonWriter out, QueryCmOrderResponse value)
                                throws IOException {
                        ...
                        @Override
                        public QueryCmOrderResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of QueryCmOrderResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryCmOrderResponse
     * @throws IOException if the JSON string is invalid with respect to QueryCmOrderResponse
     */
    public static QueryCmOrderResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, QueryCmOrderResponse.class);
    }

    /**
     * Convert an instance of QueryCmOrderResponse to an JSON string
     *
     * @return JSON string
     */
