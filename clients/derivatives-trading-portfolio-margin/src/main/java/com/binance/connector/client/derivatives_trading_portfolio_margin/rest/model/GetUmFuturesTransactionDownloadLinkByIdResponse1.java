...
public class GetUmFuturesTransactionDownloadLinkByIdResponse1 {
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse1 downloadId(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse1 status(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse1 url(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse1 s3Link(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse1 notified(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse1 expirationTimestamp(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse1 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetUmFuturesTransactionDownloadLinkByIdResponse1
                getUmFuturesTransactionDownloadLinkByIdResponse1 =
                        (GetUmFuturesTransactionDownloadLinkByIdResponse1) o;
        return Objects.equals(
                        this.downloadId,
                        getUmFuturesTransactionDownloadLinkByIdResponse1.downloadId)
                && Objects.equals(
                        this.status, getUmFuturesTransactionDownloadLinkByIdResponse1.status)
                && Objects.equals(this.url, getUmFuturesTransactionDownloadLinkByIdResponse1.url)
                && Objects.equals(
                        this.s3Link, getUmFuturesTransactionDownloadLinkByIdResponse1.s3Link)
                && Objects.equals(
                        this.notified, getUmFuturesTransactionDownloadLinkByIdResponse1.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getUmFuturesTransactionDownloadLinkByIdResponse1.expirationTimestamp)
                && Objects.equals(
                        this.isExpired, getUmFuturesTransactionDownloadLinkByIdResponse1.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetUmFuturesTransactionDownloadLinkByIdResponse1 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetUmFuturesTransactionDownloadLinkByIdResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                        + " GetUmFuturesTransactionDownloadLinkByIdResponse1 is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetUmFuturesTransactionDownloadLinkByIdResponse1.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUmFuturesTransactionDownloadLinkByIdResponse1.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetUmFuturesTransactionDownloadLinkByIdResponse1' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetUmFuturesTransactionDownloadLinkByIdResponse1> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(GetUmFuturesTransactionDownloadLinkByIdResponse1.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetUmFuturesTransactionDownloadLinkByIdResponse1>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                GetUmFuturesTransactionDownloadLinkByIdResponse1 value)
                                throws IOException {
                        ...
                        @Override
                        public GetUmFuturesTransactionDownloadLinkByIdResponse1 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetUmFuturesTransactionDownloadLinkByIdResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetUmFuturesTransactionDownloadLinkByIdResponse1
     * @throws IOException if the JSON string is invalid with respect to
     *     GetUmFuturesTransactionDownloadLinkByIdResponse1
     */
    public static GetUmFuturesTransactionDownloadLinkByIdResponse1 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetUmFuturesTransactionDownloadLinkByIdResponse1.class);
    }

    /**
     * Convert an instance of GetUmFuturesTransactionDownloadLinkByIdResponse1 to an JSON string
     *
     * @return JSON string
     */
