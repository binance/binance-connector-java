...
public class OrderTradeUpdate extends BaseDTO {
    ...
    public OrderTradeUpdate fs(@jakarta.annotation.Nullable String fs) {
        this.fs = fs;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.fs, orderTradeUpdate.fs)
                && Objects.equals(this.E, orderTradeUpdate.E)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(fs, E, T, iLowerCase, oLowerCase);
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderTradeUpdate.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderTradeUpdate' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderTradeUpdate> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OrderTradeUpdate.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderTradeUpdate>() {
                        @Override
                        public void write(JsonWriter out, OrderTradeUpdate value)
                                throws IOException {
                        ...
                        @Override
                        public OrderTradeUpdate read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OrderTradeUpdate given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderTradeUpdate
     * @throws IOException if the JSON string is invalid with respect to OrderTradeUpdate
     */
    public static OrderTradeUpdate fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderTradeUpdate.class);
    }

    /**
     * Convert an instance of OrderTradeUpdate to an JSON string
     *
     * @return JSON string
     */
