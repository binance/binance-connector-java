...
public class QueryUmPositionInformationResponse1Inner {
    ...
    public QueryUmPositionInformationResponse1Inner() {}

    public QueryUmPositionInformationResponse1Inner entryPrice(
    ...
    public QueryUmPositionInformationResponse1Inner leverage(
    ...
    public QueryUmPositionInformationResponse1Inner markPrice(
    ...
    public QueryUmPositionInformationResponse1Inner maxNotionalValue(
    ...
    public QueryUmPositionInformationResponse1Inner positionAmt(
    ...
    public QueryUmPositionInformationResponse1Inner notional(
    ...
    public QueryUmPositionInformationResponse1Inner symbol(
    ...
    public QueryUmPositionInformationResponse1Inner unRealizedProfit(
    ...
    public QueryUmPositionInformationResponse1Inner liquidationPrice(
    ...
    public QueryUmPositionInformationResponse1Inner positionSide(
    ...
    public QueryUmPositionInformationResponse1Inner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        QueryUmPositionInformationResponse1Inner queryUmPositionInformationResponse1Inner =
                (QueryUmPositionInformationResponse1Inner) o;
        return Objects.equals(this.entryPrice, queryUmPositionInformationResponse1Inner.entryPrice)
                && Objects.equals(this.leverage, queryUmPositionInformationResponse1Inner.leverage)
                && Objects.equals(
                        this.markPrice, queryUmPositionInformationResponse1Inner.markPrice)
                && Objects.equals(
                        this.maxNotionalValue,
                        queryUmPositionInformationResponse1Inner.maxNotionalValue)
                && Objects.equals(
                        this.positionAmt, queryUmPositionInformationResponse1Inner.positionAmt)
                && Objects.equals(this.notional, queryUmPositionInformationResponse1Inner.notional)
                && Objects.equals(this.symbol, queryUmPositionInformationResponse1Inner.symbol)
                && Objects.equals(
                        this.unRealizedProfit,
                        queryUmPositionInformationResponse1Inner.unRealizedProfit)
                && Objects.equals(
                        this.liquidationPrice,
                        queryUmPositionInformationResponse1Inner.liquidationPrice)
                && Objects.equals(
                        this.positionSide, queryUmPositionInformationResponse1Inner.positionSide)
                && Objects.equals(
                        this.updateTime, queryUmPositionInformationResponse1Inner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryUmPositionInformationResponse1Inner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryUmPositionInformationResponse1Inner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " QueryUmPositionInformationResponse1Inner is not found in"
                                    + " the empty JSON string",
                                QueryUmPositionInformationResponse1Inner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!QueryUmPositionInformationResponse1Inner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `QueryUmPositionInformationResponse1Inner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryUmPositionInformationResponse1Inner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'QueryUmPositionInformationResponse1Inner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryUmPositionInformationResponse1Inner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(QueryUmPositionInformationResponse1Inner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryUmPositionInformationResponse1Inner>() {
                        @Override
                        public void write(
                                JsonWriter out, QueryUmPositionInformationResponse1Inner value)
                                throws IOException {
                        ...
                        @Override
                        public QueryUmPositionInformationResponse1Inner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of QueryUmPositionInformationResponse1Inner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryUmPositionInformationResponse1Inner
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryUmPositionInformationResponse1Inner
     */
    public static QueryUmPositionInformationResponse1Inner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, QueryUmPositionInformationResponse1Inner.class);
    }

    /**
     * Convert an instance of QueryUmPositionInformationResponse1Inner to an JSON string
     *
     * @return JSON string
     */
