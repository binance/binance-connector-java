...
public class GetUmIncomeHistoryResponseInner {
    ...
    public GetUmIncomeHistoryResponseInner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public GetUmIncomeHistoryResponseInner incomeType(
    ...
    public GetUmIncomeHistoryResponseInner income(@jakarta.annotation.Nullable String income) {
        this.income = income;
        return this;
    }
    ...
    public GetUmIncomeHistoryResponseInner asset(@jakarta.annotation.Nullable String asset) {
        this.asset = asset;
        return this;
    }
    ...
    public GetUmIncomeHistoryResponseInner info(@jakarta.annotation.Nullable String info) {
        this.info = info;
        return this;
    }
    ...
    public GetUmIncomeHistoryResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public GetUmIncomeHistoryResponseInner tradeId(@jakarta.annotation.Nullable String tradeId) {
    ...
    public boolean equals(Object o) {
        ...
        GetUmIncomeHistoryResponseInner getUmIncomeHistoryResponseInner =
                (GetUmIncomeHistoryResponseInner) o;
        return Objects.equals(this.symbol, getUmIncomeHistoryResponseInner.symbol)
                && Objects.equals(this.incomeType, getUmIncomeHistoryResponseInner.incomeType)
                && Objects.equals(this.income, getUmIncomeHistoryResponseInner.income)
                && Objects.equals(this.asset, getUmIncomeHistoryResponseInner.asset)
                && Objects.equals(this.info, getUmIncomeHistoryResponseInner.info)
                && Objects.equals(this.time, getUmIncomeHistoryResponseInner.time)
                && Objects.equals(this.tranId, getUmIncomeHistoryResponseInner.tranId)
                && Objects.equals(this.tradeId, getUmIncomeHistoryResponseInner.tradeId);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetUmIncomeHistoryResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetUmIncomeHistoryResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetUmIncomeHistoryResponseInner is not"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUmIncomeHistoryResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetUmIncomeHistoryResponseInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetUmIncomeHistoryResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetUmIncomeHistoryResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetUmIncomeHistoryResponseInner>() {
                        @Override
                        ...
                        @Override
                        public GetUmIncomeHistoryResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetUmIncomeHistoryResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetUmIncomeHistoryResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     GetUmIncomeHistoryResponseInner
     */
    public static GetUmIncomeHistoryResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetUmIncomeHistoryResponseInner.class);
    }

    /**
     * Convert an instance of GetUmIncomeHistoryResponseInner to an JSON string
     *
     * @return JSON string
     */
