...
public class NewUmOrderResponse {
    ...
    public NewUmOrderResponse() {}

    public NewUmOrderResponse clientOrderId(@jakarta.annotation.Nullable String clientOrderId) {
    ...
    public NewUmOrderResponse cumQty(@jakarta.annotation.Nullable String cumQty) {
        this.cumQty = cumQty;
        return this;
    }
    ...
    public NewUmOrderResponse cumQuote(@jakarta.annotation.Nullable String cumQuote) {
    ...
    public NewUmOrderResponse executedQty(@jakarta.annotation.Nullable String executedQty) {
    ...
    public NewUmOrderResponse orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public NewUmOrderResponse avgPrice(@jakarta.annotation.Nullable String avgPrice) {
    ...
    public NewUmOrderResponse origQty(@jakarta.annotation.Nullable String origQty) {
    ...
    public NewUmOrderResponse price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public NewUmOrderResponse reduceOnly(@jakarta.annotation.Nullable Boolean reduceOnly) {
    ...
    public NewUmOrderResponse side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public NewUmOrderResponse positionSide(@jakarta.annotation.Nullable String positionSide) {
    ...
    public NewUmOrderResponse status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public NewUmOrderResponse symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public NewUmOrderResponse timeInForce(@jakarta.annotation.Nullable String timeInForce) {
    ...
    public NewUmOrderResponse type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public NewUmOrderResponse selfTradePreventionMode(
    ...
    public NewUmOrderResponse goodTillDate(@jakarta.annotation.Nullable Long goodTillDate) {
    ...
    public NewUmOrderResponse updateTime(@jakarta.annotation.Nullable Long updateTime) {
    ...
    public NewUmOrderResponse priceMatch(@jakarta.annotation.Nullable String priceMatch) {
    ...
    public boolean equals(Object o) {
        ...
        NewUmOrderResponse newUmOrderResponse = (NewUmOrderResponse) o;
        return Objects.equals(this.clientOrderId, newUmOrderResponse.clientOrderId)
                && Objects.equals(this.cumQty, newUmOrderResponse.cumQty)
                && Objects.equals(this.cumQuote, newUmOrderResponse.cumQuote)
                && Objects.equals(this.executedQty, newUmOrderResponse.executedQty)
                && Objects.equals(this.orderId, newUmOrderResponse.orderId)
                && Objects.equals(this.avgPrice, newUmOrderResponse.avgPrice)
                && Objects.equals(this.origQty, newUmOrderResponse.origQty)
                && Objects.equals(this.price, newUmOrderResponse.price)
                && Objects.equals(this.reduceOnly, newUmOrderResponse.reduceOnly)
                && Objects.equals(this.side, newUmOrderResponse.side)
                && Objects.equals(this.positionSide, newUmOrderResponse.positionSide)
                && Objects.equals(this.status, newUmOrderResponse.status)
                && Objects.equals(this.symbol, newUmOrderResponse.symbol)
                && Objects.equals(this.timeInForce, newUmOrderResponse.timeInForce)
                && Objects.equals(this.type, newUmOrderResponse.type)
                && Objects.equals(
                        this.selfTradePreventionMode, newUmOrderResponse.selfTradePreventionMode)
                && Objects.equals(this.goodTillDate, newUmOrderResponse.goodTillDate)
                && Objects.equals(this.updateTime, newUmOrderResponse.updateTime)
                && Objects.equals(this.priceMatch, newUmOrderResponse.priceMatch);
    }
    ...
    public String toString() {
        ...
        sb.append("class NewUmOrderResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to NewUmOrderResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!NewUmOrderResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in NewUmOrderResponse is not found in the"
                                        + " empty JSON string",
                                NewUmOrderResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!NewUmOrderResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `NewUmOrderResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewUmOrderResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewUmOrderResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<NewUmOrderResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(NewUmOrderResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<NewUmOrderResponse>() {
                        @Override
                        public void write(JsonWriter out, NewUmOrderResponse value)
                                throws IOException {
                        ...
                        @Override
                        public NewUmOrderResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of NewUmOrderResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of NewUmOrderResponse
     * @throws IOException if the JSON string is invalid with respect to NewUmOrderResponse
     */
    public static NewUmOrderResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, NewUmOrderResponse.class);
    }

    /**
     * Convert an instance of NewUmOrderResponse to an JSON string
     *
     * @return JSON string
     */
