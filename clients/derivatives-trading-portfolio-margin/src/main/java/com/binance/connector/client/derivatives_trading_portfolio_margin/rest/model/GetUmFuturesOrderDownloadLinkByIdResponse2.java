...
public class GetUmFuturesOrderDownloadLinkByIdResponse2 {
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse2 downloadId(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse2 status(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse2 url(@jakarta.annotation.Nullable String url) {
        this.url = url;
        return this;
    }
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse2 s3Link(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse2 notified(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse2 expirationTimestamp(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse2 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetUmFuturesOrderDownloadLinkByIdResponse2 getUmFuturesOrderDownloadLinkByIdResponse2 =
                (GetUmFuturesOrderDownloadLinkByIdResponse2) o;
        return Objects.equals(
                        this.downloadId, getUmFuturesOrderDownloadLinkByIdResponse2.downloadId)
                && Objects.equals(this.status, getUmFuturesOrderDownloadLinkByIdResponse2.status)
                && Objects.equals(this.url, getUmFuturesOrderDownloadLinkByIdResponse2.url)
                && Objects.equals(this.s3Link, getUmFuturesOrderDownloadLinkByIdResponse2.s3Link)
                && Objects.equals(
                        this.notified, getUmFuturesOrderDownloadLinkByIdResponse2.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getUmFuturesOrderDownloadLinkByIdResponse2.expirationTimestamp)
                && Objects.equals(
                        this.isExpired, getUmFuturesOrderDownloadLinkByIdResponse2.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetUmFuturesOrderDownloadLinkByIdResponse2 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetUmFuturesOrderDownloadLinkByIdResponse2.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetUmFuturesOrderDownloadLinkByIdResponse2 is not found in"
                                    + " the empty JSON string",
                                GetUmFuturesOrderDownloadLinkByIdResponse2.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetUmFuturesOrderDownloadLinkByIdResponse2.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `GetUmFuturesOrderDownloadLinkByIdResponse2` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUmFuturesOrderDownloadLinkByIdResponse2.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetUmFuturesOrderDownloadLinkByIdResponse2' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetUmFuturesOrderDownloadLinkByIdResponse2> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetUmFuturesOrderDownloadLinkByIdResponse2.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetUmFuturesOrderDownloadLinkByIdResponse2>() {
                        @Override
                        public void write(
                                JsonWriter out, GetUmFuturesOrderDownloadLinkByIdResponse2 value)
                                throws IOException {
                        ...
                        @Override
                        public GetUmFuturesOrderDownloadLinkByIdResponse2 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetUmFuturesOrderDownloadLinkByIdResponse2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetUmFuturesOrderDownloadLinkByIdResponse2
     * @throws IOException if the JSON string is invalid with respect to
     *     GetUmFuturesOrderDownloadLinkByIdResponse2
     */
    public static GetUmFuturesOrderDownloadLinkByIdResponse2 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetUmFuturesOrderDownloadLinkByIdResponse2.class);
    }

    /**
     * Convert an instance of GetUmFuturesOrderDownloadLinkByIdResponse2 to an JSON string
     *
     * @return JSON string
     */
