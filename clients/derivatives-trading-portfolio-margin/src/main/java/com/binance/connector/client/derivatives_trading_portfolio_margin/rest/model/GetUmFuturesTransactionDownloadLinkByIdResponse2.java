...
public class GetUmFuturesTransactionDownloadLinkByIdResponse2 {
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse2 downloadId(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse2 status(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse2 url(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse2 s3Link(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse2 notified(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse2 expirationTimestamp(
    ...
    public GetUmFuturesTransactionDownloadLinkByIdResponse2 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetUmFuturesTransactionDownloadLinkByIdResponse2
                getUmFuturesTransactionDownloadLinkByIdResponse2 =
                        (GetUmFuturesTransactionDownloadLinkByIdResponse2) o;
        return Objects.equals(
                        this.downloadId,
                        getUmFuturesTransactionDownloadLinkByIdResponse2.downloadId)
                && Objects.equals(
                        this.status, getUmFuturesTransactionDownloadLinkByIdResponse2.status)
                && Objects.equals(this.url, getUmFuturesTransactionDownloadLinkByIdResponse2.url)
                && Objects.equals(
                        this.s3Link, getUmFuturesTransactionDownloadLinkByIdResponse2.s3Link)
                && Objects.equals(
                        this.notified, getUmFuturesTransactionDownloadLinkByIdResponse2.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getUmFuturesTransactionDownloadLinkByIdResponse2.expirationTimestamp)
                && Objects.equals(
                        this.isExpired, getUmFuturesTransactionDownloadLinkByIdResponse2.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetUmFuturesTransactionDownloadLinkByIdResponse2 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetUmFuturesTransactionDownloadLinkByIdResponse2.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                        + " GetUmFuturesTransactionDownloadLinkByIdResponse2 is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetUmFuturesTransactionDownloadLinkByIdResponse2.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUmFuturesTransactionDownloadLinkByIdResponse2.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetUmFuturesTransactionDownloadLinkByIdResponse2' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetUmFuturesTransactionDownloadLinkByIdResponse2> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(GetUmFuturesTransactionDownloadLinkByIdResponse2.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetUmFuturesTransactionDownloadLinkByIdResponse2>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                GetUmFuturesTransactionDownloadLinkByIdResponse2 value)
                                throws IOException {
                        ...
                        @Override
                        public GetUmFuturesTransactionDownloadLinkByIdResponse2 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetUmFuturesTransactionDownloadLinkByIdResponse2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetUmFuturesTransactionDownloadLinkByIdResponse2
     * @throws IOException if the JSON string is invalid with respect to
     *     GetUmFuturesTransactionDownloadLinkByIdResponse2
     */
    public static GetUmFuturesTransactionDownloadLinkByIdResponse2 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetUmFuturesTransactionDownloadLinkByIdResponse2.class);
    }

    /**
     * Convert an instance of GetUmFuturesTransactionDownloadLinkByIdResponse2 to an JSON string
     *
     * @return JSON string
     */
