...
public class CancelMarginAccountOrderResponse {
    ...
    public CancelMarginAccountOrderResponse() {}

    public CancelMarginAccountOrderResponse symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public CancelMarginAccountOrderResponse orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public CancelMarginAccountOrderResponse origClientOrderId(
    ...
    public CancelMarginAccountOrderResponse clientOrderId(
    ...
    public CancelMarginAccountOrderResponse price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public CancelMarginAccountOrderResponse origQty(@jakarta.annotation.Nullable String origQty) {
    ...
    public CancelMarginAccountOrderResponse executedQty(
    ...
    public CancelMarginAccountOrderResponse cummulativeQuoteQty(
    ...
    public CancelMarginAccountOrderResponse status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public CancelMarginAccountOrderResponse timeInForce(
    ...
    public CancelMarginAccountOrderResponse type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public CancelMarginAccountOrderResponse side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        CancelMarginAccountOrderResponse cancelMarginAccountOrderResponse =
                (CancelMarginAccountOrderResponse) o;
        return Objects.equals(this.symbol, cancelMarginAccountOrderResponse.symbol)
                && Objects.equals(this.orderId, cancelMarginAccountOrderResponse.orderId)
                && Objects.equals(
                        this.origClientOrderId, cancelMarginAccountOrderResponse.origClientOrderId)
                && Objects.equals(
                        this.clientOrderId, cancelMarginAccountOrderResponse.clientOrderId)
                && Objects.equals(this.price, cancelMarginAccountOrderResponse.price)
                && Objects.equals(this.origQty, cancelMarginAccountOrderResponse.origQty)
                && Objects.equals(this.executedQty, cancelMarginAccountOrderResponse.executedQty)
                && Objects.equals(
                        this.cummulativeQuoteQty,
                        cancelMarginAccountOrderResponse.cummulativeQuoteQty)
                && Objects.equals(this.status, cancelMarginAccountOrderResponse.status)
                && Objects.equals(this.timeInForce, cancelMarginAccountOrderResponse.timeInForce)
                && Objects.equals(this.type, cancelMarginAccountOrderResponse.type)
                && Objects.equals(this.side, cancelMarginAccountOrderResponse.side);
    }
    ...
    public String toString() {
        ...
        sb.append("class CancelMarginAccountOrderResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CancelMarginAccountOrderResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CancelMarginAccountOrderResponse is"
                                        + " not found in the empty JSON string",
                                CancelMarginAccountOrderResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CancelMarginAccountOrderResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `CancelMarginAccountOrderResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CancelMarginAccountOrderResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CancelMarginAccountOrderResponse' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CancelMarginAccountOrderResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CancelMarginAccountOrderResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CancelMarginAccountOrderResponse>() {
                        @Override
                        ...
                        @Override
                        public CancelMarginAccountOrderResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of CancelMarginAccountOrderResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CancelMarginAccountOrderResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     CancelMarginAccountOrderResponse
     */
    public static CancelMarginAccountOrderResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CancelMarginAccountOrderResponse.class);
    }

    /**
     * Convert an instance of CancelMarginAccountOrderResponse to an JSON string
     *
     * @return JSON string
     */
