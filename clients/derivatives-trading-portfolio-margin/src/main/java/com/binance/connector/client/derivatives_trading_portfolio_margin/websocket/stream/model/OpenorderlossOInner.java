...
public class OpenorderlossOInner extends BaseDTO {
    ...
    public OpenorderlossOInner() {}

    public OpenorderlossOInner aLowerCase(@jakarta.annotation.Nullable String aLowerCase) {
    ...
    public OpenorderlossOInner oLowerCase(@jakarta.annotation.Nullable String oLowerCase) {
    ...
    public boolean equals(Object o) {
        ...
        OpenorderlossOInner openorderlossOInner = (OpenorderlossOInner) o;
        return Objects.equals(this.aLowerCase, openorderlossOInner.aLowerCase)
                && Objects.equals(this.oLowerCase, openorderlossOInner.oLowerCase);
    }

    @Override
    public int hashCode() {
        return Objects.hash(aLowerCase, oLowerCase);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class OpenorderlossOInner {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to OpenorderlossOInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OpenorderlossOInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OpenorderlossOInner is not found in"
                                        + " the empty JSON string",
                                OpenorderlossOInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OpenorderlossOInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OpenorderlossOInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OpenorderlossOInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OpenorderlossOInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OpenorderlossOInner> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OpenorderlossOInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OpenorderlossOInner>() {
                        @Override
                        public void write(JsonWriter out, OpenorderlossOInner value)
                                throws IOException {
                        ...
                        @Override
                        public OpenorderlossOInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OpenorderlossOInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OpenorderlossOInner
     * @throws IOException if the JSON string is invalid with respect to OpenorderlossOInner
     */
    public static OpenorderlossOInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OpenorderlossOInner.class);
    }

    /**
     * Convert an instance of OpenorderlossOInner to an JSON string
     *
     * @return JSON string
     */
