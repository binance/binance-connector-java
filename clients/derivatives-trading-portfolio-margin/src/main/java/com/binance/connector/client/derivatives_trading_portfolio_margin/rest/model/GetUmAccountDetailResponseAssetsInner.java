...
public class GetUmAccountDetailResponseAssetsInner {
    ...
    public GetUmAccountDetailResponseAssetsInner() {}

    public GetUmAccountDetailResponseAssetsInner asset(@jakarta.annotation.Nullable String asset) {
        this.asset = asset;
        return this;
    }
    ...
    public GetUmAccountDetailResponseAssetsInner crossWalletBalance(
    ...
    public GetUmAccountDetailResponseAssetsInner crossUnPnl(
    ...
    public GetUmAccountDetailResponseAssetsInner maintMargin(
    ...
    public GetUmAccountDetailResponseAssetsInner initialMargin(
    ...
    public GetUmAccountDetailResponseAssetsInner positionInitialMargin(
    ...
    public GetUmAccountDetailResponseAssetsInner openOrderInitialMargin(
    ...
    public GetUmAccountDetailResponseAssetsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        GetUmAccountDetailResponseAssetsInner getUmAccountDetailResponseAssetsInner =
                (GetUmAccountDetailResponseAssetsInner) o;
        return Objects.equals(this.asset, getUmAccountDetailResponseAssetsInner.asset)
                && Objects.equals(
                        this.crossWalletBalance,
                        getUmAccountDetailResponseAssetsInner.crossWalletBalance)
                && Objects.equals(this.crossUnPnl, getUmAccountDetailResponseAssetsInner.crossUnPnl)
                && Objects.equals(
                        this.maintMargin, getUmAccountDetailResponseAssetsInner.maintMargin)
                && Objects.equals(
                        this.initialMargin, getUmAccountDetailResponseAssetsInner.initialMargin)
                && Objects.equals(
                        this.positionInitialMargin,
                        getUmAccountDetailResponseAssetsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        getUmAccountDetailResponseAssetsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.updateTime, getUmAccountDetailResponseAssetsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetUmAccountDetailResponseAssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetUmAccountDetailResponseAssetsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetUmAccountDetailResponseAssetsInner"
                                        + " is not found in the empty JSON string",
                                GetUmAccountDetailResponseAssetsInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUmAccountDetailResponseAssetsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetUmAccountDetailResponseAssetsInner'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetUmAccountDetailResponseAssetsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetUmAccountDetailResponseAssetsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetUmAccountDetailResponseAssetsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, GetUmAccountDetailResponseAssetsInner value)
                                throws IOException {
                        ...
                        @Override
                        public GetUmAccountDetailResponseAssetsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetUmAccountDetailResponseAssetsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetUmAccountDetailResponseAssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     GetUmAccountDetailResponseAssetsInner
     */
    public static GetUmAccountDetailResponseAssetsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, GetUmAccountDetailResponseAssetsInner.class);
    }

    /**
     * Convert an instance of GetUmAccountDetailResponseAssetsInner to an JSON string
     *
     * @return JSON string
     */
