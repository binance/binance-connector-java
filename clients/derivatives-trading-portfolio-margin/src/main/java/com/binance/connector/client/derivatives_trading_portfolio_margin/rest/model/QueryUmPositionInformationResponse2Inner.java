...
public class QueryUmPositionInformationResponse2Inner {
    ...
    public QueryUmPositionInformationResponse2Inner() {}

    public QueryUmPositionInformationResponse2Inner symbol(
    ...
    public QueryUmPositionInformationResponse2Inner positionAmt(
    ...
    public QueryUmPositionInformationResponse2Inner entryPrice(
    ...
    public QueryUmPositionInformationResponse2Inner markPrice(
    ...
    public QueryUmPositionInformationResponse2Inner unRealizedProfit(
    ...
    public QueryUmPositionInformationResponse2Inner liquidationPrice(
    ...
    public QueryUmPositionInformationResponse2Inner leverage(
    ...
    public QueryUmPositionInformationResponse2Inner maxNotionalValue(
    ...
    public QueryUmPositionInformationResponse2Inner positionSide(
    ...
    public QueryUmPositionInformationResponse2Inner notional(
    ...
    public QueryUmPositionInformationResponse2Inner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        QueryUmPositionInformationResponse2Inner queryUmPositionInformationResponse2Inner =
                (QueryUmPositionInformationResponse2Inner) o;
        return Objects.equals(this.symbol, queryUmPositionInformationResponse2Inner.symbol)
                && Objects.equals(
                        this.positionAmt, queryUmPositionInformationResponse2Inner.positionAmt)
                && Objects.equals(
                        this.entryPrice, queryUmPositionInformationResponse2Inner.entryPrice)
                && Objects.equals(
                        this.markPrice, queryUmPositionInformationResponse2Inner.markPrice)
                && Objects.equals(
                        this.unRealizedProfit,
                        queryUmPositionInformationResponse2Inner.unRealizedProfit)
                && Objects.equals(
                        this.liquidationPrice,
                        queryUmPositionInformationResponse2Inner.liquidationPrice)
                && Objects.equals(this.leverage, queryUmPositionInformationResponse2Inner.leverage)
                && Objects.equals(
                        this.maxNotionalValue,
                        queryUmPositionInformationResponse2Inner.maxNotionalValue)
                && Objects.equals(
                        this.positionSide, queryUmPositionInformationResponse2Inner.positionSide)
                && Objects.equals(this.notional, queryUmPositionInformationResponse2Inner.notional)
                && Objects.equals(
                        this.updateTime, queryUmPositionInformationResponse2Inner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryUmPositionInformationResponse2Inner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryUmPositionInformationResponse2Inner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " QueryUmPositionInformationResponse2Inner is not found in"
                                    + " the empty JSON string",
                                QueryUmPositionInformationResponse2Inner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!QueryUmPositionInformationResponse2Inner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `QueryUmPositionInformationResponse2Inner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryUmPositionInformationResponse2Inner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'QueryUmPositionInformationResponse2Inner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryUmPositionInformationResponse2Inner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(QueryUmPositionInformationResponse2Inner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryUmPositionInformationResponse2Inner>() {
                        @Override
                        public void write(
                                JsonWriter out, QueryUmPositionInformationResponse2Inner value)
                                throws IOException {
                        ...
                        @Override
                        public QueryUmPositionInformationResponse2Inner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of QueryUmPositionInformationResponse2Inner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryUmPositionInformationResponse2Inner
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryUmPositionInformationResponse2Inner
     */
    public static QueryUmPositionInformationResponse2Inner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, QueryUmPositionInformationResponse2Inner.class);
    }

    /**
     * Convert an instance of QueryUmPositionInformationResponse2Inner to an JSON string
     *
     * @return JSON string
     */
