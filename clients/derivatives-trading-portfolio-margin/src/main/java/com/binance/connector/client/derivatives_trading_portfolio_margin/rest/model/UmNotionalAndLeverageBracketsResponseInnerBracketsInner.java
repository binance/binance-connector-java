...
public class UmNotionalAndLeverageBracketsResponseInnerBracketsInner {
    ...
    public UmNotionalAndLeverageBracketsResponseInnerBracketsInner() {}

    public UmNotionalAndLeverageBracketsResponseInnerBracketsInner bracket(
    ...
    public UmNotionalAndLeverageBracketsResponseInnerBracketsInner initialLeverage(
    ...
    public UmNotionalAndLeverageBracketsResponseInnerBracketsInner notionalCap(
    ...
    public UmNotionalAndLeverageBracketsResponseInnerBracketsInner notionalFloor(
    ...
    public UmNotionalAndLeverageBracketsResponseInnerBracketsInner maintMarginRatio(
    ...
    public UmNotionalAndLeverageBracketsResponseInnerBracketsInner cum(
    ...
    public boolean equals(Object o) {
        ...
        UmNotionalAndLeverageBracketsResponseInnerBracketsInner
                umNotionalAndLeverageBracketsResponseInnerBracketsInner =
                        (UmNotionalAndLeverageBracketsResponseInnerBracketsInner) o;
        return Objects.equals(
                        this.bracket,
                        umNotionalAndLeverageBracketsResponseInnerBracketsInner.bracket)
                && Objects.equals(
                        this.initialLeverage,
                        umNotionalAndLeverageBracketsResponseInnerBracketsInner.initialLeverage)
                && Objects.equals(
                        this.notionalCap,
                        umNotionalAndLeverageBracketsResponseInnerBracketsInner.notionalCap)
                && Objects.equals(
                        this.notionalFloor,
                        umNotionalAndLeverageBracketsResponseInnerBracketsInner.notionalFloor)
                && Objects.equals(
                        this.maintMarginRatio,
                        umNotionalAndLeverageBracketsResponseInnerBracketsInner.maintMarginRatio)
                && Objects.equals(
                        this.cum, umNotionalAndLeverageBracketsResponseInnerBracketsInner.cum);
    }
    ...
    public String toString() {
        ...
        sb.append("class UmNotionalAndLeverageBracketsResponseInnerBracketsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UmNotionalAndLeverageBracketsResponseInnerBracketsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " UmNotionalAndLeverageBracketsResponseInnerBracketsInner is"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!UmNotionalAndLeverageBracketsResponseInnerBracketsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UmNotionalAndLeverageBracketsResponseInnerBracketsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'UmNotionalAndLeverageBracketsResponseInnerBracketsInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<UmNotionalAndLeverageBracketsResponseInnerBracketsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(
                                    UmNotionalAndLeverageBracketsResponseInnerBracketsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<UmNotionalAndLeverageBracketsResponseInnerBracketsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                        ...
                        @Override
                        public UmNotionalAndLeverageBracketsResponseInnerBracketsInner read(
    ...
    /**
     * Create an instance of UmNotionalAndLeverageBracketsResponseInnerBracketsInner given an JSON
     * string
     *
     * @param jsonString JSON string
     * @return An instance of UmNotionalAndLeverageBracketsResponseInnerBracketsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     UmNotionalAndLeverageBracketsResponseInnerBracketsInner
     */
    public static UmNotionalAndLeverageBracketsResponseInnerBracketsInner fromJson(
            String jsonString) throws IOException {
        return JSON.getGson()
                .fromJson(
                        jsonString, UmNotionalAndLeverageBracketsResponseInnerBracketsInner.class);
    }

    /**
     * Convert an instance of UmNotionalAndLeverageBracketsResponseInnerBracketsInner to an JSON
     * string
     *
     * @return JSON string
     */
