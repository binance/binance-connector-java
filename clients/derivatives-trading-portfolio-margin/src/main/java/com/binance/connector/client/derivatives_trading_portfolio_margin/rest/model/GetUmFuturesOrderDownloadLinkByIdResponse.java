...
public class GetUmFuturesOrderDownloadLinkByIdResponse {
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse downloadId(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse status(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse url(@jakarta.annotation.Nullable String url) {
        this.url = url;
        return this;
    }
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse s3Link(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse notified(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse expirationTimestamp(
    ...
    public GetUmFuturesOrderDownloadLinkByIdResponse isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetUmFuturesOrderDownloadLinkByIdResponse getUmFuturesOrderDownloadLinkByIdResponse =
                (GetUmFuturesOrderDownloadLinkByIdResponse) o;
        return Objects.equals(this.downloadId, getUmFuturesOrderDownloadLinkByIdResponse.downloadId)
                && Objects.equals(this.status, getUmFuturesOrderDownloadLinkByIdResponse.status)
                && Objects.equals(this.url, getUmFuturesOrderDownloadLinkByIdResponse.url)
                && Objects.equals(this.s3Link, getUmFuturesOrderDownloadLinkByIdResponse.s3Link)
                && Objects.equals(this.notified, getUmFuturesOrderDownloadLinkByIdResponse.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getUmFuturesOrderDownloadLinkByIdResponse.expirationTimestamp)
                && Objects.equals(
                        this.isExpired, getUmFuturesOrderDownloadLinkByIdResponse.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetUmFuturesOrderDownloadLinkByIdResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetUmFuturesOrderDownloadLinkByIdResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetUmFuturesOrderDownloadLinkByIdResponse is not found in"
                                    + " the empty JSON string",
                                GetUmFuturesOrderDownloadLinkByIdResponse.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetUmFuturesOrderDownloadLinkByIdResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `GetUmFuturesOrderDownloadLinkByIdResponse` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<GetUmFuturesOrderDownloadLinkByIdResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetUmFuturesOrderDownloadLinkByIdResponse.class));
