...
public class UmFuturesAccountConfigurationResponse {
    ...
    public UmFuturesAccountConfigurationResponse() {}

    public UmFuturesAccountConfigurationResponse feeTier(
    ...
    public UmFuturesAccountConfigurationResponse canTrade(
    ...
    public UmFuturesAccountConfigurationResponse canDeposit(
    ...
    public UmFuturesAccountConfigurationResponse canWithdraw(
    ...
    public UmFuturesAccountConfigurationResponse dualSidePosition(
    ...
    public UmFuturesAccountConfigurationResponse updateTime(
    ...
    public UmFuturesAccountConfigurationResponse multiAssetsMargin(
    ...
    public UmFuturesAccountConfigurationResponse tradeGroupId(
    ...
    public boolean equals(Object o) {
        ...
        UmFuturesAccountConfigurationResponse umFuturesAccountConfigurationResponse =
                (UmFuturesAccountConfigurationResponse) o;
        return Objects.equals(this.feeTier, umFuturesAccountConfigurationResponse.feeTier)
                && Objects.equals(this.canTrade, umFuturesAccountConfigurationResponse.canTrade)
                && Objects.equals(this.canDeposit, umFuturesAccountConfigurationResponse.canDeposit)
                && Objects.equals(
                        this.canWithdraw, umFuturesAccountConfigurationResponse.canWithdraw)
                && Objects.equals(
                        this.dualSidePosition,
                        umFuturesAccountConfigurationResponse.dualSidePosition)
                && Objects.equals(this.updateTime, umFuturesAccountConfigurationResponse.updateTime)
                && Objects.equals(
                        this.multiAssetsMargin,
                        umFuturesAccountConfigurationResponse.multiAssetsMargin)
                && Objects.equals(
                        this.tradeGroupId, umFuturesAccountConfigurationResponse.tradeGroupId);
    }
    ...
    public String toString() {
        ...
        sb.append("class UmFuturesAccountConfigurationResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UmFuturesAccountConfigurationResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UmFuturesAccountConfigurationResponse"
                                        + " is not found in the empty JSON string",
                                UmFuturesAccountConfigurationResponse.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!UmFuturesAccountConfigurationResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `UmFuturesAccountConfigurationResponse` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UmFuturesAccountConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UmFuturesAccountConfigurationResponse'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<UmFuturesAccountConfigurationResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(UmFuturesAccountConfigurationResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<UmFuturesAccountConfigurationResponse>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public UmFuturesAccountConfigurationResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of UmFuturesAccountConfigurationResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UmFuturesAccountConfigurationResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     UmFuturesAccountConfigurationResponse
     */
    public static UmFuturesAccountConfigurationResponse fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, UmFuturesAccountConfigurationResponse.class);
    }

    /**
     * Convert an instance of UmFuturesAccountConfigurationResponse to an JSON string
     *
     * @return JSON string
     */
