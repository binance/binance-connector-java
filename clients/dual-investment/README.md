# Binance Java DualInvestment Connector
...
![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-dual-investment)
...
```bash
mvn -f clients/pom.xml -pl dual-investment
```
