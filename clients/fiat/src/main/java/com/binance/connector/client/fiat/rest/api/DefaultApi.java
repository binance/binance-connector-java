...
public class DefaultApi {
     ...
     */
    private okhttp3.Call depositCall(DepositRequest depositRequest, Long recvWindow)
            throws ApiException {
    ...
    private okhttp3.Call depositValidateBeforeCall(DepositRequest depositRequest, Long recvWindow)
            throws ApiException {
        try {
            Validator validator =
            ...
            Object[] parameterValues = {depositRequest, recvWindow};
            Method method = this.getClass().getMethod("deposit", DepositRequest.class, Long.class);
            Set<ConstraintViolation<DefaultApi>> violations =
                    executableValidator.validateParameters(this, method, parameterValues);

            if (violations.size() == 0) {
                return depositCall(depositRequest, recvWindow);
            } else {
    ...
    public ApiResponse<DepositResponse> deposit(
            @Valid @NotNull DepositRequest depositRequest, @Max(60000L) Long recvWindow)
            throws ApiException {
        okhttp3.Call localVarCall = depositValidateBeforeCall(depositRequest, recvWindow);
     ...
     */
    private okhttp3.Call fiatWithdrawCall(FiatWithdrawRequest fiatWithdrawRequest, Long recvWindow)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fiatWithdrawValidateBeforeCall(
        ...
        try {
            ...
            Object[] parameterValues = {fiatWithdrawRequest, recvWindow};
            Method method =
                    this.getClass()
                            .getMethod("fiatWithdraw", FiatWithdrawRequest.class, Long.class);
            Set<ConstraintViolation<DefaultApi>> violations =
                    executableValidator.validateParameters(this, method, parameterValues);

            if (violations.size() == 0) {
                return fiatWithdrawCall(fiatWithdrawRequest, recvWindow);
            } else {
                throw new ConstraintViolationException((Set) violations);
            }
        } catch (NoSuchMethodException e) {
    ...
    public ApiResponse<FiatWithdrawResponse> fiatWithdraw(
            @Valid @NotNull FiatWithdrawRequest fiatWithdrawRequest, @Max(60000L) Long recvWindow)
            throws ApiException {
        okhttp3.Call localVarCall = fiatWithdrawValidateBeforeCall(fiatWithdrawRequest, recvWindow);
    ...
    public ApiResponse<GetOrderDetailResponse> getOrderDetail(
            @NotNull String orderNo, @Max(60000L) Long recvWindow) throws ApiException {
