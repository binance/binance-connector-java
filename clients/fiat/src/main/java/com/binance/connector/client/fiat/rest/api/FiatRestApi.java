...
public class FiatRestApi {
    ...
    public ApiResponse<FiatWithdrawResponse> fiatWithdraw(Long recvWindow) throws ApiException {
        return fiatApi.fiatWithdraw(recvWindow);
    }
     ...
     */
    public ApiResponse<GetOrderDetailResponse> getOrderDetail(String orderId, Long recvWindow)
            throws ApiException {
        return fiatApi.getOrderDetail(orderId, recvWindow);
    }
}
