...
<a id="deposit"></a>
# **deposit**
> DepositResponse deposit(depositRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DepositResponse result = apiInstance.deposit(depositRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FiatApi#deposit");
...
<a id="fiatWithdraw"></a>
# **fiatWithdraw**
> FiatWithdrawResponse fiatWithdraw(fiatWithdrawRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FiatWithdrawResponse result = apiInstance.fiatWithdraw(fiatWithdrawRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    FiatApi apiInstance = new FiatApi(defaultClient);
    String orderNo = "orderNo_example"; // String | order id retrieved from the api call of withdrawal
    Long recvWindow = 56L; // Long | 
    try {
