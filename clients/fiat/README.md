...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-fiat)](https://central.sonatype.com/artifact/io.github.binance/binance-fiat)
...
- [REST API](./src/main/java/com/binance/connector/client/fiat/rest/api)
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/fiat/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/fiat/src/main/java/com/binance/connector/client/fiat/rest) folder.
