# Binance Java Staking Connector
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/staking/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/staking/src/main/java/com/binance/connector/client/staking/rest) folder.
