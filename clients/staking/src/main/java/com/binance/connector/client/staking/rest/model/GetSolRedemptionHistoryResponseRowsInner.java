...
public class GetSolRedemptionHistoryResponseRowsInner {
    ...
    public GetSolRedemptionHistoryResponseRowsInner() {}

    public GetSolRedemptionHistoryResponseRowsInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public GetSolRedemptionHistoryResponseRowsInner arrivalTime(
    ...
    public GetSolRedemptionHistoryResponseRowsInner asset(
    ...
    public GetSolRedemptionHistoryResponseRowsInner amount(
    ...
    public GetSolRedemptionHistoryResponseRowsInner distributeAsset(
    ...
    public GetSolRedemptionHistoryResponseRowsInner distributeAmount(
    ...
    public GetSolRedemptionHistoryResponseRowsInner exchangeRate(
    ...
    public GetSolRedemptionHistoryResponseRowsInner status(
    ...
    public boolean equals(Object o) {
        ...
        GetSolRedemptionHistoryResponseRowsInner getSolRedemptionHistoryResponseRowsInner =
                (GetSolRedemptionHistoryResponseRowsInner) o;
        return Objects.equals(this.time, getSolRedemptionHistoryResponseRowsInner.time)
                && Objects.equals(
                        this.arrivalTime, getSolRedemptionHistoryResponseRowsInner.arrivalTime)
                && Objects.equals(this.asset, getSolRedemptionHistoryResponseRowsInner.asset)
                && Objects.equals(this.amount, getSolRedemptionHistoryResponseRowsInner.amount)
                && Objects.equals(
                        this.distributeAsset,
                        getSolRedemptionHistoryResponseRowsInner.distributeAsset)
                && Objects.equals(
                        this.distributeAmount,
                        getSolRedemptionHistoryResponseRowsInner.distributeAmount)
                && Objects.equals(
                        this.exchangeRate, getSolRedemptionHistoryResponseRowsInner.exchangeRate)
                && Objects.equals(this.status, getSolRedemptionHistoryResponseRowsInner.status);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetSolRedemptionHistoryResponseRowsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetSolRedemptionHistoryResponseRowsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetSolRedemptionHistoryResponseRowsInner is not found in"
                                    + " the empty JSON string",
                                GetSolRedemptionHistoryResponseRowsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetSolRedemptionHistoryResponseRowsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `GetSolRedemptionHistoryResponseRowsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetSolRedemptionHistoryResponseRowsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetSolRedemptionHistoryResponseRowsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetSolRedemptionHistoryResponseRowsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetSolRedemptionHistoryResponseRowsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetSolRedemptionHistoryResponseRowsInner>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public GetSolRedemptionHistoryResponseRowsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetSolRedemptionHistoryResponseRowsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetSolRedemptionHistoryResponseRowsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     GetSolRedemptionHistoryResponseRowsInner
     */
    public static GetSolRedemptionHistoryResponseRowsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, GetSolRedemptionHistoryResponseRowsInner.class);
    }

    /**
     * Convert an instance of GetSolRedemptionHistoryResponseRowsInner to an JSON string
     *
     * @return JSON string
     */
