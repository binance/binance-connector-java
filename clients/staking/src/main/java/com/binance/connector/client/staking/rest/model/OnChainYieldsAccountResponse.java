...
public class OnChainYieldsAccountResponse {
    ...
    public OnChainYieldsAccountResponse() {}

    public OnChainYieldsAccountResponse totalAmountInBTC(
    ...
    public OnChainYieldsAccountResponse totalAmountInUSDT(
    ...
    public OnChainYieldsAccountResponse totalFlexibleAmountInBTC(
    ...
    public OnChainYieldsAccountResponse totalFlexibleAmountInUSDT(
    ...
    public OnChainYieldsAccountResponse totalLockedInBTC(
    ...
    public OnChainYieldsAccountResponse totalLockedInUSDT(
    ...
    public boolean equals(Object o) {
        ...
        OnChainYieldsAccountResponse onChainYieldsAccountResponse =
                (OnChainYieldsAccountResponse) o;
        return Objects.equals(this.totalAmountInBTC, onChainYieldsAccountResponse.totalAmountInBTC)
                && Objects.equals(
                        this.totalAmountInUSDT, onChainYieldsAccountResponse.totalAmountInUSDT)
                && Objects.equals(
                        this.totalFlexibleAmountInBTC,
                        onChainYieldsAccountResponse.totalFlexibleAmountInBTC)
                && Objects.equals(
                        this.totalFlexibleAmountInUSDT,
                        onChainYieldsAccountResponse.totalFlexibleAmountInUSDT)
                && Objects.equals(
                        this.totalLockedInBTC, onChainYieldsAccountResponse.totalLockedInBTC)
                && Objects.equals(
                        this.totalLockedInUSDT, onChainYieldsAccountResponse.totalLockedInUSDT);
    }
    ...
    public String toString() {
        ...
        sb.append("class OnChainYieldsAccountResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OnChainYieldsAccountResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OnChainYieldsAccountResponse is not"
                                        + " found in the empty JSON string",
                                OnChainYieldsAccountResponse.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OnChainYieldsAccountResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OnChainYieldsAccountResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OnChainYieldsAccountResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OnChainYieldsAccountResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OnChainYieldsAccountResponse>() {
                        @Override
                        ...
                        @Override
                        public OnChainYieldsAccountResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OnChainYieldsAccountResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OnChainYieldsAccountResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     OnChainYieldsAccountResponse
     */
    public static OnChainYieldsAccountResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OnChainYieldsAccountResponse.class);
    }

    /**
     * Convert an instance of OnChainYieldsAccountResponse to an JSON string
     *
     * @return JSON string
     */
