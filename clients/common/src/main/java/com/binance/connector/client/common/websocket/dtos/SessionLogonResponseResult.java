...
public class SessionLogonResponseResult extends BaseDTO {
    ...
    public String toString() {
        String sb =
                "class SessionLogonResponseResult {\n"
                        + "		apiKey: "
                        + toIndentedString(apiKey)
                        + "\n"
                        + "		authorizedSince: "
                        + toIndentedString(authorizedSince)
                        + "\n"
                        + "		connectedSince: "
                        + toIndentedString(connectedSince)
                        + "\n"
                        + "		returnRateLimits: "
                        + toIndentedString(returnRateLimits)
                        + "\n"
                        + "		serverTime: "
                        + toIndentedString(serverTime)
                        + "\n"
                        + "		userDataStream: "
                        + toIndentedString(userDataStream)
                        + "\n"
                        + "}";
        return sb;
    }
    ...
    public String toUrlQueryString() {
        ...
        if (apiKeyValue != null) {
            ...
            valMap.put("apiKey", urlEncode(apiKeyValueAsString));
        }
        Object authorizedSinceValue = getAuthorizedSince();
        if (authorizedSinceValue != null) {
            String authorizedSinceValueAsString = "";
            authorizedSinceValueAsString = authorizedSinceValue.toString();
            valMap.put("authorizedSince", urlEncode(authorizedSinceValueAsString));
        }
        Object connectedSinceValue = getConnectedSince();
        if (connectedSinceValue != null) {
            String connectedSinceValueAsString = "";
            connectedSinceValueAsString = connectedSinceValue.toString();
            valMap.put("connectedSince", urlEncode(connectedSinceValueAsString));
        }
        Object returnRateLimitsValue = getReturnRateLimits();
        if (returnRateLimitsValue != null) {
            String returnRateLimitsValueAsString = "";
            returnRateLimitsValueAsString = returnRateLimitsValue.toString();
            valMap.put("returnRateLimits", urlEncode(returnRateLimitsValueAsString));
        }
        ...
        if (serverTimeValue != null) {
            ...
            valMap.put("serverTime", urlEncode(serverTimeValueAsString));
        }
        Object userDataStreamValue = getUserDataStream();
        if (userDataStreamValue != null) {
            String userDataStreamValueAsString = "";
            userDataStreamValueAsString = userDataStreamValue.toString();
            valMap.put("userDataStream", urlEncode(userDataStreamValueAsString));
        }
            ...
            if (!SessionLogonResponseResult.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                ...
                                SessionLogonResponseResult.openapiRequiredFields));
            }
        }
