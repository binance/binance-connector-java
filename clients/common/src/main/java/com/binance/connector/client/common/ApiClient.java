...
public class ApiClient {
    ...
    public ApiClient(
        ...
        Interceptor retryInterceptor =
                getRetryInterceptor(configuration.getRetries(), configuration.getBackOff());
        ...
        if (!configuration.getCompression()) {
            builder.addNetworkInterceptor(new AcceptEncodingInterceptor());
        }
        ...
        Authentication timeUnit =
                (queryParams, headerParams, cookieParams, payload, method, uri) -> {
                    if (configuration.getTimeUnit() != null
                            && !headerParams.containsKey(HEADER_TIMEUNIT)) {
                        headerParams.put(HEADER_TIMEUNIT, configuration.getTimeUnit().toString());
                    }
                };
        authentications.put("timeUnit", timeUnit);
    ...
    public Interceptor getRetryInterceptor(Integer retryCount, Integer retryBackoff) {
        return chain -> {
            ...
            int tryCount = 0;
            while (shouldRetry(request, response) && tryCount < retryCount) {
                try {
    ...
    /**
     * Determine if the request should be retried based on the method and response code
     *
     * @param request
     * @param response
     * @return
    ...
    private boolean shouldRetry(Request request, Response response) {
        ...
        // Server-side error, we can retry
        boolean serverError = response.code() >= HttpURLConnection.HTTP_INTERNAL_ERROR;
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.binance.com
     ...
     * @return a {@link com.binance.connector.client.common.ApiClient} object
     */
     ...
     * @throws com.binance.connector.client.common.ApiException If fail to deserialize response
    ...
    public <T> T deserialize(Response response, Type returnType) throws ApiException {
        ...
        if (isJsonMime(contentType)) {
            if (json != null) {
                return json.fromJson(respBody, returnType);
            } else {
     ...
     * @throws com.binance.connector.client.common.ApiException If fail to serialize the given
     *     object
     */
     ...
     * @throws com.binance.connector.client.common.ApiException If fail to read file content from
    ...
    public File prepareDownloadFile(Response response) throws IOException {
        ...
        if (filename == null) {
            ...
            if (prefix.length() < MIN_FILENAME_SIZE) {
                prefix = "download-";
            }
        }
     ...
     * @throws com.binance.connector.client.common.ApiException If fail to execute the call
     */
     ...
     * @return Type
     * @throws com.binance.connector.client.common.ApiException If the response has an unsuccessful
     *     status code or fail to deserialize the response body
     */
    public <T> T handleResponse(Response response, Type returnType) throws ApiException {
        if (response.isSuccessful()) {
            if (returnType == null || response.code() == HttpURLConnection.HTTP_NO_CONTENT) {
     ...
     * @throws com.binance.connector.client.common.ApiException If fail to serialize the request
     *     body object
     */
    ...
    public String buildUrl(
        ...
        if (baseUrl != null) {
            ...
            if (serverIndex != null) {
                ...
                baseURL = servers.get(serverIndex).setURL(serverVariables);
            } else {
                baseURL = basePath;
            }
            url.append(baseURL).append(path);
