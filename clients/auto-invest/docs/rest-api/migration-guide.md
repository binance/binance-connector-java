...
<dependency>
  <groupId>io.github.binance</groupId>
  <artifactId>binance-auto-invest</artifactId>
...
```java
import com.binance.connector.client.auto-invest.rest.api.AutoInvestRestApi;
```

4. **Configuration and Client Initialization**:  
   The new structure keeps the existing configuration options but modularized clients into `AutoInvestRestApi`.
