...
public class VolumeParticipationFutureAlgoResponse {
    ...
    public VolumeParticipationFutureAlgoResponse() {}

    public VolumeParticipationFutureAlgoResponse clientAlgoId(
    ...
    public VolumeParticipationFutureAlgoResponse success(
    ...
    public VolumeParticipationFutureAlgoResponse code(@jakarta.annotation.Nullable Long code) {
        this.code = code;
        return this;
    }
    ...
    public VolumeParticipationFutureAlgoResponse msg(@jakarta.annotation.Nullable String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        VolumeParticipationFutureAlgoResponse volumeParticipationFutureAlgoResponse =
                (VolumeParticipationFutureAlgoResponse) o;
        return Objects.equals(this.clientAlgoId, volumeParticipationFutureAlgoResponse.clientAlgoId)
                && Objects.equals(this.success, volumeParticipationFutureAlgoResponse.success)
                && Objects.equals(this.code, volumeParticipationFutureAlgoResponse.code)
                && Objects.equals(this.msg, volumeParticipationFutureAlgoResponse.msg);
    }
    ...
    public String toString() {
        ...
        sb.append("class VolumeParticipationFutureAlgoResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!VolumeParticipationFutureAlgoResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in VolumeParticipationFutureAlgoResponse"
                                        + " is not found in the empty JSON string",
                                VolumeParticipationFutureAlgoResponse.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!VolumeParticipationFutureAlgoResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'VolumeParticipationFutureAlgoResponse'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<VolumeParticipationFutureAlgoResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(VolumeParticipationFutureAlgoResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<VolumeParticipationFutureAlgoResponse>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public VolumeParticipationFutureAlgoResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of VolumeParticipationFutureAlgoResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of VolumeParticipationFutureAlgoResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     VolumeParticipationFutureAlgoResponse
     */
    public static VolumeParticipationFutureAlgoResponse fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, VolumeParticipationFutureAlgoResponse.class);
    }

    /**
     * Convert an instance of VolumeParticipationFutureAlgoResponse to an JSON string
     *
     * @return JSON string
     */
