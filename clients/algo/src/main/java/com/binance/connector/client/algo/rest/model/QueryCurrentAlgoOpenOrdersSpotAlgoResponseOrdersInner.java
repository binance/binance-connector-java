...
public class QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner {
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner() {}

    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner algoId(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner symbol(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner side(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner totalQty(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner executedQty(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner executedAmt(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner avgPrice(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner clientAlgoId(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner bookTime(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner endTime(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner algoStatus(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner algoType(
    ...
    public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner urgency(
    ...
    public boolean equals(Object o) {
        ...
        QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner
                queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner =
                        (QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner) o;
        return Objects.equals(
                        this.algoId, queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.algoId)
                && Objects.equals(
                        this.symbol, queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.symbol)
                && Objects.equals(
                        this.side, queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.side)
                && Objects.equals(
                        this.totalQty,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.totalQty)
                && Objects.equals(
                        this.executedQty,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.executedQty)
                && Objects.equals(
                        this.executedAmt,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.executedAmt)
                && Objects.equals(
                        this.avgPrice,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.avgPrice)
                && Objects.equals(
                        this.clientAlgoId,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.clientAlgoId)
                && Objects.equals(
                        this.bookTime,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.bookTime)
                && Objects.equals(
                        this.endTime, queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.endTime)
                && Objects.equals(
                        this.algoStatus,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.algoStatus)
                && Objects.equals(
                        this.algoType,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.algoType)
                && Objects.equals(
                        this.urgency,
                        queryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.urgency);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner is"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(
                                    QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                        ...
                        @Override
                        public QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner read(
    ...
    /**
     * Create an instance of QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner given an JSON
     * string
     *
     * @param jsonString JSON string
     * @return An instance of QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner
     */
    public static QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner.class);
    }

    /**
     * Convert an instance of QueryCurrentAlgoOpenOrdersSpotAlgoResponseOrdersInner to an JSON
     * string
     *
     * @return JSON string
     */
