...
public class VolumeParticipationFutureAlgoRequest {
    ...
    public VolumeParticipationFutureAlgoRequest() {}

    public VolumeParticipationFutureAlgoRequest symbol(@jakarta.annotation.Nonnull String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public VolumeParticipationFutureAlgoRequest quantity(
    ...
    public VolumeParticipationFutureAlgoRequest clientAlgoId(
    ...
    public VolumeParticipationFutureAlgoRequest reduceOnly(
    ...
    public VolumeParticipationFutureAlgoRequest limitPrice(
    ...
    public VolumeParticipationFutureAlgoRequest recvWindow(
    ...
    public boolean equals(Object o) {
        ...
        VolumeParticipationFutureAlgoRequest volumeParticipationFutureAlgoRequest =
                (VolumeParticipationFutureAlgoRequest) o;
        return Objects.equals(this.symbol, volumeParticipationFutureAlgoRequest.symbol)
                && Objects.equals(this.side, volumeParticipationFutureAlgoRequest.side)
                && Objects.equals(
                        this.positionSide, volumeParticipationFutureAlgoRequest.positionSide)
                && Objects.equals(this.quantity, volumeParticipationFutureAlgoRequest.quantity)
                && Objects.equals(this.urgency, volumeParticipationFutureAlgoRequest.urgency)
                && Objects.equals(
                        this.clientAlgoId, volumeParticipationFutureAlgoRequest.clientAlgoId)
                && Objects.equals(this.reduceOnly, volumeParticipationFutureAlgoRequest.reduceOnly)
                && Objects.equals(this.limitPrice, volumeParticipationFutureAlgoRequest.limitPrice)
                && Objects.equals(this.recvWindow, volumeParticipationFutureAlgoRequest.recvWindow);
    }
    ...
    public String toString() {
        ...
        sb.append("class VolumeParticipationFutureAlgoRequest {\n");
    ...
    static {
        ...
        openapiRequiredFields.add("urgency");
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!VolumeParticipationFutureAlgoRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in VolumeParticipationFutureAlgoRequest"
                                        + " is not found in the empty JSON string",
                                VolumeParticipationFutureAlgoRequest.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!VolumeParticipationFutureAlgoRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'VolumeParticipationFutureAlgoRequest'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<VolumeParticipationFutureAlgoRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(VolumeParticipationFutureAlgoRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<VolumeParticipationFutureAlgoRequest>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public VolumeParticipationFutureAlgoRequest read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of VolumeParticipationFutureAlgoRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of VolumeParticipationFutureAlgoRequest
     * @throws IOException if the JSON string is invalid with respect to
     *     VolumeParticipationFutureAlgoRequest
     */
    public static VolumeParticipationFutureAlgoRequest fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, VolumeParticipationFutureAlgoRequest.class);
    }

    /**
     * Convert an instance of VolumeParticipationFutureAlgoRequest to an JSON string
     *
     * @return JSON string
     */
