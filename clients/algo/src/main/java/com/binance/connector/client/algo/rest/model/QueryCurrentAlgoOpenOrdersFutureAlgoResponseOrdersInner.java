...
public class QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner {
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner() {}

    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner algoId(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner symbol(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner side(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner positionSide(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner totalQty(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner executedQty(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner executedAmt(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner avgPrice(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner clientAlgoId(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner bookTime(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner endTime(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner algoStatus(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner algoType(
    ...
    public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner urgency(
    ...
    public boolean equals(Object o) {
        ...
        QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner
                queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner =
                        (QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner) o;
        return Objects.equals(
                        this.algoId, queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.algoId)
                && Objects.equals(
                        this.symbol, queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.symbol)
                && Objects.equals(
                        this.side, queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.side)
                && Objects.equals(
                        this.positionSide,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.positionSide)
                && Objects.equals(
                        this.totalQty,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.totalQty)
                && Objects.equals(
                        this.executedQty,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.executedQty)
                && Objects.equals(
                        this.executedAmt,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.executedAmt)
                && Objects.equals(
                        this.avgPrice,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.avgPrice)
                && Objects.equals(
                        this.clientAlgoId,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.clientAlgoId)
                && Objects.equals(
                        this.bookTime,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.bookTime)
                && Objects.equals(
                        this.endTime,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.endTime)
                && Objects.equals(
                        this.algoStatus,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.algoStatus)
                && Objects.equals(
                        this.algoType,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.algoType)
                && Objects.equals(
                        this.urgency,
                        queryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.urgency);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner is"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(
                                    QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                        ...
                        @Override
                        public QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner read(
    ...
    /**
     * Create an instance of QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner given an JSON
     * string
     *
     * @param jsonString JSON string
     * @return An instance of QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner
     */
    public static QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner fromJson(
            String jsonString) throws IOException {
        return JSON.getGson()
                .fromJson(
                        jsonString, QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner.class);
    }

    /**
     * Convert an instance of QueryCurrentAlgoOpenOrdersFutureAlgoResponseOrdersInner to an JSON
     * string
     *
     * @return JSON string
     */
