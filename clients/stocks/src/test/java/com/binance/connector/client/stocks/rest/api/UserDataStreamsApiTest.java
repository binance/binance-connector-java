...
public class UserDataStreamsApiTest {
     ...
     */
    @Test
    public void createRenewListenKeyTest() throws ApiException, CryptoException, IOException {
        Long recvWindow = 5000L;
        ApiResponse<CreateRenewListenKeyResponse> response = api.createRenewListenKey(recvWindow);
        ...
        assertEquals("/sapi/v1/equity/listenKey", actualRequest.url().encodedPath());
    }
}
