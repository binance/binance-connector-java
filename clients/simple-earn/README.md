# Binance Java SimpleEarn Connector
...
More examples can be found in the [`examples/rest-api`](./examples/simple-earn/src/main/java/com/binance/connector/client/simple-earn/rest) folder.
