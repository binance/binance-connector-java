...
public class GetLockedSubscriptionRecordResponseRowsInner {
    ...
    public GetLockedSubscriptionRecordResponseRowsInner() {}

    public GetLockedSubscriptionRecordResponseRowsInner positionId(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner purchaseId(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner projectId(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner time(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner asset(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner amount(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner lockPeriod(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner type(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner sourceAccount(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner amtFromSpot(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner amtFromFunding(
    ...
    public GetLockedSubscriptionRecordResponseRowsInner status(
    ...
    public boolean equals(Object o) {
        ...
        GetLockedSubscriptionRecordResponseRowsInner getLockedSubscriptionRecordResponseRowsInner =
                (GetLockedSubscriptionRecordResponseRowsInner) o;
        return Objects.equals(
                        this.positionId, getLockedSubscriptionRecordResponseRowsInner.positionId)
                && Objects.equals(
                        this.purchaseId, getLockedSubscriptionRecordResponseRowsInner.purchaseId)
                && Objects.equals(
                        this.projectId, getLockedSubscriptionRecordResponseRowsInner.projectId)
                && Objects.equals(this.time, getLockedSubscriptionRecordResponseRowsInner.time)
                && Objects.equals(this.asset, getLockedSubscriptionRecordResponseRowsInner.asset)
                && Objects.equals(this.amount, getLockedSubscriptionRecordResponseRowsInner.amount)
                && Objects.equals(
                        this.lockPeriod, getLockedSubscriptionRecordResponseRowsInner.lockPeriod)
                && Objects.equals(this.type, getLockedSubscriptionRecordResponseRowsInner.type)
                && Objects.equals(
                        this.sourceAccount,
                        getLockedSubscriptionRecordResponseRowsInner.sourceAccount)
                && Objects.equals(
                        this.amtFromSpot, getLockedSubscriptionRecordResponseRowsInner.amtFromSpot)
                && Objects.equals(
                        this.amtFromFunding,
                        getLockedSubscriptionRecordResponseRowsInner.amtFromFunding)
                && Objects.equals(this.status, getLockedSubscriptionRecordResponseRowsInner.status);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetLockedSubscriptionRecordResponseRowsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetLockedSubscriptionRecordResponseRowsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetLockedSubscriptionRecordResponseRowsInner is not found"
                                    + " in the empty JSON string",
                                GetLockedSubscriptionRecordResponseRowsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetLockedSubscriptionRecordResponseRowsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `GetLockedSubscriptionRecordResponseRowsInner` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetLockedSubscriptionRecordResponseRowsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetLockedSubscriptionRecordResponseRowsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetLockedSubscriptionRecordResponseRowsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(GetLockedSubscriptionRecordResponseRowsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetLockedSubscriptionRecordResponseRowsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, GetLockedSubscriptionRecordResponseRowsInner value)
                                throws IOException {
                        ...
                        @Override
                        public GetLockedSubscriptionRecordResponseRowsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetLockedSubscriptionRecordResponseRowsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetLockedSubscriptionRecordResponseRowsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     GetLockedSubscriptionRecordResponseRowsInner
     */
    public static GetLockedSubscriptionRecordResponseRowsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetLockedSubscriptionRecordResponseRowsInner.class);
    }

    /**
     * Convert an instance of GetLockedSubscriptionRecordResponseRowsInner to an JSON string
     *
     * @return JSON string
     */
