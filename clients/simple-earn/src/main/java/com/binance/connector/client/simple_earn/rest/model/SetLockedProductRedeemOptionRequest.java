...
public class SetLockedProductRedeemOptionRequest {
    ...
    public SetLockedProductRedeemOptionRequest() {}

    public SetLockedProductRedeemOptionRequest positionId(
    ...
    public SetLockedProductRedeemOptionRequest recvWindow(
    ...
    public boolean equals(Object o) {
        ...
        SetLockedProductRedeemOptionRequest setLockedProductRedeemOptionRequest =
                (SetLockedProductRedeemOptionRequest) o;
        return Objects.equals(this.positionId, setLockedProductRedeemOptionRequest.positionId)
                && Objects.equals(this.redeemTo, setLockedProductRedeemOptionRequest.redeemTo)
                && Objects.equals(this.recvWindow, setLockedProductRedeemOptionRequest.recvWindow);
    }
    ...
    public String toString() {
        ...
        sb.append("class SetLockedProductRedeemOptionRequest {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SetLockedProductRedeemOptionRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SetLockedProductRedeemOptionRequest is"
                                        + " not found in the empty JSON string",
                                SetLockedProductRedeemOptionRequest.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SetLockedProductRedeemOptionRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SetLockedProductRedeemOptionRequest' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<SetLockedProductRedeemOptionRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(SetLockedProductRedeemOptionRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<SetLockedProductRedeemOptionRequest>() {
                        @Override
                        ...
                        @Override
                        public SetLockedProductRedeemOptionRequest read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of SetLockedProductRedeemOptionRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SetLockedProductRedeemOptionRequest
     * @throws IOException if the JSON string is invalid with respect to
     *     SetLockedProductRedeemOptionRequest
     */
    public static SetLockedProductRedeemOptionRequest fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, SetLockedProductRedeemOptionRequest.class);
    }

    /**
     * Convert an instance of SetLockedProductRedeemOptionRequest to an JSON string
     *
     * @return JSON string
     */
