...
public class GetRwusdQuotaDetailsResponse {
    ...
    private GetRwusdQuotaDetailsResponseSubscriptionQuota subscriptionQuota;
    ...
    @jakarta.annotation.Nullable
    private GetRwusdQuotaDetailsResponseFastRedemptionQuota fastRedemptionQuota;
    ...
    @jakarta.annotation.Nullable
    private GetRwusdQuotaDetailsResponseStandardRedemptionQuota standardRedemptionQuota;
    ...
    public GetRwusdQuotaDetailsResponse() {}

    public GetRwusdQuotaDetailsResponse subscriptionQuota(
            @jakarta.annotation.Nullable
                    GetRwusdQuotaDetailsResponseSubscriptionQuota subscriptionQuota) {
    ...
    @jakarta.annotation.Nullable
    @Valid
    public GetRwusdQuotaDetailsResponseSubscriptionQuota getSubscriptionQuota() {
        return subscriptionQuota;
    }
    ...
    public GetRwusdQuotaDetailsResponse fastRedemptionQuota(
            @jakarta.annotation.Nullable
                    GetRwusdQuotaDetailsResponseFastRedemptionQuota fastRedemptionQuota) {
    ...
    @jakarta.annotation.Nullable
    @Valid
    public GetRwusdQuotaDetailsResponseFastRedemptionQuota getFastRedemptionQuota() {
        return fastRedemptionQuota;
    }
    ...
    public GetRwusdQuotaDetailsResponse standardRedemptionQuota(
            @jakarta.annotation.Nullable
                    GetRwusdQuotaDetailsResponseStandardRedemptionQuota standardRedemptionQuota) {
    ...
    @jakarta.annotation.Nullable
    @Valid
    public GetRwusdQuotaDetailsResponseStandardRedemptionQuota getStandardRedemptionQuota() {
        return standardRedemptionQuota;
    }
    ...
    public GetRwusdQuotaDetailsResponse subscribeEnable(
    ...
    public GetRwusdQuotaDetailsResponse redeemEnable(
    ...
    public boolean equals(Object o) {
        ...
        GetRwusdQuotaDetailsResponse getRwusdQuotaDetailsResponse =
                (GetRwusdQuotaDetailsResponse) o;
        return Objects.equals(
                        this.subscriptionQuota, getRwusdQuotaDetailsResponse.subscriptionQuota)
                && Objects.equals(
                        this.fastRedemptionQuota, getRwusdQuotaDetailsResponse.fastRedemptionQuota)
                && Objects.equals(
                        this.standardRedemptionQuota,
                        getRwusdQuotaDetailsResponse.standardRedemptionQuota)
                && Objects.equals(
                        this.subscribeEnable, getRwusdQuotaDetailsResponse.subscribeEnable)
                && Objects.equals(this.redeemEnable, getRwusdQuotaDetailsResponse.redeemEnable);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetRwusdQuotaDetailsResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetRwusdQuotaDetailsResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetRwusdQuotaDetailsResponse is not"
                                        + " found in the empty JSON string",
                                GetRwusdQuotaDetailsResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("subscriptionQuota") != null
            ...
            GetRwusdQuotaDetailsResponseSubscriptionQuota.validateJsonElement(
        ...
        if (jsonObj.get("fastRedemptionQuota") != null
            ...
            GetRwusdQuotaDetailsResponseFastRedemptionQuota.validateJsonElement(
        ...
        if (jsonObj.get("standardRedemptionQuota") != null
            ...
            GetRwusdQuotaDetailsResponseStandardRedemptionQuota.validateJsonElement(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetRwusdQuotaDetailsResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetRwusdQuotaDetailsResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetRwusdQuotaDetailsResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetRwusdQuotaDetailsResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetRwusdQuotaDetailsResponse>() {
                        @Override
                        public void write(JsonWriter out, GetRwusdQuotaDetailsResponse value)
                                throws IOException {
                        ...
                        @Override
                        public GetRwusdQuotaDetailsResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetRwusdQuotaDetailsResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetRwusdQuotaDetailsResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     GetRwusdQuotaDetailsResponse
     */
    public static GetRwusdQuotaDetailsResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetRwusdQuotaDetailsResponse.class);
    }

    /**
     * Convert an instance of GetRwusdQuotaDetailsResponse to an JSON string
     *
     * @return JSON string
     */
