...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-wallet)](https://central.sonatype.com/artifact/io.github.binance/binance-wallet)
...
- [REST API](./src/main/java/com/binance/connector/client/wallet/rest/api)
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/wallet/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/wallet/src/main/java/com/binance/connector/client/wallet/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl wallet test
```
