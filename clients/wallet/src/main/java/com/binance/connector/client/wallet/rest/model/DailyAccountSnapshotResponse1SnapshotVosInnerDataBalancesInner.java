...
public class DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner {
    ...
    public DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner() {}

    public DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner asset(
    ...
    public DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner free(
    ...
    public DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner locked(
    ...
    public boolean equals(Object o) {
        ...
        DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner
                dailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner =
                        (DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner) o;
        return Objects.equals(
                        this.asset,
                        dailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner.asset)
                && Objects.equals(
                        this.free,
                        dailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner.free)
                && Objects.equals(
                        this.locked,
                        dailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner.locked);
    }
    ...
    public String toString() {
        ...
        sb.append("class DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner.openapiFields
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner.class
                    .isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                // 'DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner>
                    thisAdapter =
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<
                        ...
                        @Override
                        public DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner read(
    ...
    /**
     * Create an instance of DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner given an
     * JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner
     * @throws IOException if the JSON string is invalid with respect to
     *     DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner
     */
    public static DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner fromJson(
            String jsonString) throws IOException {
        return JSON.getGson()
                .fromJson(
                        jsonString,
                        DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner.class);
    }

    /**
     * Convert an instance of DailyAccountSnapshotResponse1SnapshotVosInnerDataBalancesInner to an
     * JSON string
     *
     * @return JSON string
     */
