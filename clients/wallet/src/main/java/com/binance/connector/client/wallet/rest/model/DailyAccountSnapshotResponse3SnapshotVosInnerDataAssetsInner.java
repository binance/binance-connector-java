...
public class DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner {
    ...
    public DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner() {}

    public DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner asset(
    ...
    public DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner marginBalance(
    ...
    public DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner walletBalance(
    ...
    public boolean equals(Object o) {
        ...
        DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner
                dailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner =
                        (DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner) o;
        return Objects.equals(
                        this.asset,
                        dailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner.asset)
                && Objects.equals(
                        this.marginBalance,
                        dailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner.marginBalance)
                && Objects.equals(
                        this.walletBalance,
                        dailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner.walletBalance);
    }
    ...
    public String toString() {
        ...
        sb.append("class DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner.openapiRequiredFields
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner.openapiFields
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner.class
                    .isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes
                // 'DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner>
                    thisAdapter =
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<
                        ...
                        public void write(
                                JsonWriter out,
                                DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner value)
                                throws IOException {
                        ...
                        @Override
                        public DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner read(
    ...
    /**
     * Create an instance of DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner given an
     * JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner
     */
    public static DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner fromJson(
            String jsonString) throws IOException {
        return JSON.getGson()
                .fromJson(
                        jsonString,
                        DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner.class);
    }

    /**
     * Convert an instance of DailyAccountSnapshotResponse3SnapshotVosInnerDataAssetsInner to an
     * JSON string
     *
     * @return JSON string
     */
