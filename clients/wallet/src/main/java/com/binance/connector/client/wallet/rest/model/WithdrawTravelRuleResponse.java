...
public class WithdrawTravelRuleResponse {
    ...
    public WithdrawTravelRuleResponse trId(@jakarta.annotation.Nullable Long trId) {
        this.trId = trId;
        return this;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WithdrawTravelRuleResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WithdrawTravelRuleResponse.openapiRequiredFields
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WithdrawTravelRuleResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WithdrawTravelRuleResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<WithdrawTravelRuleResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(WithdrawTravelRuleResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<WithdrawTravelRuleResponse>() {
                        @Override
                        ...
                        @Override
                        public WithdrawTravelRuleResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of WithdrawTravelRuleResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WithdrawTravelRuleResponse
     * @throws IOException if the JSON string is invalid with respect to WithdrawTravelRuleResponse
     */
    public static WithdrawTravelRuleResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WithdrawTravelRuleResponse.class);
    }

    /**
     * Convert an instance of WithdrawTravelRuleResponse to an JSON string
     *
     * @return JSON string
     */
