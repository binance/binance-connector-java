...
public class DefaultApi {
    ...
    private static final String USER_AGENT =
            String.format(
                    "binance-mining/4.0.0 (Java/%s; %s; %s)",
    ...
    public ApiResponse<AccountListResponse> accountList(
            @NotNull String algo, @NotNull String userName, @Max(60000L) Long recvWindow)
            throws ApiException {
    ...
    public ApiResponse<EarningsListResponse> earningsList(
            ...
            Long endDate,
            Long pageIndex,
            @Min(10L) @Max(200L) Long pageSize,
    ...
    public ApiResponse<HashrateResaleListResponse> hashrateResaleList(
            Long pageIndex, @Min(10L) @Max(200L) Long pageSize, @Max(60000L) Long recvWindow)
            throws ApiException {
        okhttp3.Call localVarCall =
