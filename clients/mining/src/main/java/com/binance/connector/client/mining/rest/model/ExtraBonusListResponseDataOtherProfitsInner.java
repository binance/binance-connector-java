...
public class ExtraBonusListResponseDataOtherProfitsInner {
    ...
    public ExtraBonusListResponseDataOtherProfitsInner() {}

    public ExtraBonusListResponseDataOtherProfitsInner time(
    ...
    public ExtraBonusListResponseDataOtherProfitsInner coinName(
    ...
    public ExtraBonusListResponseDataOtherProfitsInner type(
    ...
    public ExtraBonusListResponseDataOtherProfitsInner profitAmount(
    ...
    public ExtraBonusListResponseDataOtherProfitsInner status(
    ...
    public boolean equals(Object o) {
        ...
        ExtraBonusListResponseDataOtherProfitsInner extraBonusListResponseDataOtherProfitsInner =
                (ExtraBonusListResponseDataOtherProfitsInner) o;
        return Objects.equals(this.time, extraBonusListResponseDataOtherProfitsInner.time)
                && Objects.equals(
                        this.coinName, extraBonusListResponseDataOtherProfitsInner.coinName)
                && Objects.equals(this.type, extraBonusListResponseDataOtherProfitsInner.type)
                && Objects.equals(
                        this.profitAmount, extraBonusListResponseDataOtherProfitsInner.profitAmount)
                && Objects.equals(this.status, extraBonusListResponseDataOtherProfitsInner.status);
    }
    ...
    public String toString() {
        ...
        sb.append("class ExtraBonusListResponseDataOtherProfitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ExtraBonusListResponseDataOtherProfitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " ExtraBonusListResponseDataOtherProfitsInner is not found in"
                                    + " the empty JSON string",
                                ExtraBonusListResponseDataOtherProfitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExtraBonusListResponseDataOtherProfitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'ExtraBonusListResponseDataOtherProfitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ExtraBonusListResponseDataOtherProfitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ExtraBonusListResponseDataOtherProfitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ExtraBonusListResponseDataOtherProfitsInner>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public ExtraBonusListResponseDataOtherProfitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of ExtraBonusListResponseDataOtherProfitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ExtraBonusListResponseDataOtherProfitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     ExtraBonusListResponseDataOtherProfitsInner
     */
    public static ExtraBonusListResponseDataOtherProfitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, ExtraBonusListResponseDataOtherProfitsInner.class);
    }

    /**
     * Convert an instance of ExtraBonusListResponseDataOtherProfitsInner to an JSON string
     *
     * @return JSON string
     */
