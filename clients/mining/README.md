...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-mining)](https://central.sonatype.com/artifact/io.github.binance/binance-mining)
...
- [REST API](./src/main/java/com/binance/connector/client/mining/rest/api)
...
<dependency>
  ...
  <artifactId>binance-mining</artifactId>
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/mining/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/mining/src/main/java/com/binance/connector/client/mining/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl mining test
```
