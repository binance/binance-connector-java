# Binance Java Derivatives Trading Coin Futures Connector
...
- [REST API](./src/main/java/com/binance/connector/client/derivatives_trading_coin_futures/rest/api)
- [Websocket API](./src/main/java/com/binance/connector/client/derivatives_trading_coin_futures/websocket/api)
- [Websocket Stream](./src/main/java/com/binance/connector/client/derivatives_trading_coin_futures/websocket/stream)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/derivatives/coin-margined-futures/).

### REST APIs

All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/derivatives_trading_coin_futures/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/derivatives-trading-coin-futures/src/main/java/com/binance/connector/client/derivatives_trading_coin_futures/rest) folder.
