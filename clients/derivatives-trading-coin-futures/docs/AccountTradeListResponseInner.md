...
|**buyer** | **Boolean** | Whether the trade is a buy side for the account. |  [optional] |
|**maker** | **Boolean** | Whether the account is maker in this trade. |  [optional] |
