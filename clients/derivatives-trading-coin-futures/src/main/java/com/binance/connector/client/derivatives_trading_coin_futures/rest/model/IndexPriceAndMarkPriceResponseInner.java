...
public class IndexPriceAndMarkPriceResponseInner {
    ...
    public IndexPriceAndMarkPriceResponseInner() {}

    public IndexPriceAndMarkPriceResponseInner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public IndexPriceAndMarkPriceResponseInner pair(@jakarta.annotation.Nullable String pair) {
        this.pair = pair;
        return this;
    }
    ...
    public IndexPriceAndMarkPriceResponseInner markPrice(
    ...
    public IndexPriceAndMarkPriceResponseInner indexPrice(
    ...
    public IndexPriceAndMarkPriceResponseInner estimatedSettlePrice(
    ...
    public IndexPriceAndMarkPriceResponseInner lastFundingRate(
    ...
    public IndexPriceAndMarkPriceResponseInner interestRate(
    ...
    public IndexPriceAndMarkPriceResponseInner nextFundingTime(
    ...
    public IndexPriceAndMarkPriceResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        IndexPriceAndMarkPriceResponseInner indexPriceAndMarkPriceResponseInner =
                (IndexPriceAndMarkPriceResponseInner) o;
        return Objects.equals(this.symbol, indexPriceAndMarkPriceResponseInner.symbol)
                && Objects.equals(this.pair, indexPriceAndMarkPriceResponseInner.pair)
                && Objects.equals(this.markPrice, indexPriceAndMarkPriceResponseInner.markPrice)
                && Objects.equals(this.indexPrice, indexPriceAndMarkPriceResponseInner.indexPrice)
                && Objects.equals(
                        this.estimatedSettlePrice,
                        indexPriceAndMarkPriceResponseInner.estimatedSettlePrice)
                && Objects.equals(
                        this.lastFundingRate, indexPriceAndMarkPriceResponseInner.lastFundingRate)
                && Objects.equals(
                        this.interestRate, indexPriceAndMarkPriceResponseInner.interestRate)
                && Objects.equals(
                        this.nextFundingTime, indexPriceAndMarkPriceResponseInner.nextFundingTime)
                && Objects.equals(this.time, indexPriceAndMarkPriceResponseInner.time);
    }
    ...
    public String toString() {
        ...
        sb.append("class IndexPriceAndMarkPriceResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!IndexPriceAndMarkPriceResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in IndexPriceAndMarkPriceResponseInner is"
                                        + " not found in the empty JSON string",
                                IndexPriceAndMarkPriceResponseInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!IndexPriceAndMarkPriceResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'IndexPriceAndMarkPriceResponseInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<IndexPriceAndMarkPriceResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(IndexPriceAndMarkPriceResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<IndexPriceAndMarkPriceResponseInner>() {
                        @Override
                        ...
                        @Override
                        public IndexPriceAndMarkPriceResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of IndexPriceAndMarkPriceResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of IndexPriceAndMarkPriceResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     IndexPriceAndMarkPriceResponseInner
     */
    public static IndexPriceAndMarkPriceResponseInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, IndexPriceAndMarkPriceResponseInner.class);
    }

    /**
     * Convert an instance of IndexPriceAndMarkPriceResponseInner to an JSON string
     *
     * @return JSON string
     */
