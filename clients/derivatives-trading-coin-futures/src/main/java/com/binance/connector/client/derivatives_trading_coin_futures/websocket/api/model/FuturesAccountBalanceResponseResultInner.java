...
public class FuturesAccountBalanceResponseResultInner extends BaseDTO {
    ...
    public FuturesAccountBalanceResponseResultInner() {}

    public FuturesAccountBalanceResponseResultInner accountAlias(
    ...
    public FuturesAccountBalanceResponseResultInner asset(
    ...
    public FuturesAccountBalanceResponseResultInner balance(
    ...
    public FuturesAccountBalanceResponseResultInner withdrawAvailable(
    ...
    public FuturesAccountBalanceResponseResultInner crossWalletBalance(
    ...
    public FuturesAccountBalanceResponseResultInner crossUnPnl(
    ...
    public FuturesAccountBalanceResponseResultInner availableBalance(
    ...
    public FuturesAccountBalanceResponseResultInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        FuturesAccountBalanceResponseResultInner futuresAccountBalanceResponseResultInner =
                (FuturesAccountBalanceResponseResultInner) o;
        return Objects.equals(
                        this.accountAlias, futuresAccountBalanceResponseResultInner.accountAlias)
                && Objects.equals(this.asset, futuresAccountBalanceResponseResultInner.asset)
                && Objects.equals(this.balance, futuresAccountBalanceResponseResultInner.balance)
                && Objects.equals(
                        this.withdrawAvailable,
                        futuresAccountBalanceResponseResultInner.withdrawAvailable)
                && Objects.equals(
                        this.crossWalletBalance,
                        futuresAccountBalanceResponseResultInner.crossWalletBalance)
                && Objects.equals(
                        this.crossUnPnl, futuresAccountBalanceResponseResultInner.crossUnPnl)
                && Objects.equals(
                        this.availableBalance,
                        futuresAccountBalanceResponseResultInner.availableBalance)
                && Objects.equals(
                        this.updateTime, futuresAccountBalanceResponseResultInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class FuturesAccountBalanceResponseResultInner {\n");
    ...
    public String toUrlQueryString() {
        ...
        String withdrawAvailableValue = getWithdrawAvailable();
        if (withdrawAvailableValue != null) {
            String withdrawAvailableValueAsString = withdrawAvailableValue.toString();
            valMap.put("withdrawAvailable", withdrawAvailableValueAsString);
        }
    ...
    public Map<String, Object> toMap() {
        ...
        if (withdrawAvailableValue != null) {
            valMap.put("withdrawAvailable", withdrawAvailableValue);
        }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FuturesAccountBalanceResponseResultInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " FuturesAccountBalanceResponseResultInner is not found in"
                                    + " the empty JSON string",
                                FuturesAccountBalanceResponseResultInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!FuturesAccountBalanceResponseResultInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `FuturesAccountBalanceResponseResultInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FuturesAccountBalanceResponseResultInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'FuturesAccountBalanceResponseResultInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FuturesAccountBalanceResponseResultInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(FuturesAccountBalanceResponseResultInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FuturesAccountBalanceResponseResultInner>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public FuturesAccountBalanceResponseResultInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of FuturesAccountBalanceResponseResultInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FuturesAccountBalanceResponseResultInner
     * @throws IOException if the JSON string is invalid with respect to
     *     FuturesAccountBalanceResponseResultInner
     */
    public static FuturesAccountBalanceResponseResultInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, FuturesAccountBalanceResponseResultInner.class);
    }

    /**
     * Convert an instance of FuturesAccountBalanceResponseResultInner to an JSON string
     *
     * @return JSON string
     */
