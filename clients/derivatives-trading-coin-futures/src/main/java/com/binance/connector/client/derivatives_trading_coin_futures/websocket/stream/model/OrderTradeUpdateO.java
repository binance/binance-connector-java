...
public class OrderTradeUpdateO extends BaseDTO {
    ...
    public OrderTradeUpdateO ma(@jakarta.annotation.Nullable String ma) {
        this.ma = ma;
        return this;
    }
    ...
    public void setMa(@jakarta.annotation.Nullable String ma) {
        this.ma = ma;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.sLowerCase, orderTradeUpdateO.sLowerCase)
                ...
                && Objects.equals(this.ma, orderTradeUpdateO.ma)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if ((jsonObj.get("ma") != null && !jsonObj.get("ma").isJsonNull())
                && !jsonObj.get("ma").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ma` to be a primitive type in the JSON string but"
                                    + " got `%s`",
                            jsonObj.get("ma").toString()));
        }
