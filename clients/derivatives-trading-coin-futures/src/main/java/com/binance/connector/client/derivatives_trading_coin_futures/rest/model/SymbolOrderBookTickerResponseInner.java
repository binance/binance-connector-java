...
public class SymbolOrderBookTickerResponseInner {
    ...
    public SymbolOrderBookTickerResponseInner() {}

    public SymbolOrderBookTickerResponseInner lastUpdateId(
    ...
    public SymbolOrderBookTickerResponseInner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public SymbolOrderBookTickerResponseInner pair(@jakarta.annotation.Nullable String pair) {
        this.pair = pair;
        return this;
    }
    ...
    public SymbolOrderBookTickerResponseInner bidPrice(
    ...
    public SymbolOrderBookTickerResponseInner bidQty(@jakarta.annotation.Nullable String bidQty) {
        this.bidQty = bidQty;
        return this;
    }
    ...
    public SymbolOrderBookTickerResponseInner askPrice(
    ...
    public SymbolOrderBookTickerResponseInner askQty(@jakarta.annotation.Nullable String askQty) {
        this.askQty = askQty;
        return this;
    }
    ...
    public SymbolOrderBookTickerResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        SymbolOrderBookTickerResponseInner symbolOrderBookTickerResponseInner =
                (SymbolOrderBookTickerResponseInner) o;
        return Objects.equals(this.lastUpdateId, symbolOrderBookTickerResponseInner.lastUpdateId)
                && Objects.equals(this.symbol, symbolOrderBookTickerResponseInner.symbol)
                && Objects.equals(this.pair, symbolOrderBookTickerResponseInner.pair)
                && Objects.equals(this.bidPrice, symbolOrderBookTickerResponseInner.bidPrice)
                && Objects.equals(this.bidQty, symbolOrderBookTickerResponseInner.bidQty)
                && Objects.equals(this.askPrice, symbolOrderBookTickerResponseInner.askPrice)
                && Objects.equals(this.askQty, symbolOrderBookTickerResponseInner.askQty)
                && Objects.equals(this.time, symbolOrderBookTickerResponseInner.time);
    }

    @Override
    public int hashCode() {
        return Objects.hash(lastUpdateId, symbol, pair, bidPrice, bidQty, askPrice, askQty, time);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class SymbolOrderBookTickerResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SymbolOrderBookTickerResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SymbolOrderBookTickerResponseInner is"
                                        + " not found in the empty JSON string",
                                SymbolOrderBookTickerResponseInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SymbolOrderBookTickerResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SymbolOrderBookTickerResponseInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<SymbolOrderBookTickerResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(SymbolOrderBookTickerResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<SymbolOrderBookTickerResponseInner>() {
                        @Override
                        ...
                        @Override
                        public SymbolOrderBookTickerResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of SymbolOrderBookTickerResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SymbolOrderBookTickerResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     SymbolOrderBookTickerResponseInner
     */
    public static SymbolOrderBookTickerResponseInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, SymbolOrderBookTickerResponseInner.class);
    }

    /**
     * Convert an instance of SymbolOrderBookTickerResponseInner to an JSON string
     *
     * @return JSON string
     */
