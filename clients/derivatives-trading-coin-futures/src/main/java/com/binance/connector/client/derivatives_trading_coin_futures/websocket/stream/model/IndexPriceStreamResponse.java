...
public class IndexPriceStreamResponse extends BaseDTO {
    ...
    public IndexPriceStreamResponse() {}

    public IndexPriceStreamResponse eLowerCase(@jakarta.annotation.Nullable String eLowerCase) {
    ...
    public IndexPriceStreamResponse E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public IndexPriceStreamResponse iLowerCase(@jakarta.annotation.Nullable String iLowerCase) {
    ...
    public IndexPriceStreamResponse pLowerCase(@jakarta.annotation.Nullable String pLowerCase) {
    ...
    public boolean equals(Object o) {
        ...
        IndexPriceStreamResponse indexPriceStreamResponse = (IndexPriceStreamResponse) o;
        return Objects.equals(this.eLowerCase, indexPriceStreamResponse.eLowerCase)
                && Objects.equals(this.E, indexPriceStreamResponse.E)
                && Objects.equals(this.iLowerCase, indexPriceStreamResponse.iLowerCase)
                && Objects.equals(this.pLowerCase, indexPriceStreamResponse.pLowerCase);
    }

    @Override
    public int hashCode() {
        return Objects.hash(eLowerCase, E, iLowerCase, pLowerCase);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class IndexPriceStreamResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to IndexPriceStreamResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!IndexPriceStreamResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in IndexPriceStreamResponse is not found"
                                        + " in the empty JSON string",
                                IndexPriceStreamResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!IndexPriceStreamResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `IndexPriceStreamResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!IndexPriceStreamResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'IndexPriceStreamResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<IndexPriceStreamResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(IndexPriceStreamResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<IndexPriceStreamResponse>() {
                        @Override
                        ...
                        @Override
                        public IndexPriceStreamResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of IndexPriceStreamResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of IndexPriceStreamResponse
     * @throws IOException if the JSON string is invalid with respect to IndexPriceStreamResponse
     */
    public static IndexPriceStreamResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, IndexPriceStreamResponse.class);
    }

    /**
     * Convert an instance of IndexPriceStreamResponse to an JSON string
     *
     * @return JSON string
     */
