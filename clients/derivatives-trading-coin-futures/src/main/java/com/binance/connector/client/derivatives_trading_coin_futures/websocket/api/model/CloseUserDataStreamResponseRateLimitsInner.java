...
public class CloseUserDataStreamResponseRateLimitsInner extends BaseDTO {
    ...
    public CloseUserDataStreamResponseRateLimitsInner() {}

    public CloseUserDataStreamResponseRateLimitsInner rateLimitType(
    ...
    public CloseUserDataStreamResponseRateLimitsInner interval(
    ...
    public CloseUserDataStreamResponseRateLimitsInner intervalNum(
    ...
    public CloseUserDataStreamResponseRateLimitsInner limit(
    ...
    public CloseUserDataStreamResponseRateLimitsInner count(
    ...
    public boolean equals(Object o) {
        ...
        CloseUserDataStreamResponseRateLimitsInner closeUserDataStreamResponseRateLimitsInner =
                (CloseUserDataStreamResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType,
                        closeUserDataStreamResponseRateLimitsInner.rateLimitType)
                && Objects.equals(
                        this.interval, closeUserDataStreamResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, closeUserDataStreamResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, closeUserDataStreamResponseRateLimitsInner.limit)
                && Objects.equals(this.count, closeUserDataStreamResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class CloseUserDataStreamResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CloseUserDataStreamResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " CloseUserDataStreamResponseRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                CloseUserDataStreamResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CloseUserDataStreamResponseRateLimitsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `CloseUserDataStreamResponseRateLimitsInner` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CloseUserDataStreamResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'CloseUserDataStreamResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CloseUserDataStreamResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CloseUserDataStreamResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CloseUserDataStreamResponseRateLimitsInner>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public CloseUserDataStreamResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of CloseUserDataStreamResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CloseUserDataStreamResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     CloseUserDataStreamResponseRateLimitsInner
     */
    public static CloseUserDataStreamResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, CloseUserDataStreamResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of CloseUserDataStreamResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
