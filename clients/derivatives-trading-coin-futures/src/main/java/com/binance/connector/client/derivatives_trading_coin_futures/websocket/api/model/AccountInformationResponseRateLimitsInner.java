...
public class AccountInformationResponseRateLimitsInner extends BaseDTO {
    ...
    public AccountInformationResponseRateLimitsInner() {}

    public AccountInformationResponseRateLimitsInner rateLimitType(
    ...
    public AccountInformationResponseRateLimitsInner interval(
    ...
    public AccountInformationResponseRateLimitsInner intervalNum(
    ...
    public AccountInformationResponseRateLimitsInner limit(
    ...
    public AccountInformationResponseRateLimitsInner count(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationResponseRateLimitsInner accountInformationResponseRateLimitsInner =
                (AccountInformationResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType, accountInformationResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, accountInformationResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, accountInformationResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, accountInformationResponseRateLimitsInner.limit)
                && Objects.equals(this.count, accountInformationResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationResponseRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                AccountInformationResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AccountInformationResponseRateLimitsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountInformationResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountInformationResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationResponseRateLimitsInner
     */
    public static AccountInformationResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, AccountInformationResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of AccountInformationResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
