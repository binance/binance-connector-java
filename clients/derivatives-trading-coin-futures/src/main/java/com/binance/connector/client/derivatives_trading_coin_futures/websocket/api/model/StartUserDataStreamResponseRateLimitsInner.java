...
public class StartUserDataStreamResponseRateLimitsInner extends BaseDTO {
    ...
    public StartUserDataStreamResponseRateLimitsInner() {}

    public StartUserDataStreamResponseRateLimitsInner rateLimitType(
    ...
    public StartUserDataStreamResponseRateLimitsInner interval(
    ...
    public StartUserDataStreamResponseRateLimitsInner intervalNum(
    ...
    public StartUserDataStreamResponseRateLimitsInner limit(
    ...
    public StartUserDataStreamResponseRateLimitsInner count(
    ...
    public boolean equals(Object o) {
        ...
        StartUserDataStreamResponseRateLimitsInner startUserDataStreamResponseRateLimitsInner =
                (StartUserDataStreamResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType,
                        startUserDataStreamResponseRateLimitsInner.rateLimitType)
                && Objects.equals(
                        this.interval, startUserDataStreamResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, startUserDataStreamResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, startUserDataStreamResponseRateLimitsInner.limit)
                && Objects.equals(this.count, startUserDataStreamResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class StartUserDataStreamResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!StartUserDataStreamResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " StartUserDataStreamResponseRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                StartUserDataStreamResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!StartUserDataStreamResponseRateLimitsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `StartUserDataStreamResponseRateLimitsInner` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!StartUserDataStreamResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'StartUserDataStreamResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<StartUserDataStreamResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(StartUserDataStreamResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<StartUserDataStreamResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, StartUserDataStreamResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public StartUserDataStreamResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of StartUserDataStreamResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of StartUserDataStreamResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     StartUserDataStreamResponseRateLimitsInner
     */
    public static StartUserDataStreamResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, StartUserDataStreamResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of StartUserDataStreamResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
