...
public class IndividualSymbolMiniTickerStreamResponse extends BaseDTO {
    ...
    public IndividualSymbolMiniTickerStreamResponse E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public IndividualSymbolMiniTickerStreamResponse sLowerCase(
    ...
    public IndividualSymbolMiniTickerStreamResponse ps(@jakarta.annotation.Nullable String ps) {
        this.ps = ps;
        return this;
    }
    ...
    public IndividualSymbolMiniTickerStreamResponse cLowerCase(
    ...
    public IndividualSymbolMiniTickerStreamResponse oLowerCase(
    ...
    public IndividualSymbolMiniTickerStreamResponse hLowerCase(
    ...
    public IndividualSymbolMiniTickerStreamResponse lLowerCase(
    ...
    public IndividualSymbolMiniTickerStreamResponse vLowerCase(
    ...
    public IndividualSymbolMiniTickerStreamResponse qLowerCase(
    ...
    public boolean equals(Object o) {
        ...
        IndividualSymbolMiniTickerStreamResponse individualSymbolMiniTickerStreamResponse =
                (IndividualSymbolMiniTickerStreamResponse) o;
        return Objects.equals(this.eLowerCase, individualSymbolMiniTickerStreamResponse.eLowerCase)
                && Objects.equals(this.E, individualSymbolMiniTickerStreamResponse.E)
                && Objects.equals(
                        this.sLowerCase, individualSymbolMiniTickerStreamResponse.sLowerCase)
                && Objects.equals(this.ps, individualSymbolMiniTickerStreamResponse.ps)
                && Objects.equals(
                        this.cLowerCase, individualSymbolMiniTickerStreamResponse.cLowerCase)
                && Objects.equals(
                        this.oLowerCase, individualSymbolMiniTickerStreamResponse.oLowerCase)
                && Objects.equals(
                        this.hLowerCase, individualSymbolMiniTickerStreamResponse.hLowerCase)
                && Objects.equals(
                        this.lLowerCase, individualSymbolMiniTickerStreamResponse.lLowerCase)
                && Objects.equals(
    ...
    public String toString() {
        ...
        sb.append("class IndividualSymbolMiniTickerStreamResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!IndividualSymbolMiniTickerStreamResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " IndividualSymbolMiniTickerStreamResponse is not found in"
                                    + " the empty JSON string",
                                IndividualSymbolMiniTickerStreamResponse.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!IndividualSymbolMiniTickerStreamResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `IndividualSymbolMiniTickerStreamResponse` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!IndividualSymbolMiniTickerStreamResponse.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'IndividualSymbolMiniTickerStreamResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<IndividualSymbolMiniTickerStreamResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(IndividualSymbolMiniTickerStreamResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<IndividualSymbolMiniTickerStreamResponse>() {
                        @Override
                        public void write(
                                JsonWriter out, IndividualSymbolMiniTickerStreamResponse value)
                                throws IOException {
                        ...
                        @Override
                        public IndividualSymbolMiniTickerStreamResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of IndividualSymbolMiniTickerStreamResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of IndividualSymbolMiniTickerStreamResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     IndividualSymbolMiniTickerStreamResponse
     */
    public static IndividualSymbolMiniTickerStreamResponse fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, IndividualSymbolMiniTickerStreamResponse.class);
    }

    /**
     * Convert an instance of IndividualSymbolMiniTickerStreamResponse to an JSON string
     *
     * @return JSON string
     */
