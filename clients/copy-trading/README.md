# Binance Java Copy Trading Connector
...
- [REST API](./src/main/java/com/binance/connector/client/copy_trading/rest/api)
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/copy_trading/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/copy-trading/src/main/java/com/binance/connector/client/copy_trading/rest) folder.
