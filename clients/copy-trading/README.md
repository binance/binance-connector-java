# Binance Java CopyTrading Connector
...
More examples can be found in the [`examples/rest-api`](./examples/copy-trading/src/main/java/com/binance/connector/client/copy-trading/rest) folder.
