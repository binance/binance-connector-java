...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-gift-card)](https://central.sonatype.com/artifact/io.github.binance/binance-gift-card)
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/gift_card/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/gift-card/src/main/java/com/binance/connector/client/gift_card/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl gift-card test
```
