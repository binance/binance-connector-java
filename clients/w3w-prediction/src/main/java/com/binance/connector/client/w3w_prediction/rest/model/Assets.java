...
public class Assets extends ArrayList<AssetsInner> {
    public Assets() {}
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (JsonElement element : array) {
            AssetsInner.validateJsonElement(element);
        }
        if (jsonElement == null) {
            if (!Assets.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Assets is not found in the empty JSON"
                                        + " string",
                                Assets.openapiRequiredFields.toString()));
            }
        }
    }
