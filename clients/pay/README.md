...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-pay)](https://central.sonatype.com/artifact/io.github.binance/binance-pay)
...
- [REST API](./src/main/java/com/binance/connector/client/pay/rest/api)
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/pay/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/pay/src/main/java/com/binance/connector/client/pay/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl pay test
```
