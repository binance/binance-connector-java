...
public class DefaultApiTest {
     ...
     */
    @Test
    public void getSpotRebateHistoryRecordsTest()
        ...
        ApiResponse<GetSpotRebateHistoryRecordsResponse> response =
                api.getSpotRebateHistoryRecords(startTime, endTime, page, recvWindow);
        ...
        assertEquals("startTime=1623319461670&endTime=1641782889000&page=1&recvWindow=5000&timestamp=1736393892000", signInputCaptor.getValue());
        assertEquals(
                "d8669595398c3478db78736dbf4210642841e9920062e47dd9e504f877e947a8",
                actualRequest.url().queryParameter("signature"));
        assertEquals("/sapi/v1/rebate/taxQuery", actualRequest.url().encodedPath());
    }
}
