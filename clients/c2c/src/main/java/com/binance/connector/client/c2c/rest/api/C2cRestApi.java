...
public class C2cRestApi {
     ...
     * and endTime is 30 days. * If startTime and endTime are not sent, the recent 30 days&#39; data
     * will be returned. * You can only view data from the past 6 months. To see all C2C orders,
     * please check https://c2c.binance.com/en/fiatOrder Weight: 1
     *
