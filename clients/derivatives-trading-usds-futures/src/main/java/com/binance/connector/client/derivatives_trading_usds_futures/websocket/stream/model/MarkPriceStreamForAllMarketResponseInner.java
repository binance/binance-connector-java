...
public class MarkPriceStreamForAllMarketResponseInner extends BaseDTO {
    ...
    public MarkPriceStreamForAllMarketResponseInner eLowerCase(
    ...
    public MarkPriceStreamForAllMarketResponseInner E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public MarkPriceStreamForAllMarketResponseInner sLowerCase(
    ...
    public MarkPriceStreamForAllMarketResponseInner pLowerCase(
    ...
    public MarkPriceStreamForAllMarketResponseInner P(@jakarta.annotation.Nullable String P) {
        this.P = P;
        return this;
    }
    ...
    public MarkPriceStreamForAllMarketResponseInner rLowerCase(
    ...
    public boolean equals(Object o) {
        ...
        MarkPriceStreamForAllMarketResponseInner markPriceStreamForAllMarketResponseInner =
                (MarkPriceStreamForAllMarketResponseInner) o;
        return Objects.equals(this.eLowerCase, markPriceStreamForAllMarketResponseInner.eLowerCase)
                && Objects.equals(this.E, markPriceStreamForAllMarketResponseInner.E)
                && Objects.equals(
    ...
    public String toString() {
        ...
        sb.append("class MarkPriceStreamForAllMarketResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MarkPriceStreamForAllMarketResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " MarkPriceStreamForAllMarketResponseInner is not found in"
                                    + " the empty JSON string",
                                MarkPriceStreamForAllMarketResponseInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!MarkPriceStreamForAllMarketResponseInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `MarkPriceStreamForAllMarketResponseInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MarkPriceStreamForAllMarketResponseInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'MarkPriceStreamForAllMarketResponseInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<MarkPriceStreamForAllMarketResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(MarkPriceStreamForAllMarketResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<MarkPriceStreamForAllMarketResponseInner>() {
                        @Override
                        public void write(
                                JsonWriter out, MarkPriceStreamForAllMarketResponseInner value)
                                throws IOException {
                        ...
                        @Override
                        public MarkPriceStreamForAllMarketResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of MarkPriceStreamForAllMarketResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MarkPriceStreamForAllMarketResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     MarkPriceStreamForAllMarketResponseInner
     */
    public static MarkPriceStreamForAllMarketResponseInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, MarkPriceStreamForAllMarketResponseInner.class);
    }

    /**
     * Convert an instance of MarkPriceStreamForAllMarketResponseInner to an JSON string
     *
     * @return JSON string
     */
