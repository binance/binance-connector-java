...
public class GetFuturesTradeDownloadLinkByIdResponse2 {
    ...
    public GetFuturesTradeDownloadLinkByIdResponse2() {}

    public GetFuturesTradeDownloadLinkByIdResponse2 downloadId(
    ...
    public GetFuturesTradeDownloadLinkByIdResponse2 status(
    ...
    public GetFuturesTradeDownloadLinkByIdResponse2 url(@jakarta.annotation.Nullable String url) {
        this.url = url;
        return this;
    }
    ...
    public GetFuturesTradeDownloadLinkByIdResponse2 notified(
    ...
    public GetFuturesTradeDownloadLinkByIdResponse2 expirationTimestamp(
    ...
    public GetFuturesTradeDownloadLinkByIdResponse2 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetFuturesTradeDownloadLinkByIdResponse2 getFuturesTradeDownloadLinkByIdResponse2 =
                (GetFuturesTradeDownloadLinkByIdResponse2) o;
        return Objects.equals(this.downloadId, getFuturesTradeDownloadLinkByIdResponse2.downloadId)
                && Objects.equals(this.status, getFuturesTradeDownloadLinkByIdResponse2.status)
                && Objects.equals(this.url, getFuturesTradeDownloadLinkByIdResponse2.url)
                && Objects.equals(this.notified, getFuturesTradeDownloadLinkByIdResponse2.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getFuturesTradeDownloadLinkByIdResponse2.expirationTimestamp)
                && Objects.equals(
                        this.isExpired, getFuturesTradeDownloadLinkByIdResponse2.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetFuturesTradeDownloadLinkByIdResponse2 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetFuturesTradeDownloadLinkByIdResponse2.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetFuturesTradeDownloadLinkByIdResponse2 is not found in"
                                    + " the empty JSON string",
                                GetFuturesTradeDownloadLinkByIdResponse2.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetFuturesTradeDownloadLinkByIdResponse2.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `GetFuturesTradeDownloadLinkByIdResponse2` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFuturesTradeDownloadLinkByIdResponse2.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetFuturesTradeDownloadLinkByIdResponse2' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetFuturesTradeDownloadLinkByIdResponse2> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetFuturesTradeDownloadLinkByIdResponse2.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetFuturesTradeDownloadLinkByIdResponse2>() {
                        @Override
                        public void write(
                                JsonWriter out, GetFuturesTradeDownloadLinkByIdResponse2 value)
                                throws IOException {
                        ...
                        @Override
                        public GetFuturesTradeDownloadLinkByIdResponse2 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetFuturesTradeDownloadLinkByIdResponse2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetFuturesTradeDownloadLinkByIdResponse2
     * @throws IOException if the JSON string is invalid with respect to
     *     GetFuturesTradeDownloadLinkByIdResponse2
     */
    public static GetFuturesTradeDownloadLinkByIdResponse2 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, GetFuturesTradeDownloadLinkByIdResponse2.class);
    }

    /**
     * Convert an instance of GetFuturesTradeDownloadLinkByIdResponse2 to an JSON string
     *
     * @return JSON string
     */
