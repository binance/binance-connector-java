...
/** AccountInformationV2Response2AssetsInner */
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.12.0")
public class AccountInformationV2Response2AssetsInner {
    ...
    public AccountInformationV2Response2AssetsInner() {}

    public AccountInformationV2Response2AssetsInner asset(
    ...
    public AccountInformationV2Response2AssetsInner walletBalance(
    ...
    public AccountInformationV2Response2AssetsInner unrealizedProfit(
    ...
    public AccountInformationV2Response2AssetsInner marginBalance(
    ...
    public AccountInformationV2Response2AssetsInner maintMargin(
    ...
    public AccountInformationV2Response2AssetsInner initialMargin(
    ...
    public AccountInformationV2Response2AssetsInner positionInitialMargin(
    ...
    public AccountInformationV2Response2AssetsInner openOrderInitialMargin(
    ...
    public AccountInformationV2Response2AssetsInner crossWalletBalance(
    ...
    public AccountInformationV2Response2AssetsInner crossUnPnl(
    ...
    public AccountInformationV2Response2AssetsInner availableBalance(
    ...
    public AccountInformationV2Response2AssetsInner maxWithdrawAmount(
    ...
    public AccountInformationV2Response2AssetsInner marginAvailable(
    ...
    public AccountInformationV2Response2AssetsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationV2Response2AssetsInner accountInformationV2Response2AssetsInner =
                (AccountInformationV2Response2AssetsInner) o;
        return Objects.equals(this.asset, accountInformationV2Response2AssetsInner.asset)
                && Objects.equals(
                        this.walletBalance, accountInformationV2Response2AssetsInner.walletBalance)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationV2Response2AssetsInner.unrealizedProfit)
                && Objects.equals(
                        this.marginBalance, accountInformationV2Response2AssetsInner.marginBalance)
                && Objects.equals(
                        this.maintMargin, accountInformationV2Response2AssetsInner.maintMargin)
                && Objects.equals(
                        this.initialMargin, accountInformationV2Response2AssetsInner.initialMargin)
                && Objects.equals(
                        this.positionInitialMargin,
                        accountInformationV2Response2AssetsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        accountInformationV2Response2AssetsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.crossWalletBalance,
                        accountInformationV2Response2AssetsInner.crossWalletBalance)
                && Objects.equals(
                        this.crossUnPnl, accountInformationV2Response2AssetsInner.crossUnPnl)
                && Objects.equals(
                        this.availableBalance,
                        accountInformationV2Response2AssetsInner.availableBalance)
                && Objects.equals(
                        this.maxWithdrawAmount,
                        accountInformationV2Response2AssetsInner.maxWithdrawAmount)
                && Objects.equals(
                        this.marginAvailable,
                        accountInformationV2Response2AssetsInner.marginAvailable)
                && Objects.equals(
                        this.updateTime, accountInformationV2Response2AssetsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationV2Response2AssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationV2Response2AssetsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationV2Response2AssetsInner is not found in"
                                    + " the empty JSON string",
                                AccountInformationV2Response2AssetsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationV2Response2AssetsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AccountInformationV2Response2AssetsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationV2Response2AssetsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationV2Response2AssetsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationV2Response2AssetsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountInformationV2Response2AssetsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationV2Response2AssetsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountInformationV2Response2AssetsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationV2Response2AssetsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationV2Response2AssetsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationV2Response2AssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationV2Response2AssetsInner
     */
    public static AccountInformationV2Response2AssetsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, AccountInformationV2Response2AssetsInner.class);
    }

    /**
     * Convert an instance of AccountInformationV2Response2AssetsInner to an JSON string
     *
     * @return JSON string
     */
