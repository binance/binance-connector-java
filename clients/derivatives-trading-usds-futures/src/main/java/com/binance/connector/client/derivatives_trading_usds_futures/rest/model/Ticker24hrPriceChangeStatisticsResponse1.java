...
public class Ticker24hrPriceChangeStatisticsResponse1 {
    ...
    public Ticker24hrPriceChangeStatisticsResponse1() {}

    public Ticker24hrPriceChangeStatisticsResponse1 symbol(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 priceChange(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 priceChangePercent(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 weightedAvgPrice(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 lastPrice(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 lastQty(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 openPrice(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 highPrice(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 lowPrice(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 volume(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 quoteVolume(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 openTime(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 closeTime(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 firstId(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 lastId(
    ...
    public Ticker24hrPriceChangeStatisticsResponse1 count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Ticker24hrPriceChangeStatisticsResponse1 ticker24hrPriceChangeStatisticsResponse1 =
                (Ticker24hrPriceChangeStatisticsResponse1) o;
        return Objects.equals(this.symbol, ticker24hrPriceChangeStatisticsResponse1.symbol)
                && Objects.equals(
                        this.priceChange, ticker24hrPriceChangeStatisticsResponse1.priceChange)
                && Objects.equals(
                        this.priceChangePercent,
                        ticker24hrPriceChangeStatisticsResponse1.priceChangePercent)
                && Objects.equals(
                        this.weightedAvgPrice,
                        ticker24hrPriceChangeStatisticsResponse1.weightedAvgPrice)
                && Objects.equals(
                        this.lastPrice, ticker24hrPriceChangeStatisticsResponse1.lastPrice)
                && Objects.equals(this.lastQty, ticker24hrPriceChangeStatisticsResponse1.lastQty)
                && Objects.equals(
                        this.openPrice, ticker24hrPriceChangeStatisticsResponse1.openPrice)
                && Objects.equals(
                        this.highPrice, ticker24hrPriceChangeStatisticsResponse1.highPrice)
                && Objects.equals(this.lowPrice, ticker24hrPriceChangeStatisticsResponse1.lowPrice)
                && Objects.equals(this.volume, ticker24hrPriceChangeStatisticsResponse1.volume)
                && Objects.equals(
                        this.quoteVolume, ticker24hrPriceChangeStatisticsResponse1.quoteVolume)
                && Objects.equals(this.openTime, ticker24hrPriceChangeStatisticsResponse1.openTime)
                && Objects.equals(
                        this.closeTime, ticker24hrPriceChangeStatisticsResponse1.closeTime)
                && Objects.equals(this.firstId, ticker24hrPriceChangeStatisticsResponse1.firstId)
                && Objects.equals(this.lastId, ticker24hrPriceChangeStatisticsResponse1.lastId)
                && Objects.equals(this.count, ticker24hrPriceChangeStatisticsResponse1.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class Ticker24hrPriceChangeStatisticsResponse1 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Ticker24hrPriceChangeStatisticsResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " Ticker24hrPriceChangeStatisticsResponse1 is not found in"
                                    + " the empty JSON string",
                                Ticker24hrPriceChangeStatisticsResponse1.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Ticker24hrPriceChangeStatisticsResponse1.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'Ticker24hrPriceChangeStatisticsResponse1' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Ticker24hrPriceChangeStatisticsResponse1> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(Ticker24hrPriceChangeStatisticsResponse1.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<Ticker24hrPriceChangeStatisticsResponse1>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public Ticker24hrPriceChangeStatisticsResponse1 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of Ticker24hrPriceChangeStatisticsResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Ticker24hrPriceChangeStatisticsResponse1
     * @throws IOException if the JSON string is invalid with respect to
     *     Ticker24hrPriceChangeStatisticsResponse1
     */
    public static Ticker24hrPriceChangeStatisticsResponse1 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, Ticker24hrPriceChangeStatisticsResponse1.class);
    }

    /**
     * Convert an instance of Ticker24hrPriceChangeStatisticsResponse1 to an JSON string
     *
     * @return JSON string
     */
