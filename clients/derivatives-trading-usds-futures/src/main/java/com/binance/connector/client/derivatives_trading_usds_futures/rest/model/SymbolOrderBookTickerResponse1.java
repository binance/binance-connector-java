...
public class SymbolOrderBookTickerResponse1 {
    ...
    public SymbolOrderBookTickerResponse1() {}

    public SymbolOrderBookTickerResponse1 symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public SymbolOrderBookTickerResponse1 bidPrice(@jakarta.annotation.Nullable String bidPrice) {
    ...
    public SymbolOrderBookTickerResponse1 bidQty(@jakarta.annotation.Nullable String bidQty) {
        this.bidQty = bidQty;
        return this;
    }
    ...
    public SymbolOrderBookTickerResponse1 askPrice(@jakarta.annotation.Nullable String askPrice) {
    ...
    public SymbolOrderBookTickerResponse1 askQty(@jakarta.annotation.Nullable String askQty) {
        this.askQty = askQty;
        return this;
    }
    ...
    public SymbolOrderBookTickerResponse1 time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        SymbolOrderBookTickerResponse1 symbolOrderBookTickerResponse1 =
                (SymbolOrderBookTickerResponse1) o;
        return Objects.equals(this.symbol, symbolOrderBookTickerResponse1.symbol)
                && Objects.equals(this.bidPrice, symbolOrderBookTickerResponse1.bidPrice)
                && Objects.equals(this.bidQty, symbolOrderBookTickerResponse1.bidQty)
                && Objects.equals(this.askPrice, symbolOrderBookTickerResponse1.askPrice)
                && Objects.equals(this.askQty, symbolOrderBookTickerResponse1.askQty)
                && Objects.equals(this.time, symbolOrderBookTickerResponse1.time);
    }
    ...
    public String toString() {
        ...
        sb.append("class SymbolOrderBookTickerResponse1 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SymbolOrderBookTickerResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SymbolOrderBookTickerResponse1 is not"
                                        + " found in the empty JSON string",
                                SymbolOrderBookTickerResponse1.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!SymbolOrderBookTickerResponse1.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SymbolOrderBookTickerResponse1` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SymbolOrderBookTickerResponse1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SymbolOrderBookTickerResponse1' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<SymbolOrderBookTickerResponse1> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(SymbolOrderBookTickerResponse1.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<SymbolOrderBookTickerResponse1>() {
                        @Override
                        public void write(JsonWriter out, SymbolOrderBookTickerResponse1 value)
                                throws IOException {
                        ...
                        @Override
                        public SymbolOrderBookTickerResponse1 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of SymbolOrderBookTickerResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SymbolOrderBookTickerResponse1
     * @throws IOException if the JSON string is invalid with respect to
     *     SymbolOrderBookTickerResponse1
     */
    public static SymbolOrderBookTickerResponse1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SymbolOrderBookTickerResponse1.class);
    }

    /**
     * Convert an instance of SymbolOrderBookTickerResponse1 to an JSON string
     *
     * @return JSON string
     */
