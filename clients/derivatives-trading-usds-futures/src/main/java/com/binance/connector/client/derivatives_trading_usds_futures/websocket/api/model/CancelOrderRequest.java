...
public class CancelOrderRequest extends BaseDTO {
    ...
    public CancelOrderRequest id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public CancelOrderRequest symbol(@jakarta.annotation.Nonnull String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public CancelOrderRequest orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public CancelOrderRequest origClientOrderId(
    ...
    public CancelOrderRequest recvWindow(@jakarta.annotation.Nullable Long recvWindow) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, cancelOrderRequest.id)
                && Objects.equals(this.symbol, cancelOrderRequest.symbol)
                && Objects.equals(this.orderId, cancelOrderRequest.orderId)
                && Objects.equals(this.origClientOrderId, cancelOrderRequest.origClientOrderId)
                && Objects.equals(this.recvWindow, cancelOrderRequest.recvWindow);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CancelOrderRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CancelOrderRequest is not found in the"
                                        + " empty JSON string",
                                CancelOrderRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `CancelOrderRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CancelOrderRequest>() {
                        @Override
                        public void write(JsonWriter out, CancelOrderRequest value)
                                throws IOException {
