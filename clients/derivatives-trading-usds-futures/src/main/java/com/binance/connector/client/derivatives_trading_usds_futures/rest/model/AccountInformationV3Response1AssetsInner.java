...
public class AccountInformationV3Response1AssetsInner {
    ...
    public AccountInformationV3Response1AssetsInner() {}

    public AccountInformationV3Response1AssetsInner asset(
    ...
    public AccountInformationV3Response1AssetsInner walletBalance(
    ...
    public AccountInformationV3Response1AssetsInner unrealizedProfit(
    ...
    public AccountInformationV3Response1AssetsInner marginBalance(
    ...
    public AccountInformationV3Response1AssetsInner maintMargin(
    ...
    public AccountInformationV3Response1AssetsInner initialMargin(
    ...
    public AccountInformationV3Response1AssetsInner positionInitialMargin(
    ...
    public AccountInformationV3Response1AssetsInner openOrderInitialMargin(
    ...
    public AccountInformationV3Response1AssetsInner crossWalletBalance(
    ...
    public AccountInformationV3Response1AssetsInner crossUnPnl(
    ...
    public AccountInformationV3Response1AssetsInner availableBalance(
    ...
    public AccountInformationV3Response1AssetsInner maxWithdrawAmount(
    ...
    public AccountInformationV3Response1AssetsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationV3Response1AssetsInner accountInformationV3Response1AssetsInner =
                (AccountInformationV3Response1AssetsInner) o;
        return Objects.equals(this.asset, accountInformationV3Response1AssetsInner.asset)
                && Objects.equals(
                        this.walletBalance, accountInformationV3Response1AssetsInner.walletBalance)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationV3Response1AssetsInner.unrealizedProfit)
                && Objects.equals(
                        this.marginBalance, accountInformationV3Response1AssetsInner.marginBalance)
                && Objects.equals(
                        this.maintMargin, accountInformationV3Response1AssetsInner.maintMargin)
                && Objects.equals(
                        this.initialMargin, accountInformationV3Response1AssetsInner.initialMargin)
                && Objects.equals(
                        this.positionInitialMargin,
                        accountInformationV3Response1AssetsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        accountInformationV3Response1AssetsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.crossWalletBalance,
                        accountInformationV3Response1AssetsInner.crossWalletBalance)
                && Objects.equals(
                        this.crossUnPnl, accountInformationV3Response1AssetsInner.crossUnPnl)
                && Objects.equals(
                        this.availableBalance,
                        accountInformationV3Response1AssetsInner.availableBalance)
                && Objects.equals(
                        this.maxWithdrawAmount,
                        accountInformationV3Response1AssetsInner.maxWithdrawAmount)
                && Objects.equals(
                        this.updateTime, accountInformationV3Response1AssetsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationV3Response1AssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationV3Response1AssetsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationV3Response1AssetsInner is not found in"
                                    + " the empty JSON string",
                                AccountInformationV3Response1AssetsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationV3Response1AssetsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AccountInformationV3Response1AssetsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationV3Response1AssetsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationV3Response1AssetsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationV3Response1AssetsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountInformationV3Response1AssetsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationV3Response1AssetsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountInformationV3Response1AssetsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationV3Response1AssetsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationV3Response1AssetsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationV3Response1AssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationV3Response1AssetsInner
     */
    public static AccountInformationV3Response1AssetsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, AccountInformationV3Response1AssetsInner.class);
    }

    /**
     * Convert an instance of AccountInformationV3Response1AssetsInner to an JSON string
     *
     * @return JSON string
     */
