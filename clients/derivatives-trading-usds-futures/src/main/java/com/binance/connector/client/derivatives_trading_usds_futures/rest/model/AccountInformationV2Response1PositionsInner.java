...
public class AccountInformationV2Response1PositionsInner {
    ...
    public AccountInformationV2Response1PositionsInner() {}

    public AccountInformationV2Response1PositionsInner symbol(
    ...
    public AccountInformationV2Response1PositionsInner initialMargin(
    ...
    public AccountInformationV2Response1PositionsInner maintMargin(
    ...
    public AccountInformationV2Response1PositionsInner unrealizedProfit(
    ...
    public AccountInformationV2Response1PositionsInner positionInitialMargin(
    ...
    public AccountInformationV2Response1PositionsInner openOrderInitialMargin(
    ...
    public AccountInformationV2Response1PositionsInner leverage(
    ...
    public AccountInformationV2Response1PositionsInner isolated(
    ...
    public AccountInformationV2Response1PositionsInner entryPrice(
    ...
    public AccountInformationV2Response1PositionsInner maxNotional(
    ...
    public AccountInformationV2Response1PositionsInner bidNotional(
    ...
    public AccountInformationV2Response1PositionsInner askNotional(
    ...
    public AccountInformationV2Response1PositionsInner positionSide(
    ...
    public AccountInformationV2Response1PositionsInner positionAmt(
    ...
    public AccountInformationV2Response1PositionsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationV2Response1PositionsInner accountInformationV2Response1PositionsInner =
                (AccountInformationV2Response1PositionsInner) o;
        return Objects.equals(this.symbol, accountInformationV2Response1PositionsInner.symbol)
                && Objects.equals(
                        this.initialMargin,
                        accountInformationV2Response1PositionsInner.initialMargin)
                && Objects.equals(
                        this.maintMargin, accountInformationV2Response1PositionsInner.maintMargin)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationV2Response1PositionsInner.unrealizedProfit)
                && Objects.equals(
                        this.positionInitialMargin,
                        accountInformationV2Response1PositionsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        accountInformationV2Response1PositionsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.leverage, accountInformationV2Response1PositionsInner.leverage)
                && Objects.equals(
                        this.isolated, accountInformationV2Response1PositionsInner.isolated)
                && Objects.equals(
                        this.entryPrice, accountInformationV2Response1PositionsInner.entryPrice)
                && Objects.equals(
                        this.maxNotional, accountInformationV2Response1PositionsInner.maxNotional)
                && Objects.equals(
                        this.bidNotional, accountInformationV2Response1PositionsInner.bidNotional)
                && Objects.equals(
                        this.askNotional, accountInformationV2Response1PositionsInner.askNotional)
                && Objects.equals(
                        this.positionSide, accountInformationV2Response1PositionsInner.positionSide)
                && Objects.equals(
                        this.positionAmt, accountInformationV2Response1PositionsInner.positionAmt)
                && Objects.equals(
                        this.updateTime, accountInformationV2Response1PositionsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationV2Response1PositionsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationV2Response1PositionsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationV2Response1PositionsInner is not found in"
                                    + " the empty JSON string",
                                AccountInformationV2Response1PositionsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationV2Response1PositionsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `AccountInformationV2Response1PositionsInner` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationV2Response1PositionsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationV2Response1PositionsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationV2Response1PositionsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountInformationV2Response1PositionsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationV2Response1PositionsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountInformationV2Response1PositionsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationV2Response1PositionsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationV2Response1PositionsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationV2Response1PositionsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationV2Response1PositionsInner
     */
    public static AccountInformationV2Response1PositionsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountInformationV2Response1PositionsInner.class);
    }

    /**
     * Convert an instance of AccountInformationV2Response1PositionsInner to an JSON string
     *
     * @return JSON string
     */
