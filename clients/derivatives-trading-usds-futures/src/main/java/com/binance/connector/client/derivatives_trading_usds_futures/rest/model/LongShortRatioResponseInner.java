...
public class LongShortRatioResponseInner {
    ...
    public LongShortRatioResponseInner() {}

    public LongShortRatioResponseInner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public LongShortRatioResponseInner longShortRatio(
    ...
    public LongShortRatioResponseInner longAccount(
    ...
    public LongShortRatioResponseInner shortAccount(
    ...
    public LongShortRatioResponseInner timestamp(@jakarta.annotation.Nullable String timestamp) {
    ...
    public boolean equals(Object o) {
        ...
        LongShortRatioResponseInner longShortRatioResponseInner = (LongShortRatioResponseInner) o;
        return Objects.equals(this.symbol, longShortRatioResponseInner.symbol)
                && Objects.equals(this.longShortRatio, longShortRatioResponseInner.longShortRatio)
                && Objects.equals(this.longAccount, longShortRatioResponseInner.longAccount)
                && Objects.equals(this.shortAccount, longShortRatioResponseInner.shortAccount)
                && Objects.equals(this.timestamp, longShortRatioResponseInner.timestamp);
    }
    ...
    public String toString() {
        ...
        sb.append("class LongShortRatioResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!LongShortRatioResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LongShortRatioResponseInner is not"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!LongShortRatioResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'LongShortRatioResponseInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<LongShortRatioResponseInner> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(LongShortRatioResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<LongShortRatioResponseInner>() {
                        @Override
                        ...
                        @Override
                        public LongShortRatioResponseInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of LongShortRatioResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of LongShortRatioResponseInner
     * @throws IOException if the JSON string is invalid with respect to LongShortRatioResponseInner
     */
    public static LongShortRatioResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, LongShortRatioResponseInner.class);
    }

    /**
     * Convert an instance of LongShortRatioResponseInner to an JSON string
     *
     * @return JSON string
     */
