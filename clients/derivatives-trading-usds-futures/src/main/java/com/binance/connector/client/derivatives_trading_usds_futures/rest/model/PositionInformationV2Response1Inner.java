...
public class PositionInformationV2Response1Inner {
    ...
    public PositionInformationV2Response1Inner() {}

    public PositionInformationV2Response1Inner entryPrice(
    ...
    public PositionInformationV2Response1Inner breakEvenPrice(
    ...
    public PositionInformationV2Response1Inner marginType(
    ...
    public PositionInformationV2Response1Inner isAutoAddMargin(
    ...
    public PositionInformationV2Response1Inner isolatedMargin(
    ...
    public PositionInformationV2Response1Inner leverage(
    ...
    public PositionInformationV2Response1Inner liquidationPrice(
    ...
    public PositionInformationV2Response1Inner markPrice(
    ...
    public PositionInformationV2Response1Inner maxNotionalValue(
    ...
    public PositionInformationV2Response1Inner positionAmt(
    ...
    public PositionInformationV2Response1Inner notional(
    ...
    public PositionInformationV2Response1Inner isolatedWallet(
    ...
    public PositionInformationV2Response1Inner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public PositionInformationV2Response1Inner unRealizedProfit(
    ...
    public PositionInformationV2Response1Inner positionSide(
    ...
    public PositionInformationV2Response1Inner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        PositionInformationV2Response1Inner positionInformationV2Response1Inner =
                (PositionInformationV2Response1Inner) o;
        return Objects.equals(this.entryPrice, positionInformationV2Response1Inner.entryPrice)
                && Objects.equals(
                        this.breakEvenPrice, positionInformationV2Response1Inner.breakEvenPrice)
                && Objects.equals(this.marginType, positionInformationV2Response1Inner.marginType)
                && Objects.equals(
                        this.isAutoAddMargin, positionInformationV2Response1Inner.isAutoAddMargin)
                && Objects.equals(
                        this.isolatedMargin, positionInformationV2Response1Inner.isolatedMargin)
                && Objects.equals(this.leverage, positionInformationV2Response1Inner.leverage)
                && Objects.equals(
                        this.liquidationPrice, positionInformationV2Response1Inner.liquidationPrice)
                && Objects.equals(this.markPrice, positionInformationV2Response1Inner.markPrice)
                && Objects.equals(
                        this.maxNotionalValue, positionInformationV2Response1Inner.maxNotionalValue)
                && Objects.equals(this.positionAmt, positionInformationV2Response1Inner.positionAmt)
                && Objects.equals(this.notional, positionInformationV2Response1Inner.notional)
                && Objects.equals(
                        this.isolatedWallet, positionInformationV2Response1Inner.isolatedWallet)
                && Objects.equals(this.symbol, positionInformationV2Response1Inner.symbol)
                && Objects.equals(
                        this.unRealizedProfit, positionInformationV2Response1Inner.unRealizedProfit)
                && Objects.equals(
                        this.positionSide, positionInformationV2Response1Inner.positionSide)
                && Objects.equals(this.updateTime, positionInformationV2Response1Inner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class PositionInformationV2Response1Inner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PositionInformationV2Response1Inner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PositionInformationV2Response1Inner is"
                                        + " not found in the empty JSON string",
                                PositionInformationV2Response1Inner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PositionInformationV2Response1Inner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `PositionInformationV2Response1Inner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PositionInformationV2Response1Inner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PositionInformationV2Response1Inner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PositionInformationV2Response1Inner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(PositionInformationV2Response1Inner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<PositionInformationV2Response1Inner>() {
                        @Override
                        public void write(JsonWriter out, PositionInformationV2Response1Inner value)
                                throws IOException {
                        ...
                        @Override
                        public PositionInformationV2Response1Inner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of PositionInformationV2Response1Inner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PositionInformationV2Response1Inner
     * @throws IOException if the JSON string is invalid with respect to
     *     PositionInformationV2Response1Inner
     */
    public static PositionInformationV2Response1Inner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, PositionInformationV2Response1Inner.class);
    }

    /**
     * Convert an instance of PositionInformationV2Response1Inner to an JSON string
     *
     * @return JSON string
     */
