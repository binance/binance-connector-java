...
public class AccountInformationV2Response2ResultAssetsInner extends BaseDTO {
    ...
    public AccountInformationV2Response2ResultAssetsInner() {}

    public AccountInformationV2Response2ResultAssetsInner asset(
    ...
    public AccountInformationV2Response2ResultAssetsInner walletBalance(
    ...
    public AccountInformationV2Response2ResultAssetsInner unrealizedProfit(
    ...
    public AccountInformationV2Response2ResultAssetsInner marginBalance(
    ...
    public AccountInformationV2Response2ResultAssetsInner maintMargin(
    ...
    public AccountInformationV2Response2ResultAssetsInner initialMargin(
    ...
    public AccountInformationV2Response2ResultAssetsInner positionInitialMargin(
    ...
    public AccountInformationV2Response2ResultAssetsInner openOrderInitialMargin(
    ...
    public AccountInformationV2Response2ResultAssetsInner crossWalletBalance(
    ...
    public AccountInformationV2Response2ResultAssetsInner crossUnPnl(
    ...
    public AccountInformationV2Response2ResultAssetsInner availableBalance(
    ...
    public AccountInformationV2Response2ResultAssetsInner maxWithdrawAmount(
    ...
    public AccountInformationV2Response2ResultAssetsInner marginAvailable(
    ...
    public AccountInformationV2Response2ResultAssetsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationV2Response2ResultAssetsInner
                accountInformationV2Response2ResultAssetsInner =
                        (AccountInformationV2Response2ResultAssetsInner) o;
        return Objects.equals(this.asset, accountInformationV2Response2ResultAssetsInner.asset)
                && Objects.equals(
                        this.walletBalance,
                        accountInformationV2Response2ResultAssetsInner.walletBalance)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationV2Response2ResultAssetsInner.unrealizedProfit)
                && Objects.equals(
                        this.marginBalance,
                        accountInformationV2Response2ResultAssetsInner.marginBalance)
                && Objects.equals(
                        this.maintMargin,
                        accountInformationV2Response2ResultAssetsInner.maintMargin)
                && Objects.equals(
                        this.initialMargin,
                        accountInformationV2Response2ResultAssetsInner.initialMargin)
                && Objects.equals(
                        this.positionInitialMargin,
                        accountInformationV2Response2ResultAssetsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        accountInformationV2Response2ResultAssetsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.crossWalletBalance,
                        accountInformationV2Response2ResultAssetsInner.crossWalletBalance)
                && Objects.equals(
                        this.crossUnPnl, accountInformationV2Response2ResultAssetsInner.crossUnPnl)
                && Objects.equals(
                        this.availableBalance,
                        accountInformationV2Response2ResultAssetsInner.availableBalance)
                && Objects.equals(
                        this.maxWithdrawAmount,
                        accountInformationV2Response2ResultAssetsInner.maxWithdrawAmount)
                && Objects.equals(
                        this.marginAvailable,
                        accountInformationV2Response2ResultAssetsInner.marginAvailable)
                && Objects.equals(
                        this.updateTime, accountInformationV2Response2ResultAssetsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationV2Response2ResultAssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationV2Response2ResultAssetsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationV2Response2ResultAssetsInner is not found"
                                    + " in the empty JSON string",
                                AccountInformationV2Response2ResultAssetsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationV2Response2ResultAssetsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationV2Response2ResultAssetsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationV2Response2ResultAssetsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationV2Response2ResultAssetsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(AccountInformationV2Response2ResultAssetsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationV2Response2ResultAssetsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                AccountInformationV2Response2ResultAssetsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationV2Response2ResultAssetsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationV2Response2ResultAssetsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationV2Response2ResultAssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationV2Response2ResultAssetsInner
     */
    public static AccountInformationV2Response2ResultAssetsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountInformationV2Response2ResultAssetsInner.class);
    }

    /**
     * Convert an instance of AccountInformationV2Response2ResultAssetsInner to an JSON string
     *
     * @return JSON string
     */
