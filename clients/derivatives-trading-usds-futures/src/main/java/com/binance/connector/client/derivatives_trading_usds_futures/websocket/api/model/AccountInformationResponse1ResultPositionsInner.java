...
public class AccountInformationResponse1ResultPositionsInner extends BaseDTO {
    ...
    public AccountInformationResponse1ResultPositionsInner() {}

    public AccountInformationResponse1ResultPositionsInner symbol(
    ...
    public AccountInformationResponse1ResultPositionsInner initialMargin(
    ...
    public AccountInformationResponse1ResultPositionsInner maintMargin(
    ...
    public AccountInformationResponse1ResultPositionsInner unrealizedProfit(
    ...
    public AccountInformationResponse1ResultPositionsInner positionInitialMargin(
    ...
    public AccountInformationResponse1ResultPositionsInner openOrderInitialMargin(
    ...
    public AccountInformationResponse1ResultPositionsInner leverage(
    ...
    public AccountInformationResponse1ResultPositionsInner isolated(
    ...
    public AccountInformationResponse1ResultPositionsInner entryPrice(
    ...
    public AccountInformationResponse1ResultPositionsInner maxNotional(
    ...
    public AccountInformationResponse1ResultPositionsInner bidNotional(
    ...
    public AccountInformationResponse1ResultPositionsInner askNotional(
    ...
    public AccountInformationResponse1ResultPositionsInner positionSide(
    ...
    public AccountInformationResponse1ResultPositionsInner positionAmt(
    ...
    public AccountInformationResponse1ResultPositionsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationResponse1ResultPositionsInner
                accountInformationResponse1ResultPositionsInner =
                        (AccountInformationResponse1ResultPositionsInner) o;
        return Objects.equals(this.symbol, accountInformationResponse1ResultPositionsInner.symbol)
                && Objects.equals(
                        this.initialMargin,
                        accountInformationResponse1ResultPositionsInner.initialMargin)
                && Objects.equals(
                        this.maintMargin,
                        accountInformationResponse1ResultPositionsInner.maintMargin)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationResponse1ResultPositionsInner.unrealizedProfit)
                && Objects.equals(
                        this.positionInitialMargin,
                        accountInformationResponse1ResultPositionsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        accountInformationResponse1ResultPositionsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.leverage, accountInformationResponse1ResultPositionsInner.leverage)
                && Objects.equals(
                        this.isolated, accountInformationResponse1ResultPositionsInner.isolated)
                && Objects.equals(
                        this.entryPrice, accountInformationResponse1ResultPositionsInner.entryPrice)
                && Objects.equals(
                        this.maxNotional,
                        accountInformationResponse1ResultPositionsInner.maxNotional)
                && Objects.equals(
                        this.bidNotional,
                        accountInformationResponse1ResultPositionsInner.bidNotional)
                && Objects.equals(
                        this.askNotional,
                        accountInformationResponse1ResultPositionsInner.askNotional)
                && Objects.equals(
                        this.positionSide,
                        accountInformationResponse1ResultPositionsInner.positionSide)
                && Objects.equals(
                        this.positionAmt,
                        accountInformationResponse1ResultPositionsInner.positionAmt)
                && Objects.equals(
                        this.updateTime,
                        accountInformationResponse1ResultPositionsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationResponse1ResultPositionsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationResponse1ResultPositionsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                        + " AccountInformationResponse1ResultPositionsInner is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationResponse1ResultPositionsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationResponse1ResultPositionsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationResponse1ResultPositionsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationResponse1ResultPositionsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(AccountInformationResponse1ResultPositionsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationResponse1ResultPositionsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                AccountInformationResponse1ResultPositionsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationResponse1ResultPositionsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationResponse1ResultPositionsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationResponse1ResultPositionsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationResponse1ResultPositionsInner
     */
    public static AccountInformationResponse1ResultPositionsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountInformationResponse1ResultPositionsInner.class);
    }

    /**
     * Convert an instance of AccountInformationResponse1ResultPositionsInner to an JSON string
     *
     * @return JSON string
     */
