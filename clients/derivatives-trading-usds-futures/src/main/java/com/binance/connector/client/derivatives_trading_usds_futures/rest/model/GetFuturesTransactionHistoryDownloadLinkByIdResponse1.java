...
public class GetFuturesTransactionHistoryDownloadLinkByIdResponse1 {
    ...
    public GetFuturesTransactionHistoryDownloadLinkByIdResponse1 downloadId(
    ...
    public GetFuturesTransactionHistoryDownloadLinkByIdResponse1 status(
    ...
    public GetFuturesTransactionHistoryDownloadLinkByIdResponse1 url(
    ...
    public GetFuturesTransactionHistoryDownloadLinkByIdResponse1 notified(
    ...
    public GetFuturesTransactionHistoryDownloadLinkByIdResponse1 expirationTimestamp(
    ...
    public GetFuturesTransactionHistoryDownloadLinkByIdResponse1 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetFuturesTransactionHistoryDownloadLinkByIdResponse1
                getFuturesTransactionHistoryDownloadLinkByIdResponse1 =
                        (GetFuturesTransactionHistoryDownloadLinkByIdResponse1) o;
        return Objects.equals(
                        this.downloadId,
                        getFuturesTransactionHistoryDownloadLinkByIdResponse1.downloadId)
                && Objects.equals(
                        this.status, getFuturesTransactionHistoryDownloadLinkByIdResponse1.status)
                && Objects.equals(
                        this.url, getFuturesTransactionHistoryDownloadLinkByIdResponse1.url)
                && Objects.equals(
                        this.notified,
                        getFuturesTransactionHistoryDownloadLinkByIdResponse1.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getFuturesTransactionHistoryDownloadLinkByIdResponse1.expirationTimestamp)
                && Objects.equals(
                        this.isExpired,
                        getFuturesTransactionHistoryDownloadLinkByIdResponse1.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetFuturesTransactionHistoryDownloadLinkByIdResponse1 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetFuturesTransactionHistoryDownloadLinkByIdResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetFuturesTransactionHistoryDownloadLinkByIdResponse1 is"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetFuturesTransactionHistoryDownloadLinkByIdResponse1.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFuturesTransactionHistoryDownloadLinkByIdResponse1.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetFuturesTransactionHistoryDownloadLinkByIdResponse1' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetFuturesTransactionHistoryDownloadLinkByIdResponse1> thisAdapter =
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<GetFuturesTransactionHistoryDownloadLinkByIdResponse1>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                GetFuturesTransactionHistoryDownloadLinkByIdResponse1 value)
                                throws IOException {
                        ...
                        @Override
                        public GetFuturesTransactionHistoryDownloadLinkByIdResponse1 read(
    ...
    /**
     * Create an instance of GetFuturesTransactionHistoryDownloadLinkByIdResponse1 given an JSON
     * string
     *
     * @param jsonString JSON string
     * @return An instance of GetFuturesTransactionHistoryDownloadLinkByIdResponse1
     * @throws IOException if the JSON string is invalid with respect to
     *     GetFuturesTransactionHistoryDownloadLinkByIdResponse1
     */
    public static GetFuturesTransactionHistoryDownloadLinkByIdResponse1 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetFuturesTransactionHistoryDownloadLinkByIdResponse1.class);
    }

    /**
     * Convert an instance of GetFuturesTransactionHistoryDownloadLinkByIdResponse1 to an JSON
     * string
     *
     * @return JSON string
     */
