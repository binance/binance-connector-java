...
public class MultiAssetsModeAssetIndexResponse2Inner {
    ...
    public MultiAssetsModeAssetIndexResponse2Inner() {}

    public MultiAssetsModeAssetIndexResponse2Inner symbol(
    ...
    public MultiAssetsModeAssetIndexResponse2Inner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public MultiAssetsModeAssetIndexResponse2Inner index(
            @jakarta.annotation.Nullable String index) {
        this.index = index;
        return this;
    }
    ...
    public MultiAssetsModeAssetIndexResponse2Inner bidBuffer(
    ...
    public MultiAssetsModeAssetIndexResponse2Inner askBuffer(
    ...
    public MultiAssetsModeAssetIndexResponse2Inner bidRate(
            @jakarta.annotation.Nullable String bidRate) {
    ...
    public MultiAssetsModeAssetIndexResponse2Inner askRate(
            @jakarta.annotation.Nullable String askRate) {
    ...
    public MultiAssetsModeAssetIndexResponse2Inner autoExchangeBidBuffer(
    ...
    public MultiAssetsModeAssetIndexResponse2Inner autoExchangeAskBuffer(
    ...
    public MultiAssetsModeAssetIndexResponse2Inner autoExchangeBidRate(
    ...
    public MultiAssetsModeAssetIndexResponse2Inner autoExchangeAskRate(
    ...
    public boolean equals(Object o) {
        ...
        MultiAssetsModeAssetIndexResponse2Inner multiAssetsModeAssetIndexResponse2Inner =
                (MultiAssetsModeAssetIndexResponse2Inner) o;
        return Objects.equals(this.symbol, multiAssetsModeAssetIndexResponse2Inner.symbol)
                && Objects.equals(this.time, multiAssetsModeAssetIndexResponse2Inner.time)
                && Objects.equals(this.index, multiAssetsModeAssetIndexResponse2Inner.index)
                && Objects.equals(this.bidBuffer, multiAssetsModeAssetIndexResponse2Inner.bidBuffer)
                && Objects.equals(this.askBuffer, multiAssetsModeAssetIndexResponse2Inner.askBuffer)
                && Objects.equals(this.bidRate, multiAssetsModeAssetIndexResponse2Inner.bidRate)
                && Objects.equals(this.askRate, multiAssetsModeAssetIndexResponse2Inner.askRate)
                && Objects.equals(
                        this.autoExchangeBidBuffer,
                        multiAssetsModeAssetIndexResponse2Inner.autoExchangeBidBuffer)
                && Objects.equals(
                        this.autoExchangeAskBuffer,
                        multiAssetsModeAssetIndexResponse2Inner.autoExchangeAskBuffer)
                && Objects.equals(
                        this.autoExchangeBidRate,
                        multiAssetsModeAssetIndexResponse2Inner.autoExchangeBidRate)
                && Objects.equals(
                        this.autoExchangeAskRate,
                        multiAssetsModeAssetIndexResponse2Inner.autoExchangeAskRate);
    }
    ...
    public String toString() {
        ...
        sb.append("class MultiAssetsModeAssetIndexResponse2Inner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MultiAssetsModeAssetIndexResponse2Inner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " MultiAssetsModeAssetIndexResponse2Inner is not found in the"
                                    + " empty JSON string",
                                MultiAssetsModeAssetIndexResponse2Inner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!MultiAssetsModeAssetIndexResponse2Inner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `MultiAssetsModeAssetIndexResponse2Inner` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MultiAssetsModeAssetIndexResponse2Inner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes 'MultiAssetsModeAssetIndexResponse2Inner'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<MultiAssetsModeAssetIndexResponse2Inner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(MultiAssetsModeAssetIndexResponse2Inner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<MultiAssetsModeAssetIndexResponse2Inner>() {
                        @Override
                        public void write(
                                JsonWriter out, MultiAssetsModeAssetIndexResponse2Inner value)
                                throws IOException {
                        ...
                        @Override
                        public MultiAssetsModeAssetIndexResponse2Inner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of MultiAssetsModeAssetIndexResponse2Inner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MultiAssetsModeAssetIndexResponse2Inner
     * @throws IOException if the JSON string is invalid with respect to
     *     MultiAssetsModeAssetIndexResponse2Inner
     */
    public static MultiAssetsModeAssetIndexResponse2Inner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, MultiAssetsModeAssetIndexResponse2Inner.class);
    }

    /**
     * Convert an instance of MultiAssetsModeAssetIndexResponse2Inner to an JSON string
     *
     * @return JSON string
     */
