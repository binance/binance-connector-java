...
public class PositionInformationV3Response1Inner {
    ...
    public PositionInformationV3Response1Inner() {}

    public PositionInformationV3Response1Inner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public PositionInformationV3Response1Inner positionSide(
    ...
    public PositionInformationV3Response1Inner positionAmt(
    ...
    public PositionInformationV3Response1Inner entryPrice(
    ...
    public PositionInformationV3Response1Inner breakEvenPrice(
    ...
    public PositionInformationV3Response1Inner markPrice(
    ...
    public PositionInformationV3Response1Inner unRealizedProfit(
    ...
    public PositionInformationV3Response1Inner liquidationPrice(
    ...
    public PositionInformationV3Response1Inner isolatedMargin(
    ...
    public PositionInformationV3Response1Inner notional(
    ...
    public PositionInformationV3Response1Inner marginAsset(
    ...
    public PositionInformationV3Response1Inner isolatedWallet(
    ...
    public PositionInformationV3Response1Inner initialMargin(
    ...
    public PositionInformationV3Response1Inner maintMargin(
    ...
    public PositionInformationV3Response1Inner positionInitialMargin(
    ...
    public PositionInformationV3Response1Inner openOrderInitialMargin(
    ...
    public PositionInformationV3Response1Inner adl(@jakarta.annotation.Nullable Long adl) {
        this.adl = adl;
        return this;
    }
    ...
    public PositionInformationV3Response1Inner bidNotional(
    ...
    public PositionInformationV3Response1Inner askNotional(
    ...
    public PositionInformationV3Response1Inner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        PositionInformationV3Response1Inner positionInformationV3Response1Inner =
                (PositionInformationV3Response1Inner) o;
        return Objects.equals(this.symbol, positionInformationV3Response1Inner.symbol)
                && Objects.equals(
                        this.positionSide, positionInformationV3Response1Inner.positionSide)
                && Objects.equals(this.positionAmt, positionInformationV3Response1Inner.positionAmt)
                && Objects.equals(this.entryPrice, positionInformationV3Response1Inner.entryPrice)
                && Objects.equals(
                        this.breakEvenPrice, positionInformationV3Response1Inner.breakEvenPrice)
                && Objects.equals(this.markPrice, positionInformationV3Response1Inner.markPrice)
                && Objects.equals(
                        this.unRealizedProfit, positionInformationV3Response1Inner.unRealizedProfit)
                && Objects.equals(
                        this.liquidationPrice, positionInformationV3Response1Inner.liquidationPrice)
                && Objects.equals(
                        this.isolatedMargin, positionInformationV3Response1Inner.isolatedMargin)
                && Objects.equals(this.notional, positionInformationV3Response1Inner.notional)
                && Objects.equals(this.marginAsset, positionInformationV3Response1Inner.marginAsset)
                && Objects.equals(
                        this.isolatedWallet, positionInformationV3Response1Inner.isolatedWallet)
                && Objects.equals(
                        this.initialMargin, positionInformationV3Response1Inner.initialMargin)
                && Objects.equals(this.maintMargin, positionInformationV3Response1Inner.maintMargin)
                && Objects.equals(
                        this.positionInitialMargin,
                        positionInformationV3Response1Inner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        positionInformationV3Response1Inner.openOrderInitialMargin)
                && Objects.equals(this.adl, positionInformationV3Response1Inner.adl)
                && Objects.equals(this.bidNotional, positionInformationV3Response1Inner.bidNotional)
                && Objects.equals(this.askNotional, positionInformationV3Response1Inner.askNotional)
                && Objects.equals(this.updateTime, positionInformationV3Response1Inner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class PositionInformationV3Response1Inner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PositionInformationV3Response1Inner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PositionInformationV3Response1Inner is"
                                        + " not found in the empty JSON string",
                                PositionInformationV3Response1Inner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PositionInformationV3Response1Inner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `PositionInformationV3Response1Inner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PositionInformationV3Response1Inner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PositionInformationV3Response1Inner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PositionInformationV3Response1Inner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(PositionInformationV3Response1Inner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<PositionInformationV3Response1Inner>() {
                        @Override
                        public void write(JsonWriter out, PositionInformationV3Response1Inner value)
                                throws IOException {
                        ...
                        @Override
                        public PositionInformationV3Response1Inner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of PositionInformationV3Response1Inner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PositionInformationV3Response1Inner
     * @throws IOException if the JSON string is invalid with respect to
     *     PositionInformationV3Response1Inner
     */
    public static PositionInformationV3Response1Inner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, PositionInformationV3Response1Inner.class);
    }

    /**
     * Convert an instance of PositionInformationV3Response1Inner to an JSON string
     *
     * @return JSON string
     */
