...
public class OrderBookResponseRateLimitsInner extends BaseDTO {
    ...
    public OrderBookResponseRateLimitsInner() {}

    public OrderBookResponseRateLimitsInner rateLimitType(
    ...
    public OrderBookResponseRateLimitsInner interval(@jakarta.annotation.Nullable String interval) {
    ...
    public OrderBookResponseRateLimitsInner intervalNum(
    ...
    public OrderBookResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public OrderBookResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderBookResponseRateLimitsInner orderBookResponseRateLimitsInner =
                (OrderBookResponseRateLimitsInner) o;
        return Objects.equals(this.rateLimitType, orderBookResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, orderBookResponseRateLimitsInner.interval)
                && Objects.equals(this.intervalNum, orderBookResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, orderBookResponseRateLimitsInner.limit)
                && Objects.equals(this.count, orderBookResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderBookResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderBookResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderBookResponseRateLimitsInner is"
                                        + " not found in the empty JSON string",
                                OrderBookResponseRateLimitsInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderBookResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `OrderBookResponseRateLimitsInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderBookResponseRateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderBookResponseRateLimitsInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderBookResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OrderBookResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderBookResponseRateLimitsInner>() {
                        @Override
                        public void write(JsonWriter out, OrderBookResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public OrderBookResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of OrderBookResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderBookResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OrderBookResponseRateLimitsInner
     */
    public static OrderBookResponseRateLimitsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderBookResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of OrderBookResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
