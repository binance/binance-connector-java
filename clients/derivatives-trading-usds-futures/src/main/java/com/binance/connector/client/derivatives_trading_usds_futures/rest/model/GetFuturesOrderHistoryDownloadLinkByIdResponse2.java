...
public class GetFuturesOrderHistoryDownloadLinkByIdResponse2 {
    ...
    public GetFuturesOrderHistoryDownloadLinkByIdResponse2 downloadId(
    ...
    public GetFuturesOrderHistoryDownloadLinkByIdResponse2 status(
    ...
    public GetFuturesOrderHistoryDownloadLinkByIdResponse2 url(
    ...
    public GetFuturesOrderHistoryDownloadLinkByIdResponse2 notified(
    ...
    public GetFuturesOrderHistoryDownloadLinkByIdResponse2 expirationTimestamp(
    ...
    public GetFuturesOrderHistoryDownloadLinkByIdResponse2 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetFuturesOrderHistoryDownloadLinkByIdResponse2
                getFuturesOrderHistoryDownloadLinkByIdResponse2 =
                        (GetFuturesOrderHistoryDownloadLinkByIdResponse2) o;
        return Objects.equals(
                        this.downloadId, getFuturesOrderHistoryDownloadLinkByIdResponse2.downloadId)
                && Objects.equals(
                        this.status, getFuturesOrderHistoryDownloadLinkByIdResponse2.status)
                && Objects.equals(this.url, getFuturesOrderHistoryDownloadLinkByIdResponse2.url)
                && Objects.equals(
                        this.notified, getFuturesOrderHistoryDownloadLinkByIdResponse2.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getFuturesOrderHistoryDownloadLinkByIdResponse2.expirationTimestamp)
                && Objects.equals(
                        this.isExpired, getFuturesOrderHistoryDownloadLinkByIdResponse2.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetFuturesOrderHistoryDownloadLinkByIdResponse2 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetFuturesOrderHistoryDownloadLinkByIdResponse2.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                        + " GetFuturesOrderHistoryDownloadLinkByIdResponse2 is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetFuturesOrderHistoryDownloadLinkByIdResponse2.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFuturesOrderHistoryDownloadLinkByIdResponse2.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetFuturesOrderHistoryDownloadLinkByIdResponse2' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetFuturesOrderHistoryDownloadLinkByIdResponse2> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(GetFuturesOrderHistoryDownloadLinkByIdResponse2.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetFuturesOrderHistoryDownloadLinkByIdResponse2>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                GetFuturesOrderHistoryDownloadLinkByIdResponse2 value)
                                throws IOException {
                        ...
                        @Override
                        public GetFuturesOrderHistoryDownloadLinkByIdResponse2 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetFuturesOrderHistoryDownloadLinkByIdResponse2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetFuturesOrderHistoryDownloadLinkByIdResponse2
     * @throws IOException if the JSON string is invalid with respect to
     *     GetFuturesOrderHistoryDownloadLinkByIdResponse2
     */
    public static GetFuturesOrderHistoryDownloadLinkByIdResponse2 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetFuturesOrderHistoryDownloadLinkByIdResponse2.class);
    }

    /**
     * Convert an instance of GetFuturesOrderHistoryDownloadLinkByIdResponse2 to an JSON string
     *
     * @return JSON string
     */
