...
public class AccountInformationV2Response1ResultAssetsInner extends BaseDTO {
    ...
    public AccountInformationV2Response1ResultAssetsInner() {}

    public AccountInformationV2Response1ResultAssetsInner asset(
    ...
    public AccountInformationV2Response1ResultAssetsInner walletBalance(
    ...
    public AccountInformationV2Response1ResultAssetsInner unrealizedProfit(
    ...
    public AccountInformationV2Response1ResultAssetsInner marginBalance(
    ...
    public AccountInformationV2Response1ResultAssetsInner maintMargin(
    ...
    public AccountInformationV2Response1ResultAssetsInner initialMargin(
    ...
    public AccountInformationV2Response1ResultAssetsInner positionInitialMargin(
    ...
    public AccountInformationV2Response1ResultAssetsInner openOrderInitialMargin(
    ...
    public AccountInformationV2Response1ResultAssetsInner crossWalletBalance(
    ...
    public AccountInformationV2Response1ResultAssetsInner crossUnPnl(
    ...
    public AccountInformationV2Response1ResultAssetsInner availableBalance(
    ...
    public AccountInformationV2Response1ResultAssetsInner maxWithdrawAmount(
    ...
    public AccountInformationV2Response1ResultAssetsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationV2Response1ResultAssetsInner
                accountInformationV2Response1ResultAssetsInner =
                        (AccountInformationV2Response1ResultAssetsInner) o;
        return Objects.equals(this.asset, accountInformationV2Response1ResultAssetsInner.asset)
                && Objects.equals(
                        this.walletBalance,
                        accountInformationV2Response1ResultAssetsInner.walletBalance)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationV2Response1ResultAssetsInner.unrealizedProfit)
                && Objects.equals(
                        this.marginBalance,
                        accountInformationV2Response1ResultAssetsInner.marginBalance)
                && Objects.equals(
                        this.maintMargin,
                        accountInformationV2Response1ResultAssetsInner.maintMargin)
                && Objects.equals(
                        this.initialMargin,
                        accountInformationV2Response1ResultAssetsInner.initialMargin)
                && Objects.equals(
                        this.positionInitialMargin,
                        accountInformationV2Response1ResultAssetsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        accountInformationV2Response1ResultAssetsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.crossWalletBalance,
                        accountInformationV2Response1ResultAssetsInner.crossWalletBalance)
                && Objects.equals(
                        this.crossUnPnl, accountInformationV2Response1ResultAssetsInner.crossUnPnl)
                && Objects.equals(
                        this.availableBalance,
                        accountInformationV2Response1ResultAssetsInner.availableBalance)
                && Objects.equals(
                        this.maxWithdrawAmount,
                        accountInformationV2Response1ResultAssetsInner.maxWithdrawAmount)
                && Objects.equals(
                        this.updateTime, accountInformationV2Response1ResultAssetsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationV2Response1ResultAssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationV2Response1ResultAssetsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationV2Response1ResultAssetsInner is not found"
                                    + " in the empty JSON string",
                                AccountInformationV2Response1ResultAssetsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationV2Response1ResultAssetsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationV2Response1ResultAssetsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationV2Response1ResultAssetsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationV2Response1ResultAssetsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(AccountInformationV2Response1ResultAssetsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationV2Response1ResultAssetsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                AccountInformationV2Response1ResultAssetsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationV2Response1ResultAssetsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationV2Response1ResultAssetsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationV2Response1ResultAssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationV2Response1ResultAssetsInner
     */
    public static AccountInformationV2Response1ResultAssetsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountInformationV2Response1ResultAssetsInner.class);
    }

    /**
     * Convert an instance of AccountInformationV2Response1ResultAssetsInner to an JSON string
     *
     * @return JSON string
     */
