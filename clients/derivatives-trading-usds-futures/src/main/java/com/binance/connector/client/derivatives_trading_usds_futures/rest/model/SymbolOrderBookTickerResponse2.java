...
public class SymbolOrderBookTickerResponse2 extends ArrayList<SymbolOrderBookTickerResponse2Inner> {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (JsonElement element : array) {
            SymbolOrderBookTickerResponse2Inner.validateJsonElement(element);
        }
        if (jsonElement == null) {
