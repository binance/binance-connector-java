...
/** AccountInformationV2Response1ResultPositionsInner */
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.12.0")
public class AccountInformationV2Response1ResultPositionsInner extends BaseDTO {
    ...
    public AccountInformationV2Response1ResultPositionsInner() {}

    public AccountInformationV2Response1ResultPositionsInner symbol(
    ...
    public AccountInformationV2Response1ResultPositionsInner positionSide(
    ...
    public AccountInformationV2Response1ResultPositionsInner positionAmt(
    ...
    public AccountInformationV2Response1ResultPositionsInner unrealizedProfit(
    ...
    public AccountInformationV2Response1ResultPositionsInner isolatedMargin(
    ...
    public AccountInformationV2Response1ResultPositionsInner notional(
    ...
    public AccountInformationV2Response1ResultPositionsInner isolatedWallet(
    ...
    public AccountInformationV2Response1ResultPositionsInner initialMargin(
    ...
    public AccountInformationV2Response1ResultPositionsInner maintMargin(
    ...
    public AccountInformationV2Response1ResultPositionsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationV2Response1ResultPositionsInner
                accountInformationV2Response1ResultPositionsInner =
                        (AccountInformationV2Response1ResultPositionsInner) o;
        return Objects.equals(this.symbol, accountInformationV2Response1ResultPositionsInner.symbol)
                && Objects.equals(
                        this.positionSide,
                        accountInformationV2Response1ResultPositionsInner.positionSide)
                && Objects.equals(
                        this.positionAmt,
                        accountInformationV2Response1ResultPositionsInner.positionAmt)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationV2Response1ResultPositionsInner.unrealizedProfit)
                && Objects.equals(
                        this.isolatedMargin,
                        accountInformationV2Response1ResultPositionsInner.isolatedMargin)
                && Objects.equals(
                        this.notional, accountInformationV2Response1ResultPositionsInner.notional)
                && Objects.equals(
                        this.isolatedWallet,
                        accountInformationV2Response1ResultPositionsInner.isolatedWallet)
                && Objects.equals(
                        this.initialMargin,
                        accountInformationV2Response1ResultPositionsInner.initialMargin)
                && Objects.equals(
                        this.maintMargin,
                        accountInformationV2Response1ResultPositionsInner.maintMargin)
                && Objects.equals(
                        this.updateTime,
                        accountInformationV2Response1ResultPositionsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationV2Response1ResultPositionsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationV2Response1ResultPositionsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationV2Response1ResultPositionsInner is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationV2Response1ResultPositionsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationV2Response1ResultPositionsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationV2Response1ResultPositionsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationV2Response1ResultPositionsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(AccountInformationV2Response1ResultPositionsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationV2Response1ResultPositionsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                AccountInformationV2Response1ResultPositionsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationV2Response1ResultPositionsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationV2Response1ResultPositionsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationV2Response1ResultPositionsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationV2Response1ResultPositionsInner
     */
    public static AccountInformationV2Response1ResultPositionsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountInformationV2Response1ResultPositionsInner.class);
    }

    /**
     * Convert an instance of AccountInformationV2Response1ResultPositionsInner to an JSON string
     *
     * @return JSON string
     */
