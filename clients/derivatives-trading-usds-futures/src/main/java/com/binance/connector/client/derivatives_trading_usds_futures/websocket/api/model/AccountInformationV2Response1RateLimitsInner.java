...
public class AccountInformationV2Response1RateLimitsInner extends BaseDTO {
    ...
    public AccountInformationV2Response1RateLimitsInner() {}

    public AccountInformationV2Response1RateLimitsInner rateLimitType(
    ...
    public AccountInformationV2Response1RateLimitsInner interval(
    ...
    public AccountInformationV2Response1RateLimitsInner intervalNum(
    ...
    public AccountInformationV2Response1RateLimitsInner limit(
    ...
    public AccountInformationV2Response1RateLimitsInner count(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationV2Response1RateLimitsInner accountInformationV2Response1RateLimitsInner =
                (AccountInformationV2Response1RateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType,
                        accountInformationV2Response1RateLimitsInner.rateLimitType)
                && Objects.equals(
                        this.interval, accountInformationV2Response1RateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, accountInformationV2Response1RateLimitsInner.intervalNum)
                && Objects.equals(this.limit, accountInformationV2Response1RateLimitsInner.limit)
                && Objects.equals(this.count, accountInformationV2Response1RateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationV2Response1RateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationV2Response1RateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationV2Response1RateLimitsInner is not found"
                                    + " in the empty JSON string",
                                AccountInformationV2Response1RateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationV2Response1RateLimitsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `AccountInformationV2Response1RateLimitsInner` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationV2Response1RateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationV2Response1RateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationV2Response1RateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(AccountInformationV2Response1RateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationV2Response1RateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountInformationV2Response1RateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationV2Response1RateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationV2Response1RateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationV2Response1RateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationV2Response1RateLimitsInner
     */
    public static AccountInformationV2Response1RateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountInformationV2Response1RateLimitsInner.class);
    }

    /**
     * Convert an instance of AccountInformationV2Response1RateLimitsInner to an JSON string
     *
     * @return JSON string
     */
