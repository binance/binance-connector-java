...
public class KlineCandlestickStreamsRequest extends BaseDTO {
    ...
    public KlineCandlestickStreamsRequest symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public KlineCandlestickStreamsRequest interval(@jakarta.annotation.Nullable Interval interval) {
