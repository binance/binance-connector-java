...
public class GetFuturesTradeDownloadLinkByIdResponse1 {
    ...
    public GetFuturesTradeDownloadLinkByIdResponse1() {}

    public GetFuturesTradeDownloadLinkByIdResponse1 downloadId(
    ...
    public GetFuturesTradeDownloadLinkByIdResponse1 status(
    ...
    public GetFuturesTradeDownloadLinkByIdResponse1 url(@jakarta.annotation.Nullable String url) {
        this.url = url;
        return this;
    }
    ...
    public GetFuturesTradeDownloadLinkByIdResponse1 notified(
    ...
    public GetFuturesTradeDownloadLinkByIdResponse1 expirationTimestamp(
    ...
    public GetFuturesTradeDownloadLinkByIdResponse1 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetFuturesTradeDownloadLinkByIdResponse1 getFuturesTradeDownloadLinkByIdResponse1 =
                (GetFuturesTradeDownloadLinkByIdResponse1) o;
        return Objects.equals(this.downloadId, getFuturesTradeDownloadLinkByIdResponse1.downloadId)
                && Objects.equals(this.status, getFuturesTradeDownloadLinkByIdResponse1.status)
                && Objects.equals(this.url, getFuturesTradeDownloadLinkByIdResponse1.url)
                && Objects.equals(this.notified, getFuturesTradeDownloadLinkByIdResponse1.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getFuturesTradeDownloadLinkByIdResponse1.expirationTimestamp)
                && Objects.equals(
                        this.isExpired, getFuturesTradeDownloadLinkByIdResponse1.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetFuturesTradeDownloadLinkByIdResponse1 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetFuturesTradeDownloadLinkByIdResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetFuturesTradeDownloadLinkByIdResponse1 is not found in"
                                    + " the empty JSON string",
                                GetFuturesTradeDownloadLinkByIdResponse1.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetFuturesTradeDownloadLinkByIdResponse1.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `GetFuturesTradeDownloadLinkByIdResponse1` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFuturesTradeDownloadLinkByIdResponse1.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetFuturesTradeDownloadLinkByIdResponse1' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetFuturesTradeDownloadLinkByIdResponse1> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetFuturesTradeDownloadLinkByIdResponse1.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetFuturesTradeDownloadLinkByIdResponse1>() {
                        @Override
                        public void write(
                                JsonWriter out, GetFuturesTradeDownloadLinkByIdResponse1 value)
                                throws IOException {
                        ...
                        @Override
                        public GetFuturesTradeDownloadLinkByIdResponse1 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetFuturesTradeDownloadLinkByIdResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetFuturesTradeDownloadLinkByIdResponse1
     * @throws IOException if the JSON string is invalid with respect to
     *     GetFuturesTradeDownloadLinkByIdResponse1
     */
    public static GetFuturesTradeDownloadLinkByIdResponse1 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, GetFuturesTradeDownloadLinkByIdResponse1.class);
    }

    /**
     * Convert an instance of GetFuturesTradeDownloadLinkByIdResponse1 to an JSON string
     *
     * @return JSON string
     */
