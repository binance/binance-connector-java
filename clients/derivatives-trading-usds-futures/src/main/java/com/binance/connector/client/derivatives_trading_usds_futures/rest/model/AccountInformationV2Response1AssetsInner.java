...
public class AccountInformationV2Response1AssetsInner {
    ...
    public AccountInformationV2Response1AssetsInner() {}

    public AccountInformationV2Response1AssetsInner asset(
    ...
    public AccountInformationV2Response1AssetsInner walletBalance(
    ...
    public AccountInformationV2Response1AssetsInner unrealizedProfit(
    ...
    public AccountInformationV2Response1AssetsInner marginBalance(
    ...
    public AccountInformationV2Response1AssetsInner maintMargin(
    ...
    public AccountInformationV2Response1AssetsInner initialMargin(
    ...
    public AccountInformationV2Response1AssetsInner positionInitialMargin(
    ...
    public AccountInformationV2Response1AssetsInner openOrderInitialMargin(
    ...
    public AccountInformationV2Response1AssetsInner crossWalletBalance(
    ...
    public AccountInformationV2Response1AssetsInner crossUnPnl(
    ...
    public AccountInformationV2Response1AssetsInner availableBalance(
    ...
    public AccountInformationV2Response1AssetsInner maxWithdrawAmount(
    ...
    public AccountInformationV2Response1AssetsInner marginAvailable(
    ...
    public AccountInformationV2Response1AssetsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationV2Response1AssetsInner accountInformationV2Response1AssetsInner =
                (AccountInformationV2Response1AssetsInner) o;
        return Objects.equals(this.asset, accountInformationV2Response1AssetsInner.asset)
                && Objects.equals(
                        this.walletBalance, accountInformationV2Response1AssetsInner.walletBalance)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationV2Response1AssetsInner.unrealizedProfit)
                && Objects.equals(
                        this.marginBalance, accountInformationV2Response1AssetsInner.marginBalance)
                && Objects.equals(
                        this.maintMargin, accountInformationV2Response1AssetsInner.maintMargin)
                && Objects.equals(
                        this.initialMargin, accountInformationV2Response1AssetsInner.initialMargin)
                && Objects.equals(
                        this.positionInitialMargin,
                        accountInformationV2Response1AssetsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        accountInformationV2Response1AssetsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.crossWalletBalance,
                        accountInformationV2Response1AssetsInner.crossWalletBalance)
                && Objects.equals(
                        this.crossUnPnl, accountInformationV2Response1AssetsInner.crossUnPnl)
                && Objects.equals(
                        this.availableBalance,
                        accountInformationV2Response1AssetsInner.availableBalance)
                && Objects.equals(
                        this.maxWithdrawAmount,
                        accountInformationV2Response1AssetsInner.maxWithdrawAmount)
                && Objects.equals(
                        this.marginAvailable,
                        accountInformationV2Response1AssetsInner.marginAvailable)
                && Objects.equals(
                        this.updateTime, accountInformationV2Response1AssetsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationV2Response1AssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationV2Response1AssetsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationV2Response1AssetsInner is not found in"
                                    + " the empty JSON string",
                                AccountInformationV2Response1AssetsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationV2Response1AssetsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AccountInformationV2Response1AssetsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationV2Response1AssetsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationV2Response1AssetsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationV2Response1AssetsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountInformationV2Response1AssetsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationV2Response1AssetsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountInformationV2Response1AssetsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationV2Response1AssetsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationV2Response1AssetsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationV2Response1AssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationV2Response1AssetsInner
     */
    public static AccountInformationV2Response1AssetsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, AccountInformationV2Response1AssetsInner.class);
    }

    /**
     * Convert an instance of AccountInformationV2Response1AssetsInner to an JSON string
     *
     * @return JSON string
     */
