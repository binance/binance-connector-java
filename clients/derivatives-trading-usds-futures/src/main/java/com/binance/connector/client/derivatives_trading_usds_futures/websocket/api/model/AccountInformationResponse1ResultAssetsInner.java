...
public class AccountInformationResponse1ResultAssetsInner extends BaseDTO {
    ...
    public AccountInformationResponse1ResultAssetsInner() {}

    public AccountInformationResponse1ResultAssetsInner asset(
    ...
    public AccountInformationResponse1ResultAssetsInner walletBalance(
    ...
    public AccountInformationResponse1ResultAssetsInner unrealizedProfit(
    ...
    public AccountInformationResponse1ResultAssetsInner marginBalance(
    ...
    public AccountInformationResponse1ResultAssetsInner maintMargin(
    ...
    public AccountInformationResponse1ResultAssetsInner initialMargin(
    ...
    public AccountInformationResponse1ResultAssetsInner positionInitialMargin(
    ...
    public AccountInformationResponse1ResultAssetsInner openOrderInitialMargin(
    ...
    public AccountInformationResponse1ResultAssetsInner crossWalletBalance(
    ...
    public AccountInformationResponse1ResultAssetsInner crossUnPnl(
    ...
    public AccountInformationResponse1ResultAssetsInner availableBalance(
    ...
    public AccountInformationResponse1ResultAssetsInner maxWithdrawAmount(
    ...
    public AccountInformationResponse1ResultAssetsInner marginAvailable(
    ...
    public AccountInformationResponse1ResultAssetsInner updateTime(
    ...
    public boolean equals(Object o) {
        ...
        AccountInformationResponse1ResultAssetsInner accountInformationResponse1ResultAssetsInner =
                (AccountInformationResponse1ResultAssetsInner) o;
        return Objects.equals(this.asset, accountInformationResponse1ResultAssetsInner.asset)
                && Objects.equals(
                        this.walletBalance,
                        accountInformationResponse1ResultAssetsInner.walletBalance)
                && Objects.equals(
                        this.unrealizedProfit,
                        accountInformationResponse1ResultAssetsInner.unrealizedProfit)
                && Objects.equals(
                        this.marginBalance,
                        accountInformationResponse1ResultAssetsInner.marginBalance)
                && Objects.equals(
                        this.maintMargin, accountInformationResponse1ResultAssetsInner.maintMargin)
                && Objects.equals(
                        this.initialMargin,
                        accountInformationResponse1ResultAssetsInner.initialMargin)
                && Objects.equals(
                        this.positionInitialMargin,
                        accountInformationResponse1ResultAssetsInner.positionInitialMargin)
                && Objects.equals(
                        this.openOrderInitialMargin,
                        accountInformationResponse1ResultAssetsInner.openOrderInitialMargin)
                && Objects.equals(
                        this.crossWalletBalance,
                        accountInformationResponse1ResultAssetsInner.crossWalletBalance)
                && Objects.equals(
                        this.crossUnPnl, accountInformationResponse1ResultAssetsInner.crossUnPnl)
                && Objects.equals(
                        this.availableBalance,
                        accountInformationResponse1ResultAssetsInner.availableBalance)
                && Objects.equals(
                        this.maxWithdrawAmount,
                        accountInformationResponse1ResultAssetsInner.maxWithdrawAmount)
                && Objects.equals(
                        this.marginAvailable,
                        accountInformationResponse1ResultAssetsInner.marginAvailable)
                && Objects.equals(
                        this.updateTime, accountInformationResponse1ResultAssetsInner.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountInformationResponse1ResultAssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountInformationResponse1ResultAssetsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountInformationResponse1ResultAssetsInner is not found"
                                    + " in the empty JSON string",
                                AccountInformationResponse1ResultAssetsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountInformationResponse1ResultAssetsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `AccountInformationResponse1ResultAssetsInner` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInformationResponse1ResultAssetsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountInformationResponse1ResultAssetsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountInformationResponse1ResultAssetsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(AccountInformationResponse1ResultAssetsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountInformationResponse1ResultAssetsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountInformationResponse1ResultAssetsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountInformationResponse1ResultAssetsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountInformationResponse1ResultAssetsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInformationResponse1ResultAssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountInformationResponse1ResultAssetsInner
     */
    public static AccountInformationResponse1ResultAssetsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountInformationResponse1ResultAssetsInner.class);
    }

    /**
     * Convert an instance of AccountInformationResponse1ResultAssetsInner to an JSON string
     *
     * @return JSON string
     */
