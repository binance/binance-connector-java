...
public class AssetIndexResponse2Inner {
    ...
    public AssetIndexResponse2Inner() {}

    public AssetIndexResponse2Inner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public AssetIndexResponse2Inner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public AssetIndexResponse2Inner index(@jakarta.annotation.Nullable String index) {
        this.index = index;
        return this;
    }
    ...
    public AssetIndexResponse2Inner bidBuffer(@jakarta.annotation.Nullable String bidBuffer) {
    ...
    public AssetIndexResponse2Inner askBuffer(@jakarta.annotation.Nullable String askBuffer) {
    ...
    public AssetIndexResponse2Inner bidRate(@jakarta.annotation.Nullable String bidRate) {
    ...
    public AssetIndexResponse2Inner askRate(@jakarta.annotation.Nullable String askRate) {
    ...
    public AssetIndexResponse2Inner autoExchangeBidBuffer(
    ...
    public AssetIndexResponse2Inner autoExchangeAskBuffer(
    ...
    public AssetIndexResponse2Inner autoExchangeBidRate(
    ...
    public AssetIndexResponse2Inner autoExchangeAskRate(
    ...
    public boolean equals(Object o) {
        ...
        AssetIndexResponse2Inner assetIndexResponse2Inner = (AssetIndexResponse2Inner) o;
        return Objects.equals(this.symbol, assetIndexResponse2Inner.symbol)
                && Objects.equals(this.time, assetIndexResponse2Inner.time)
                && Objects.equals(this.index, assetIndexResponse2Inner.index)
                && Objects.equals(this.bidBuffer, assetIndexResponse2Inner.bidBuffer)
                && Objects.equals(this.askBuffer, assetIndexResponse2Inner.askBuffer)
                && Objects.equals(this.bidRate, assetIndexResponse2Inner.bidRate)
                && Objects.equals(this.askRate, assetIndexResponse2Inner.askRate)
                && Objects.equals(
                        this.autoExchangeBidBuffer, assetIndexResponse2Inner.autoExchangeBidBuffer)
                && Objects.equals(
                        this.autoExchangeAskBuffer, assetIndexResponse2Inner.autoExchangeAskBuffer)
                && Objects.equals(
                        this.autoExchangeBidRate, assetIndexResponse2Inner.autoExchangeBidRate)
                && Objects.equals(
                        this.autoExchangeAskRate, assetIndexResponse2Inner.autoExchangeAskRate);
    }
    ...
    public String toString() {
        ...
        sb.append("class AssetIndexResponse2Inner {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to AssetIndexResponse2Inner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AssetIndexResponse2Inner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AssetIndexResponse2Inner is not found"
                                        + " in the empty JSON string",
                                AssetIndexResponse2Inner.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AssetIndexResponse2Inner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AssetIndexResponse2Inner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AssetIndexResponse2Inner> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(AssetIndexResponse2Inner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AssetIndexResponse2Inner>() {
                        @Override
                        public void write(JsonWriter out, AssetIndexResponse2Inner value)
                                throws IOException {
                        ...
                        @Override
                        public AssetIndexResponse2Inner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of AssetIndexResponse2Inner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AssetIndexResponse2Inner
     * @throws IOException if the JSON string is invalid with respect to AssetIndexResponse2Inner
     */
    public static AssetIndexResponse2Inner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AssetIndexResponse2Inner.class);
    }

    /**
     * Convert an instance of AssetIndexResponse2Inner to an JSON string
     *
     * @return JSON string
     */
