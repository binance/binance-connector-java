...
public class ModifyOrderResponseRateLimitsInner extends BaseDTO {
    ...
    public ModifyOrderResponseRateLimitsInner() {}

    public ModifyOrderResponseRateLimitsInner rateLimitType(
    ...
    public ModifyOrderResponseRateLimitsInner interval(
    ...
    public ModifyOrderResponseRateLimitsInner intervalNum(
    ...
    public ModifyOrderResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ModifyOrderResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        ModifyOrderResponseRateLimitsInner modifyOrderResponseRateLimitsInner =
                (ModifyOrderResponseRateLimitsInner) o;
        return Objects.equals(this.rateLimitType, modifyOrderResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, modifyOrderResponseRateLimitsInner.interval)
                && Objects.equals(this.intervalNum, modifyOrderResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, modifyOrderResponseRateLimitsInner.limit)
                && Objects.equals(this.count, modifyOrderResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class ModifyOrderResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ModifyOrderResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ModifyOrderResponseRateLimitsInner is"
                                        + " not found in the empty JSON string",
                                ModifyOrderResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!ModifyOrderResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `ModifyOrderResponseRateLimitsInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ModifyOrderResponseRateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ModifyOrderResponseRateLimitsInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ModifyOrderResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ModifyOrderResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ModifyOrderResponseRateLimitsInner>() {
                        @Override
                        ...
                        @Override
                        public ModifyOrderResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of ModifyOrderResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ModifyOrderResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     ModifyOrderResponseRateLimitsInner
     */
    public static ModifyOrderResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, ModifyOrderResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of ModifyOrderResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
