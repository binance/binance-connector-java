# Binance Java DerivativesTradingUsdsFutures Connector
...
![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-derivatives-trading-usds-futures)
...
More examples can be found in the [`examples/rest-api`](./examples/derivatives-trading-usds-futures/src/main/java/com/binance/connector/client/derivatives-trading-usds-futures/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl derivatives-trading-usds-futures
```
