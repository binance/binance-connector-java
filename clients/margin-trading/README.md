# Binance Java Margin Trading Connector
...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-margin-trading)](https://central.sonatype.com/artifact/io.github.binance/binance-margin-trading)
...
- [REST API](./src/main/java/com/binance/connector/client/margin_trading/rest/api)
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/margin_trading/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/margin-trading/src/main/java/com/binance/connector/client/margin_trading/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl margin-trading test
```
