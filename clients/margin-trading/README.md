# Binance Java MarginTrading Connector
...
More examples can be found in the [`examples/rest-api`](./examples/margin-trading/src/main/java/com/binance/connector/client/margin-trading/rest) folder.
