...
public class MarginAccountNewOtocoResponseOrderReportsInner {
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner() {}

    public MarginAccountNewOtocoResponseOrderReportsInner symbol(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner orderId(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner orderListId(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner clientOrderId(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner transactTime(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner price(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner origQty(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner executedQty(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner cummulativeQuoteQty(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner status(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner timeInForce(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner type(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner side(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner selfTradePreventionMode(
    ...
    public MarginAccountNewOtocoResponseOrderReportsInner stopPrice(
    ...
    public boolean equals(Object o) {
        ...
        MarginAccountNewOtocoResponseOrderReportsInner
                marginAccountNewOtocoResponseOrderReportsInner =
                        (MarginAccountNewOtocoResponseOrderReportsInner) o;
        return Objects.equals(this.symbol, marginAccountNewOtocoResponseOrderReportsInner.symbol)
                && Objects.equals(
                        this.orderId, marginAccountNewOtocoResponseOrderReportsInner.orderId)
                && Objects.equals(
                        this.orderListId,
                        marginAccountNewOtocoResponseOrderReportsInner.orderListId)
                && Objects.equals(
                        this.clientOrderId,
                        marginAccountNewOtocoResponseOrderReportsInner.clientOrderId)
                && Objects.equals(
                        this.transactTime,
                        marginAccountNewOtocoResponseOrderReportsInner.transactTime)
                && Objects.equals(this.price, marginAccountNewOtocoResponseOrderReportsInner.price)
                && Objects.equals(
                        this.origQty, marginAccountNewOtocoResponseOrderReportsInner.origQty)
                && Objects.equals(
                        this.executedQty,
                        marginAccountNewOtocoResponseOrderReportsInner.executedQty)
                && Objects.equals(
                        this.cummulativeQuoteQty,
                        marginAccountNewOtocoResponseOrderReportsInner.cummulativeQuoteQty)
                && Objects.equals(
                        this.status, marginAccountNewOtocoResponseOrderReportsInner.status)
                && Objects.equals(
                        this.timeInForce,
                        marginAccountNewOtocoResponseOrderReportsInner.timeInForce)
                && Objects.equals(this.type, marginAccountNewOtocoResponseOrderReportsInner.type)
                && Objects.equals(this.side, marginAccountNewOtocoResponseOrderReportsInner.side)
                && Objects.equals(
                        this.selfTradePreventionMode,
                        marginAccountNewOtocoResponseOrderReportsInner.selfTradePreventionMode)
                && Objects.equals(
                        this.stopPrice, marginAccountNewOtocoResponseOrderReportsInner.stopPrice);
    }
    ...
    public String toString() {
        ...
        sb.append("class MarginAccountNewOtocoResponseOrderReportsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MarginAccountNewOtocoResponseOrderReportsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " MarginAccountNewOtocoResponseOrderReportsInner is not found"
                                    + " in the empty JSON string",
                                MarginAccountNewOtocoResponseOrderReportsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!MarginAccountNewOtocoResponseOrderReportsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MarginAccountNewOtocoResponseOrderReportsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'MarginAccountNewOtocoResponseOrderReportsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<MarginAccountNewOtocoResponseOrderReportsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(MarginAccountNewOtocoResponseOrderReportsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<MarginAccountNewOtocoResponseOrderReportsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                MarginAccountNewOtocoResponseOrderReportsInner value)
                                throws IOException {
                        ...
                        @Override
                        public MarginAccountNewOtocoResponseOrderReportsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of MarginAccountNewOtocoResponseOrderReportsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MarginAccountNewOtocoResponseOrderReportsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     MarginAccountNewOtocoResponseOrderReportsInner
     */
    public static MarginAccountNewOtocoResponseOrderReportsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, MarginAccountNewOtocoResponseOrderReportsInner.class);
    }

    /**
     * Convert an instance of MarginAccountNewOtocoResponseOrderReportsInner to an JSON string
     *
     * @return JSON string
     */
