...
public class QuerySpecialKeyResponse {
    ...
    public QuerySpecialKeyResponse() {}

    public QuerySpecialKeyResponse apiKey(@jakarta.annotation.Nullable String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public QuerySpecialKeyResponse ip(@jakarta.annotation.Nullable String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public QuerySpecialKeyResponse apiName(@jakarta.annotation.Nullable String apiName) {
    ...
    public QuerySpecialKeyResponse type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public QuerySpecialKeyResponse permissionMode(
    ...
    public boolean equals(Object o) {
        ...
        QuerySpecialKeyResponse querySpecialKeyResponse = (QuerySpecialKeyResponse) o;
        return Objects.equals(this.apiKey, querySpecialKeyResponse.apiKey)
                && Objects.equals(this.ip, querySpecialKeyResponse.ip)
                && Objects.equals(this.apiName, querySpecialKeyResponse.apiName)
                && Objects.equals(this.type, querySpecialKeyResponse.type)
                && Objects.equals(this.permissionMode, querySpecialKeyResponse.permissionMode);
    }

    @Override
    public int hashCode() {
        return Objects.hash(apiKey, ip, apiName, type, permissionMode);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class QuerySpecialKeyResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to QuerySpecialKeyResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QuerySpecialKeyResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in QuerySpecialKeyResponse is not found"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QuerySpecialKeyResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'QuerySpecialKeyResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QuerySpecialKeyResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(QuerySpecialKeyResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QuerySpecialKeyResponse>() {
                        @Override
                        ...
                        @Override
                        public QuerySpecialKeyResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of QuerySpecialKeyResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QuerySpecialKeyResponse
     * @throws IOException if the JSON string is invalid with respect to QuerySpecialKeyResponse
     */
    public static QuerySpecialKeyResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, QuerySpecialKeyResponse.class);
    }

    /**
     * Convert an instance of QuerySpecialKeyResponse to an JSON string
     *
     * @return JSON string
     */
