...
public class JSON {
                ...
                new GsonFireBuilder()
                        .registerTypeSelector(
                                com.binance.connector.client.margin_trading.websocket.stream.model
                                        .RiskDataStreamEventsResponse.class,
                                new TypeSelector<
                                        com.binance.connector.client.margin_trading.websocket.stream
                                                .model.RiskDataStreamEventsResponse>() {
                                    @Override
                                    public Class<
                                                    ? extends
                                                            com.binance.connector.client
                                                                    .margin_trading.websocket.stream
                                                                    .model
                        ...
                        .registerTypeSelector(
                                com.binance.connector.client.margin_trading.websocket.stream.model
                                        .TradeDataStreamEventsResponse.class,
                                new TypeSelector<
                                        com.binance.connector.client.margin_trading.websocket.stream
                                                .model.TradeDataStreamEventsResponse>() {
                                    @Override
                                    public Class<
                                                    ? extends
                                                            com.binance.connector.client
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(
                new com.binance.connector.client.margin_trading.websocket.stream.model
                        .TradeDataStreamEventsResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(
                new com.binance.connector.client.margin_trading.websocket.stream.model
                        .UserLiabilityChange.CustomTypeAdapterFactory());
