...
public class GetForceLiquidationRecordResponseRowsInner {
    ...
    public GetForceLiquidationRecordResponseRowsInner() {}

    public GetForceLiquidationRecordResponseRowsInner avgPrice(
    ...
    public GetForceLiquidationRecordResponseRowsInner executedQty(
    ...
    public GetForceLiquidationRecordResponseRowsInner orderId(
    ...
    public GetForceLiquidationRecordResponseRowsInner price(
    ...
    public GetForceLiquidationRecordResponseRowsInner qty(@jakarta.annotation.Nullable String qty) {
        this.qty = qty;
        return this;
    }
    ...
    public GetForceLiquidationRecordResponseRowsInner side(
    ...
    public GetForceLiquidationRecordResponseRowsInner symbol(
    ...
    public GetForceLiquidationRecordResponseRowsInner timeInForce(
    ...
    public GetForceLiquidationRecordResponseRowsInner isIsolated(
    ...
    public GetForceLiquidationRecordResponseRowsInner updatedTime(
    ...
    public boolean equals(Object o) {
        ...
        GetForceLiquidationRecordResponseRowsInner getForceLiquidationRecordResponseRowsInner =
                (GetForceLiquidationRecordResponseRowsInner) o;
        return Objects.equals(this.avgPrice, getForceLiquidationRecordResponseRowsInner.avgPrice)
                && Objects.equals(
                        this.executedQty, getForceLiquidationRecordResponseRowsInner.executedQty)
                && Objects.equals(this.orderId, getForceLiquidationRecordResponseRowsInner.orderId)
                && Objects.equals(this.price, getForceLiquidationRecordResponseRowsInner.price)
                && Objects.equals(this.qty, getForceLiquidationRecordResponseRowsInner.qty)
                && Objects.equals(this.side, getForceLiquidationRecordResponseRowsInner.side)
                && Objects.equals(this.symbol, getForceLiquidationRecordResponseRowsInner.symbol)
                && Objects.equals(
                        this.timeInForce, getForceLiquidationRecordResponseRowsInner.timeInForce)
                && Objects.equals(
                        this.isIsolated, getForceLiquidationRecordResponseRowsInner.isIsolated)
                && Objects.equals(
                        this.updatedTime, getForceLiquidationRecordResponseRowsInner.updatedTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetForceLiquidationRecordResponseRowsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetForceLiquidationRecordResponseRowsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetForceLiquidationRecordResponseRowsInner is not found in"
                                    + " the empty JSON string",
                                GetForceLiquidationRecordResponseRowsInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetForceLiquidationRecordResponseRowsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetForceLiquidationRecordResponseRowsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetForceLiquidationRecordResponseRowsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetForceLiquidationRecordResponseRowsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetForceLiquidationRecordResponseRowsInner>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public GetForceLiquidationRecordResponseRowsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetForceLiquidationRecordResponseRowsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetForceLiquidationRecordResponseRowsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     GetForceLiquidationRecordResponseRowsInner
     */
    public static GetForceLiquidationRecordResponseRowsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetForceLiquidationRecordResponseRowsInner.class);
    }

    /**
     * Convert an instance of GetForceLiquidationRecordResponseRowsInner to an JSON string
     *
     * @return JSON string
     */
