...
public class QueryCurrentMarginOrderCountUsageResponseInner {
    ...
    public QueryCurrentMarginOrderCountUsageResponseInner() {}

    public QueryCurrentMarginOrderCountUsageResponseInner rateLimitType(
    ...
    public QueryCurrentMarginOrderCountUsageResponseInner interval(
    ...
    public QueryCurrentMarginOrderCountUsageResponseInner intervalNum(
    ...
    public QueryCurrentMarginOrderCountUsageResponseInner limit(
    ...
    public QueryCurrentMarginOrderCountUsageResponseInner count(
    ...
    public boolean equals(Object o) {
        ...
        QueryCurrentMarginOrderCountUsageResponseInner
                queryCurrentMarginOrderCountUsageResponseInner =
                        (QueryCurrentMarginOrderCountUsageResponseInner) o;
        return Objects.equals(
                        this.rateLimitType,
                        queryCurrentMarginOrderCountUsageResponseInner.rateLimitType)
                && Objects.equals(
                        this.interval, queryCurrentMarginOrderCountUsageResponseInner.interval)
                && Objects.equals(
                        this.intervalNum,
                        queryCurrentMarginOrderCountUsageResponseInner.intervalNum)
                && Objects.equals(this.limit, queryCurrentMarginOrderCountUsageResponseInner.limit)
                && Objects.equals(this.count, queryCurrentMarginOrderCountUsageResponseInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryCurrentMarginOrderCountUsageResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryCurrentMarginOrderCountUsageResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " QueryCurrentMarginOrderCountUsageResponseInner is not found"
                                    + " in the empty JSON string",
                                QueryCurrentMarginOrderCountUsageResponseInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryCurrentMarginOrderCountUsageResponseInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'QueryCurrentMarginOrderCountUsageResponseInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryCurrentMarginOrderCountUsageResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(QueryCurrentMarginOrderCountUsageResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryCurrentMarginOrderCountUsageResponseInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                        ...
                        @Override
                        public QueryCurrentMarginOrderCountUsageResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of QueryCurrentMarginOrderCountUsageResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryCurrentMarginOrderCountUsageResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryCurrentMarginOrderCountUsageResponseInner
     */
    public static QueryCurrentMarginOrderCountUsageResponseInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, QueryCurrentMarginOrderCountUsageResponseInner.class);
    }

    /**
     * Convert an instance of QueryCurrentMarginOrderCountUsageResponseInner to an JSON string
     *
     * @return JSON string
     */
