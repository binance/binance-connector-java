...
public class QueryPreventedMatchesResponseInner {
    ...
    public QueryPreventedMatchesResponseInner() {}

    public QueryPreventedMatchesResponseInner symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public QueryPreventedMatchesResponseInner preventedMatchId(
    ...
    public QueryPreventedMatchesResponseInner takerOrderId(
    ...
    public QueryPreventedMatchesResponseInner makerSymbol(
    ...
    public QueryPreventedMatchesResponseInner makerOrderId(
    ...
    public QueryPreventedMatchesResponseInner tradeGroupId(
    ...
    public QueryPreventedMatchesResponseInner selfTradePreventionMode(
    ...
    public QueryPreventedMatchesResponseInner price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public QueryPreventedMatchesResponseInner makerPreventedQuantity(
    ...
    public QueryPreventedMatchesResponseInner transactTime(
    ...
    public boolean equals(Object o) {
        ...
        QueryPreventedMatchesResponseInner queryPreventedMatchesResponseInner =
                (QueryPreventedMatchesResponseInner) o;
        return Objects.equals(this.symbol, queryPreventedMatchesResponseInner.symbol)
                && Objects.equals(
                        this.preventedMatchId, queryPreventedMatchesResponseInner.preventedMatchId)
                && Objects.equals(
                        this.takerOrderId, queryPreventedMatchesResponseInner.takerOrderId)
                && Objects.equals(this.makerSymbol, queryPreventedMatchesResponseInner.makerSymbol)
                && Objects.equals(
                        this.makerOrderId, queryPreventedMatchesResponseInner.makerOrderId)
                && Objects.equals(
                        this.tradeGroupId, queryPreventedMatchesResponseInner.tradeGroupId)
                && Objects.equals(
                        this.selfTradePreventionMode,
                        queryPreventedMatchesResponseInner.selfTradePreventionMode)
                && Objects.equals(this.price, queryPreventedMatchesResponseInner.price)
                && Objects.equals(
                        this.makerPreventedQuantity,
                        queryPreventedMatchesResponseInner.makerPreventedQuantity)
                && Objects.equals(
                        this.transactTime, queryPreventedMatchesResponseInner.transactTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryPreventedMatchesResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryPreventedMatchesResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in QueryPreventedMatchesResponseInner is"
                                        + " not found in the empty JSON string",
                                QueryPreventedMatchesResponseInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryPreventedMatchesResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'QueryPreventedMatchesResponseInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QueryPreventedMatchesResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(QueryPreventedMatchesResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QueryPreventedMatchesResponseInner>() {
                        @Override
