...
public class MarginAccountNewOrderResponse2 {
    ...
    public MarginAccountNewOrderResponse2() {}

    public MarginAccountNewOrderResponse2 symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public MarginAccountNewOrderResponse2 orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public MarginAccountNewOrderResponse2 clientOrderId(
    ...
    public MarginAccountNewOrderResponse2 transactTime(
    ...
    public MarginAccountNewOrderResponse2 price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public MarginAccountNewOrderResponse2 origQty(@jakarta.annotation.Nullable String origQty) {
    ...
    public MarginAccountNewOrderResponse2 executedQty(
    ...
    public MarginAccountNewOrderResponse2 cummulativeQuoteQty(
    ...
    public MarginAccountNewOrderResponse2 status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public MarginAccountNewOrderResponse2 timeInForce(
    ...
    public MarginAccountNewOrderResponse2 type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public MarginAccountNewOrderResponse2 side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public MarginAccountNewOrderResponse2 isIsolated(
    ...
    public MarginAccountNewOrderResponse2 selfTradePreventionMode(
    ...
    public boolean equals(Object o) {
        ...
        MarginAccountNewOrderResponse2 marginAccountNewOrderResponse2 =
                (MarginAccountNewOrderResponse2) o;
        return Objects.equals(this.symbol, marginAccountNewOrderResponse2.symbol)
                && Objects.equals(this.orderId, marginAccountNewOrderResponse2.orderId)
                && Objects.equals(this.clientOrderId, marginAccountNewOrderResponse2.clientOrderId)
                && Objects.equals(this.transactTime, marginAccountNewOrderResponse2.transactTime)
                && Objects.equals(this.price, marginAccountNewOrderResponse2.price)
                && Objects.equals(this.origQty, marginAccountNewOrderResponse2.origQty)
                && Objects.equals(this.executedQty, marginAccountNewOrderResponse2.executedQty)
                && Objects.equals(
                        this.cummulativeQuoteQty,
                        marginAccountNewOrderResponse2.cummulativeQuoteQty)
                && Objects.equals(this.status, marginAccountNewOrderResponse2.status)
                && Objects.equals(this.timeInForce, marginAccountNewOrderResponse2.timeInForce)
                && Objects.equals(this.type, marginAccountNewOrderResponse2.type)
                && Objects.equals(this.side, marginAccountNewOrderResponse2.side)
                && Objects.equals(this.isIsolated, marginAccountNewOrderResponse2.isIsolated)
                && Objects.equals(
                        this.selfTradePreventionMode,
                        marginAccountNewOrderResponse2.selfTradePreventionMode);
    }
    ...
    public String toString() {
        ...
        sb.append("class MarginAccountNewOrderResponse2 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MarginAccountNewOrderResponse2.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in MarginAccountNewOrderResponse2 is not"
                                        + " found in the empty JSON string",
                                MarginAccountNewOrderResponse2.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!MarginAccountNewOrderResponse2.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `MarginAccountNewOrderResponse2` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MarginAccountNewOrderResponse2.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MarginAccountNewOrderResponse2' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<MarginAccountNewOrderResponse2> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(MarginAccountNewOrderResponse2.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<MarginAccountNewOrderResponse2>() {
                        @Override
                        public void write(JsonWriter out, MarginAccountNewOrderResponse2 value)
                                throws IOException {
                        ...
                        @Override
                        public MarginAccountNewOrderResponse2 read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of MarginAccountNewOrderResponse2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MarginAccountNewOrderResponse2
     * @throws IOException if the JSON string is invalid with respect to
     *     MarginAccountNewOrderResponse2
     */
    public static MarginAccountNewOrderResponse2 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, MarginAccountNewOrderResponse2.class);
    }

    /**
     * Convert an instance of MarginAccountNewOrderResponse2 to an JSON string
     *
     * @return JSON string
     */
