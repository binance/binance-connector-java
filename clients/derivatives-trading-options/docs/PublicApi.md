...
| [**hour24Ticker**](PublicApi.md#hour24Ticker) | **POST** /&lt;symbol&gt;@optionTicker&lt;expirationDate&gt; | 24-hour TICKER |
...
<a id="hour24Ticker"></a>
# **hour24Ticker**
> Hour24TickerResponse hour24Ticker(hour24TickerRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    PublicApi apiInstance = new PublicApi(defaultClient);
    Hour24TickerRequest hour24TickerRequest = new Hour24TickerRequest(); // Hour24TickerRequest | 
    try {
      Hour24TickerResponse result = apiInstance.hour24Ticker(hour24TickerRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PublicApi#hour24Ticker");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **hour24TickerRequest** | [**Hour24TickerRequest**](Hour24TickerRequest.md)|  | |

### Return type

[**Hour24TickerResponse**](Hour24TickerResponse.md)
...
Top &lt;levels&gt; bids and asks. Valid &lt;levels&gt; are 5, 10, 20.  Update Speed: 100ms or 500ms
