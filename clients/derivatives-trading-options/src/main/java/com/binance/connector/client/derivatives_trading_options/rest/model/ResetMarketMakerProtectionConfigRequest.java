...
public class ResetMarketMakerProtectionConfigRequest {
    ...
    public ResetMarketMakerProtectionConfigRequest recvWindow(
    ...
    public boolean equals(Object o) {
        ...
        ResetMarketMakerProtectionConfigRequest resetMarketMakerProtectionConfigRequest =
                (ResetMarketMakerProtectionConfigRequest) o;
        return Objects.equals(this.underlying, resetMarketMakerProtectionConfigRequest.underlying)
                && Objects.equals(
                        this.recvWindow, resetMarketMakerProtectionConfigRequest.recvWindow);
    }

    @Override
    public int hashCode() {
        return Objects.hash(underlying, recvWindow);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ResetMarketMakerProtectionConfigRequest {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ResetMarketMakerProtectionConfigRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " ResetMarketMakerProtectionConfigRequest is not found in the"
                                    + " empty JSON string",
                                ResetMarketMakerProtectionConfigRequest.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ResetMarketMakerProtectionConfigRequest.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes 'ResetMarketMakerProtectionConfigRequest'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ResetMarketMakerProtectionConfigRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ResetMarketMakerProtectionConfigRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ResetMarketMakerProtectionConfigRequest>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public ResetMarketMakerProtectionConfigRequest read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of ResetMarketMakerProtectionConfigRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ResetMarketMakerProtectionConfigRequest
     * @throws IOException if the JSON string is invalid with respect to
     *     ResetMarketMakerProtectionConfigRequest
     */
    public static ResetMarketMakerProtectionConfigRequest fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, ResetMarketMakerProtectionConfigRequest.class);
    }

    /**
     * Convert an instance of ResetMarketMakerProtectionConfigRequest to an JSON string
     *
     * @return JSON string
     */
