...
public class PartialBookDepthStreamsRequest extends BaseDTO {
    ...
    public PartialBookDepthStreamsRequest id(@jakarta.annotation.Nullable Integer id) {
        this.id = id;
        return this;
    }
    ...
    public PartialBookDepthStreamsRequest level(@jakarta.annotation.Nonnull String level) {
        this.level = level;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PartialBookDepthStreamsRequest partialBookDepthStreamsRequest =
                (PartialBookDepthStreamsRequest) o;
        return Objects.equals(this.id, partialBookDepthStreamsRequest.id)
                && Objects.equals(this.symbol, partialBookDepthStreamsRequest.symbol)
                && Objects.equals(this.level, partialBookDepthStreamsRequest.level)
                && Objects.equals(this.updateSpeed, partialBookDepthStreamsRequest.updateSpeed);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, symbol, level, updateSpeed);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class PartialBookDepthStreamsRequest {\n");
    ...
    public String toUrlQueryString() {
        ...
        String levelValue = getLevel();
        if (levelValue != null) {
            String levelValueAsString = levelValue.toString();
            valMap.put("level", levelValueAsString);
        }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PartialBookDepthStreamsRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PartialBookDepthStreamsRequest is not"
                                        + " found in the empty JSON string",
                                PartialBookDepthStreamsRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PartialBookDepthStreamsRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `PartialBookDepthStreamsRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PartialBookDepthStreamsRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PartialBookDepthStreamsRequest' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PartialBookDepthStreamsRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(PartialBookDepthStreamsRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<PartialBookDepthStreamsRequest>() {
                        @Override
                        ...
                        @Override
                        public PartialBookDepthStreamsRequest read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of PartialBookDepthStreamsRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PartialBookDepthStreamsRequest
     * @throws IOException if the JSON string is invalid with respect to
     *     PartialBookDepthStreamsRequest
     */
    public static PartialBookDepthStreamsRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PartialBookDepthStreamsRequest.class);
    }

    /**
     * Convert an instance of PartialBookDepthStreamsRequest to an JSON string
     *
     * @return JSON string
     */
