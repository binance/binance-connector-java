...
public class OldTradesLookupResponseInner {
    ...
    public OldTradesLookupResponseInner id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public OldTradesLookupResponseInner tradeId(@jakarta.annotation.Nullable String tradeId) {
    ...
    public OldTradesLookupResponseInner price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public OldTradesLookupResponseInner qty(@jakarta.annotation.Nullable String qty) {
        this.qty = qty;
        return this;
    }
    ...
    public OldTradesLookupResponseInner quoteQty(@jakarta.annotation.Nullable String quoteQty) {
    ...
    public OldTradesLookupResponseInner side(@jakarta.annotation.Nullable Long side) {
        this.side = side;
        return this;
    }
    ...
    public OldTradesLookupResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        OldTradesLookupResponseInner oldTradesLookupResponseInner =
                (OldTradesLookupResponseInner) o;
        return Objects.equals(this.id, oldTradesLookupResponseInner.id)
                && Objects.equals(this.tradeId, oldTradesLookupResponseInner.tradeId)
                && Objects.equals(this.price, oldTradesLookupResponseInner.price)
                ...
                && Objects.equals(this.side, oldTradesLookupResponseInner.side)
                && Objects.equals(this.time, oldTradesLookupResponseInner.time);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, tradeId, price, qty, quoteQty, side, time);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class OldTradesLookupResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OldTradesLookupResponseInner.openapiRequiredFields
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OldTradesLookupResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OldTradesLookupResponseInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OldTradesLookupResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OldTradesLookupResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OldTradesLookupResponseInner>() {
                        @Override
                        ...
                        @Override
                        public OldTradesLookupResponseInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OldTradesLookupResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OldTradesLookupResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OldTradesLookupResponseInner
     */
    public static OldTradesLookupResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OldTradesLookupResponseInner.class);
    }

    /**
     * Convert an instance of OldTradesLookupResponseInner to an JSON string
     *
     * @return JSON string
     */
