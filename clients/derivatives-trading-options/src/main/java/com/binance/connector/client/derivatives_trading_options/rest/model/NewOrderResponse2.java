...
public class NewOrderResponse2 {
    ...
    public NewOrderResponse2() {}

    public NewOrderResponse2 orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public NewOrderResponse2 symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public NewOrderResponse2 price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public NewOrderResponse2 quantity(@jakarta.annotation.Nullable String quantity) {
    ...
    public NewOrderResponse2 executedQty(@jakarta.annotation.Nullable String executedQty) {
    ...
    public NewOrderResponse2 fee(@jakarta.annotation.Nullable String fee) {
        this.fee = fee;
        return this;
    }
    ...
    public NewOrderResponse2 side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public NewOrderResponse2 type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public NewOrderResponse2 timeInForce(@jakarta.annotation.Nullable String timeInForce) {
    ...
    public NewOrderResponse2 reduceOnly(@jakarta.annotation.Nullable Boolean reduceOnly) {
    ...
    public NewOrderResponse2 postOnly(@jakarta.annotation.Nullable Boolean postOnly) {
    ...
    public NewOrderResponse2 createTime(@jakarta.annotation.Nullable Long createTime) {
    ...
    public NewOrderResponse2 updateTime(@jakarta.annotation.Nullable Long updateTime) {
    ...
    public NewOrderResponse2 status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public NewOrderResponse2 avgPrice(@jakarta.annotation.Nullable String avgPrice) {
    ...
    public NewOrderResponse2 clientOrderId(@jakarta.annotation.Nullable String clientOrderId) {
    ...
    public NewOrderResponse2 priceScale(@jakarta.annotation.Nullable Long priceScale) {
    ...
    public NewOrderResponse2 quantityScale(@jakarta.annotation.Nullable Long quantityScale) {
    ...
    public NewOrderResponse2 optionSide(@jakarta.annotation.Nullable String optionSide) {
    ...
    public NewOrderResponse2 quoteAsset(@jakarta.annotation.Nullable String quoteAsset) {
    ...
    public NewOrderResponse2 mmp(@jakarta.annotation.Nullable Boolean mmp) {
        this.mmp = mmp;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        NewOrderResponse2 newOrderResponse2 = (NewOrderResponse2) o;
        return Objects.equals(this.orderId, newOrderResponse2.orderId)
                && Objects.equals(this.symbol, newOrderResponse2.symbol)
                && Objects.equals(this.price, newOrderResponse2.price)
                && Objects.equals(this.quantity, newOrderResponse2.quantity)
                && Objects.equals(this.executedQty, newOrderResponse2.executedQty)
                && Objects.equals(this.fee, newOrderResponse2.fee)
                && Objects.equals(this.side, newOrderResponse2.side)
                && Objects.equals(this.type, newOrderResponse2.type)
                && Objects.equals(this.timeInForce, newOrderResponse2.timeInForce)
                && Objects.equals(this.reduceOnly, newOrderResponse2.reduceOnly)
                && Objects.equals(this.postOnly, newOrderResponse2.postOnly)
                && Objects.equals(this.createTime, newOrderResponse2.createTime)
                && Objects.equals(this.updateTime, newOrderResponse2.updateTime)
                && Objects.equals(this.status, newOrderResponse2.status)
                && Objects.equals(this.avgPrice, newOrderResponse2.avgPrice)
                && Objects.equals(this.clientOrderId, newOrderResponse2.clientOrderId)
                && Objects.equals(this.priceScale, newOrderResponse2.priceScale)
                && Objects.equals(this.quantityScale, newOrderResponse2.quantityScale)
                && Objects.equals(this.optionSide, newOrderResponse2.optionSide)
                && Objects.equals(this.quoteAsset, newOrderResponse2.quoteAsset)
                && Objects.equals(this.mmp, newOrderResponse2.mmp);
    }
    ...
    public String toString() {
        ...
        sb.append("class NewOrderResponse2 {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to NewOrderResponse2
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!NewOrderResponse2.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in NewOrderResponse2 is not found in the"
                                        + " empty JSON string",
                                NewOrderResponse2.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!NewOrderResponse2.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `NewOrderResponse2` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NewOrderResponse2.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NewOrderResponse2' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<NewOrderResponse2> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(NewOrderResponse2.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<NewOrderResponse2>() {
                        @Override
                        public void write(JsonWriter out, NewOrderResponse2 value)
                                throws IOException {
                        ...
                        @Override
                        public NewOrderResponse2 read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of NewOrderResponse2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of NewOrderResponse2
     * @throws IOException if the JSON string is invalid with respect to NewOrderResponse2
     */
    public static NewOrderResponse2 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, NewOrderResponse2.class);
    }

    /**
     * Convert an instance of NewOrderResponse2 to an JSON string
     *
     * @return JSON string
     */
