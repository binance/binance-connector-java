...
public class PlaceMultipleOrdersRequest {
    ...
    public PlaceMultipleOrdersRequest orders(@jakarta.annotation.Nonnull Orders orders) {
        this.orders = orders;
        return this;
    }
    ...
    public void setOrders(@jakarta.annotation.Nonnull Orders orders) {
        this.orders = orders;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.orders, placeMultipleOrdersRequest.orders)
                && Objects.equals(this.recvWindow, placeMultipleOrdersRequest.recvWindow);
    }

    @Override
    public int hashCode() {
        return Objects.hash(orders, recvWindow);
    }
    ...
    public String toUrlQueryString() {
        ...
        ordersValueAsString = ordersValue.toString();
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PlaceMultipleOrdersRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `PlaceMultipleOrdersRequest` properties. JSON: %s",
