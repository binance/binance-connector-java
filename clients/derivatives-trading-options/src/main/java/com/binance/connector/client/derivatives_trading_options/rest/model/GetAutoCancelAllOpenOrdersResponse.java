...
public class GetAutoCancelAllOpenOrdersResponse {
    ...
    public GetAutoCancelAllOpenOrdersResponse() {}

    public GetAutoCancelAllOpenOrdersResponse underlying(
    ...
    public GetAutoCancelAllOpenOrdersResponse countdownTime(
    ...
    public boolean equals(Object o) {
        ...
        GetAutoCancelAllOpenOrdersResponse getAutoCancelAllOpenOrdersResponse =
                (GetAutoCancelAllOpenOrdersResponse) o;
        return Objects.equals(this.underlying, getAutoCancelAllOpenOrdersResponse.underlying)
                && Objects.equals(
                        this.countdownTime, getAutoCancelAllOpenOrdersResponse.countdownTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetAutoCancelAllOpenOrdersResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetAutoCancelAllOpenOrdersResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetAutoCancelAllOpenOrdersResponse is"
                                        + " not found in the empty JSON string",
                                GetAutoCancelAllOpenOrdersResponse.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAutoCancelAllOpenOrdersResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAutoCancelAllOpenOrdersResponse' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetAutoCancelAllOpenOrdersResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetAutoCancelAllOpenOrdersResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetAutoCancelAllOpenOrdersResponse>() {
                        @Override
                        ...
                        @Override
                        public GetAutoCancelAllOpenOrdersResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetAutoCancelAllOpenOrdersResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetAutoCancelAllOpenOrdersResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     GetAutoCancelAllOpenOrdersResponse
     */
    public static GetAutoCancelAllOpenOrdersResponse fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, GetAutoCancelAllOpenOrdersResponse.class);
    }

    /**
     * Convert an instance of GetAutoCancelAllOpenOrdersResponse to an JSON string
     *
     * @return JSON string
     */
