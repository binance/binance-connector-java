...
public class IndexPriceStreamsResponseInner extends BaseDTO {
    ...
    public IndexPriceStreamsResponseInner() {}

    public IndexPriceStreamsResponseInner eLowerCase(
    ...
    public IndexPriceStreamsResponseInner E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public IndexPriceStreamsResponseInner sLowerCase(
    ...
    public IndexPriceStreamsResponseInner pLowerCase(
    ...
    public boolean equals(Object o) {
        ...
        IndexPriceStreamsResponseInner indexPriceStreamsResponseInner =
                (IndexPriceStreamsResponseInner) o;
        return Objects.equals(this.eLowerCase, indexPriceStreamsResponseInner.eLowerCase)
                && Objects.equals(this.E, indexPriceStreamsResponseInner.E)
                && Objects.equals(this.sLowerCase, indexPriceStreamsResponseInner.sLowerCase)
                && Objects.equals(this.pLowerCase, indexPriceStreamsResponseInner.pLowerCase);
    }
    ...
    public String toString() {
        ...
        sb.append("class IndexPriceStreamsResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!IndexPriceStreamsResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in IndexPriceStreamsResponseInner is not"
                                        + " found in the empty JSON string",
                                IndexPriceStreamsResponseInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!IndexPriceStreamsResponseInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `IndexPriceStreamsResponseInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!IndexPriceStreamsResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'IndexPriceStreamsResponseInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<IndexPriceStreamsResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(IndexPriceStreamsResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<IndexPriceStreamsResponseInner>() {
                        @Override
                        public void write(JsonWriter out, IndexPriceStreamsResponseInner value)
                                throws IOException {
                        ...
                        @Override
                        public IndexPriceStreamsResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of IndexPriceStreamsResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of IndexPriceStreamsResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     IndexPriceStreamsResponseInner
     */
    public static IndexPriceStreamsResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, IndexPriceStreamsResponseInner.class);
    }

    /**
     * Convert an instance of IndexPriceStreamsResponseInner to an JSON string
     *
     * @return JSON string
     */
