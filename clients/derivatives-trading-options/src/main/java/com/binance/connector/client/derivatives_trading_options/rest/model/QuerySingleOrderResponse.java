...
public class QuerySingleOrderResponse {
    ...
    public QuerySingleOrderResponse symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public QuerySingleOrderResponse price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public QuerySingleOrderResponse quantity(@jakarta.annotation.Nullable String quantity) {
    ...
    public QuerySingleOrderResponse executedQty(@jakarta.annotation.Nullable String executedQty) {
    ...
    public QuerySingleOrderResponse type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public QuerySingleOrderResponse timeInForce(@jakarta.annotation.Nullable String timeInForce) {
    ...
    public QuerySingleOrderResponse reduceOnly(@jakarta.annotation.Nullable Boolean reduceOnly) {
    ...
    public QuerySingleOrderResponse updateTime(@jakarta.annotation.Nullable Long updateTime) {
    ...
    public QuerySingleOrderResponse status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public QuerySingleOrderResponse avgPrice(@jakarta.annotation.Nullable String avgPrice) {
    ...
    public QuerySingleOrderResponse priceScale(@jakarta.annotation.Nullable Long priceScale) {
    ...
    public QuerySingleOrderResponse quantityScale(@jakarta.annotation.Nullable Long quantityScale) {
    ...
    public QuerySingleOrderResponse optionSide(@jakarta.annotation.Nullable String optionSide) {
    ...
    public QuerySingleOrderResponse quoteAsset(@jakarta.annotation.Nullable String quoteAsset) {
    ...
    public QuerySingleOrderResponse mmp(@jakarta.annotation.Nullable Boolean mmp) {
        this.mmp = mmp;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        QuerySingleOrderResponse querySingleOrderResponse = (QuerySingleOrderResponse) o;
        return Objects.equals(this.orderId, querySingleOrderResponse.orderId)
                && Objects.equals(this.symbol, querySingleOrderResponse.symbol)
    ...
    public String toString() {
        ...
        sb.append("class QuerySingleOrderResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to QuerySingleOrderResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QuerySingleOrderResponse.openapiRequiredFields
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QuerySingleOrderResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'QuerySingleOrderResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<QuerySingleOrderResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(QuerySingleOrderResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<QuerySingleOrderResponse>() {
                        @Override
                        ...
                        @Override
                        public QuerySingleOrderResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of QuerySingleOrderResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QuerySingleOrderResponse
     * @throws IOException if the JSON string is invalid with respect to QuerySingleOrderResponse
     */
    public static QuerySingleOrderResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, QuerySingleOrderResponse.class);
    }

    /**
     * Convert an instance of QuerySingleOrderResponse to an JSON string
     *
     * @return JSON string
     */
