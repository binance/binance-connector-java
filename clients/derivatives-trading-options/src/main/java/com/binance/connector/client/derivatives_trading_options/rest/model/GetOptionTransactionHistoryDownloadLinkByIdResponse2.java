...
public class GetOptionTransactionHistoryDownloadLinkByIdResponse2 {
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse2 downloadId(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse2 status(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse2 url(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse2 notified(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse2 expirationTimestamp(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse2 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetOptionTransactionHistoryDownloadLinkByIdResponse2
                getOptionTransactionHistoryDownloadLinkByIdResponse2 =
                        (GetOptionTransactionHistoryDownloadLinkByIdResponse2) o;
        return Objects.equals(
                        this.downloadId,
                        getOptionTransactionHistoryDownloadLinkByIdResponse2.downloadId)
                && Objects.equals(
                        this.status, getOptionTransactionHistoryDownloadLinkByIdResponse2.status)
                && Objects.equals(
                        this.url, getOptionTransactionHistoryDownloadLinkByIdResponse2.url)
                && Objects.equals(
                        this.notified,
                        getOptionTransactionHistoryDownloadLinkByIdResponse2.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getOptionTransactionHistoryDownloadLinkByIdResponse2.expirationTimestamp)
                && Objects.equals(
                        this.isExpired,
                        getOptionTransactionHistoryDownloadLinkByIdResponse2.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetOptionTransactionHistoryDownloadLinkByIdResponse2 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetOptionTransactionHistoryDownloadLinkByIdResponse2.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetOptionTransactionHistoryDownloadLinkByIdResponse2 is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetOptionTransactionHistoryDownloadLinkByIdResponse2.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetOptionTransactionHistoryDownloadLinkByIdResponse2.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetOptionTransactionHistoryDownloadLinkByIdResponse2' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetOptionTransactionHistoryDownloadLinkByIdResponse2> thisAdapter =
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<GetOptionTransactionHistoryDownloadLinkByIdResponse2>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                GetOptionTransactionHistoryDownloadLinkByIdResponse2 value)
                                throws IOException {
                        ...
                        @Override
                        public GetOptionTransactionHistoryDownloadLinkByIdResponse2 read(
    ...
    /**
     * Create an instance of GetOptionTransactionHistoryDownloadLinkByIdResponse2 given an JSON
     * string
     *
     * @param jsonString JSON string
     * @return An instance of GetOptionTransactionHistoryDownloadLinkByIdResponse2
     * @throws IOException if the JSON string is invalid with respect to
     *     GetOptionTransactionHistoryDownloadLinkByIdResponse2
     */
    public static GetOptionTransactionHistoryDownloadLinkByIdResponse2 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetOptionTransactionHistoryDownloadLinkByIdResponse2.class);
    }

    /**
     * Convert an instance of GetOptionTransactionHistoryDownloadLinkByIdResponse2 to an JSON string
     *
     * @return JSON string
     */
