...
public class OptionMarginAccountInformationResponseGreekInner {
    ...
    public OptionMarginAccountInformationResponseGreekInner underlying(
    ...
    public OptionMarginAccountInformationResponseGreekInner delta(
    ...
    public boolean equals(Object o) {
        ...
        OptionMarginAccountInformationResponseGreekInner
                optionMarginAccountInformationResponseGreekInner =
                        (OptionMarginAccountInformationResponseGreekInner) o;
        return Objects.equals(
                        this.underlying,
                        optionMarginAccountInformationResponseGreekInner.underlying)
                && Objects.equals(
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OptionMarginAccountInformationResponseGreekInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                        + " OptionMarginAccountInformationResponseGreekInner is not"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OptionMarginAccountInformationResponseGreekInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'OptionMarginAccountInformationResponseGreekInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OptionMarginAccountInformationResponseGreekInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(OptionMarginAccountInformationResponseGreekInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OptionMarginAccountInformationResponseGreekInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                OptionMarginAccountInformationResponseGreekInner value)
                                throws IOException {
                        ...
                        @Override
                        public OptionMarginAccountInformationResponseGreekInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of OptionMarginAccountInformationResponseGreekInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OptionMarginAccountInformationResponseGreekInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OptionMarginAccountInformationResponseGreekInner
     */
    public static OptionMarginAccountInformationResponseGreekInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, OptionMarginAccountInformationResponseGreekInner.class);
    }

    /**
     * Convert an instance of OptionMarginAccountInformationResponseGreekInner to an JSON string
     *
     * @return JSON string
     */
