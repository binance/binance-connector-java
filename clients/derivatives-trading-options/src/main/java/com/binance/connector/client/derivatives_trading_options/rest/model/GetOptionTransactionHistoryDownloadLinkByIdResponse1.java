...
public class GetOptionTransactionHistoryDownloadLinkByIdResponse1 {
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse1 downloadId(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse1 status(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse1 url(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse1 notified(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse1 expirationTimestamp(
    ...
    public GetOptionTransactionHistoryDownloadLinkByIdResponse1 isExpired(
    ...
    public boolean equals(Object o) {
        ...
        GetOptionTransactionHistoryDownloadLinkByIdResponse1
                getOptionTransactionHistoryDownloadLinkByIdResponse1 =
                        (GetOptionTransactionHistoryDownloadLinkByIdResponse1) o;
        return Objects.equals(
                        this.downloadId,
                        getOptionTransactionHistoryDownloadLinkByIdResponse1.downloadId)
                && Objects.equals(
                        this.status, getOptionTransactionHistoryDownloadLinkByIdResponse1.status)
                && Objects.equals(
                        this.url, getOptionTransactionHistoryDownloadLinkByIdResponse1.url)
                && Objects.equals(
                        this.notified,
                        getOptionTransactionHistoryDownloadLinkByIdResponse1.notified)
                && Objects.equals(
                        this.expirationTimestamp,
                        getOptionTransactionHistoryDownloadLinkByIdResponse1.expirationTimestamp)
                && Objects.equals(
                        this.isExpired,
                        getOptionTransactionHistoryDownloadLinkByIdResponse1.isExpired);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetOptionTransactionHistoryDownloadLinkByIdResponse1 {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetOptionTransactionHistoryDownloadLinkByIdResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetOptionTransactionHistoryDownloadLinkByIdResponse1 is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetOptionTransactionHistoryDownloadLinkByIdResponse1.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetOptionTransactionHistoryDownloadLinkByIdResponse1.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetOptionTransactionHistoryDownloadLinkByIdResponse1' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetOptionTransactionHistoryDownloadLinkByIdResponse1> thisAdapter =
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<GetOptionTransactionHistoryDownloadLinkByIdResponse1>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                GetOptionTransactionHistoryDownloadLinkByIdResponse1 value)
                                throws IOException {
                        ...
                        @Override
                        public GetOptionTransactionHistoryDownloadLinkByIdResponse1 read(
    ...
    /**
     * Create an instance of GetOptionTransactionHistoryDownloadLinkByIdResponse1 given an JSON
     * string
     *
     * @param jsonString JSON string
     * @return An instance of GetOptionTransactionHistoryDownloadLinkByIdResponse1
     * @throws IOException if the JSON string is invalid with respect to
     *     GetOptionTransactionHistoryDownloadLinkByIdResponse1
     */
    public static GetOptionTransactionHistoryDownloadLinkByIdResponse1 fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetOptionTransactionHistoryDownloadLinkByIdResponse1.class);
    }

    /**
     * Convert an instance of GetOptionTransactionHistoryDownloadLinkByIdResponse1 to an JSON string
     *
     * @return JSON string
     */
