...
public class CancelAllOptionOrdersByUnderlyingResponse {
    ...
    public CancelAllOptionOrdersByUnderlyingResponse msg(@jakarta.annotation.Nullable String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CancelAllOptionOrdersByUnderlyingResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " CancelAllOptionOrdersByUnderlyingResponse is not found in"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CancelAllOptionOrdersByUnderlyingResponse.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'CancelAllOptionOrdersByUnderlyingResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CancelAllOptionOrdersByUnderlyingResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CancelAllOptionOrdersByUnderlyingResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CancelAllOptionOrdersByUnderlyingResponse>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public CancelAllOptionOrdersByUnderlyingResponse read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of CancelAllOptionOrdersByUnderlyingResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CancelAllOptionOrdersByUnderlyingResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     CancelAllOptionOrdersByUnderlyingResponse
     */
    public static CancelAllOptionOrdersByUnderlyingResponse fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, CancelAllOptionOrdersByUnderlyingResponse.class);
    }

    /**
     * Convert an instance of CancelAllOptionOrdersByUnderlyingResponse to an JSON string
     *
     * @return JSON string
     */
