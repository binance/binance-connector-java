...
public class HistoricalBlockTradesResponseInner {
    ...
    public HistoricalBlockTradesResponseInner() {}

    public HistoricalBlockTradesResponseInner id(@jakarta.annotation.Nullable Long id) {
        this.id = id;
        return this;
    }
    ...
    public HistoricalBlockTradesResponseInner price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public HistoricalBlockTradesResponseInner qty(@jakarta.annotation.Nullable String qty) {
        this.qty = qty;
        return this;
    }
    ...
    public HistoricalBlockTradesResponseInner quoteQty(
    ...
    public HistoricalBlockTradesResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public HistoricalBlockTradesResponseInner isBuyerMaker(
    ...
    public boolean equals(Object o) {
        ...
        HistoricalBlockTradesResponseInner historicalBlockTradesResponseInner =
                (HistoricalBlockTradesResponseInner) o;
        return Objects.equals(this.id, historicalBlockTradesResponseInner.id)
                && Objects.equals(this.price, historicalBlockTradesResponseInner.price)
                && Objects.equals(this.qty, historicalBlockTradesResponseInner.qty)
                && Objects.equals(this.quoteQty, historicalBlockTradesResponseInner.quoteQty)
                && Objects.equals(this.time, historicalBlockTradesResponseInner.time)
                && Objects.equals(
                        this.isBuyerMaker, historicalBlockTradesResponseInner.isBuyerMaker);
    }
    ...
    public String toString() {
        ...
        sb.append("class HistoricalBlockTradesResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!HistoricalBlockTradesResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in HistoricalBlockTradesResponseInner is"
                                        + " not found in the empty JSON string",
                                HistoricalBlockTradesResponseInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!HistoricalBlockTradesResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'HistoricalBlockTradesResponseInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<HistoricalBlockTradesResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(HistoricalBlockTradesResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<HistoricalBlockTradesResponseInner>() {
                        @Override
                        public void write(JsonWriter out, HistoricalBlockTradesResponseInner value)
                                throws IOException {
                        ...
                        @Override
                        public HistoricalBlockTradesResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of HistoricalBlockTradesResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of HistoricalBlockTradesResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     HistoricalBlockTradesResponseInner
     */
    public static HistoricalBlockTradesResponseInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, HistoricalBlockTradesResponseInner.class);
    }

    /**
     * Convert an instance of HistoricalBlockTradesResponseInner to an JSON string
     *
     * @return JSON string
     */
