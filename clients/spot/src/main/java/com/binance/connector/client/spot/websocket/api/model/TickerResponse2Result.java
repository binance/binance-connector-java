...
public class TickerResponse2Result extends BaseDTO {
    ...
    public TickerResponse2Result() {}

    public TickerResponse2Result symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public TickerResponse2Result openPrice(@jakarta.annotation.Nullable String openPrice) {
    ...
    public TickerResponse2Result highPrice(@jakarta.annotation.Nullable String highPrice) {
    ...
    public TickerResponse2Result lowPrice(@jakarta.annotation.Nullable String lowPrice) {
    ...
    public TickerResponse2Result lastPrice(@jakarta.annotation.Nullable String lastPrice) {
    ...
    public TickerResponse2Result volume(@jakarta.annotation.Nullable String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public TickerResponse2Result quoteVolume(@jakarta.annotation.Nullable String quoteVolume) {
    ...
    public TickerResponse2Result openTime(@jakarta.annotation.Nullable Long openTime) {
    ...
    public TickerResponse2Result closeTime(@jakarta.annotation.Nullable Long closeTime) {
    ...
    public TickerResponse2Result firstId(@jakarta.annotation.Nullable Long firstId) {
    ...
    public TickerResponse2Result lastId(@jakarta.annotation.Nullable Long lastId) {
        this.lastId = lastId;
        return this;
    }
    ...
    public TickerResponse2Result count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        TickerResponse2Result tickerResponse2Result = (TickerResponse2Result) o;
        return Objects.equals(this.symbol, tickerResponse2Result.symbol)
                && Objects.equals(this.openPrice, tickerResponse2Result.openPrice)
                && Objects.equals(this.highPrice, tickerResponse2Result.highPrice)
                && Objects.equals(this.lowPrice, tickerResponse2Result.lowPrice)
                && Objects.equals(this.lastPrice, tickerResponse2Result.lastPrice)
                && Objects.equals(this.volume, tickerResponse2Result.volume)
                && Objects.equals(this.quoteVolume, tickerResponse2Result.quoteVolume)
                && Objects.equals(this.openTime, tickerResponse2Result.openTime)
                && Objects.equals(this.closeTime, tickerResponse2Result.closeTime)
                && Objects.equals(this.firstId, tickerResponse2Result.firstId)
                && Objects.equals(this.lastId, tickerResponse2Result.lastId)
                && Objects.equals(this.count, tickerResponse2Result.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class TickerResponse2Result {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to TickerResponse2Result
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TickerResponse2Result.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TickerResponse2Result is not found in"
                                        + " the empty JSON string",
                                TickerResponse2Result.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TickerResponse2Result.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `TickerResponse2Result` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TickerResponse2Result.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TickerResponse2Result' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TickerResponse2Result> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(TickerResponse2Result.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TickerResponse2Result>() {
                        @Override
                        public void write(JsonWriter out, TickerResponse2Result value)
                                throws IOException {
                        ...
                        @Override
                        public TickerResponse2Result read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of TickerResponse2Result given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TickerResponse2Result
     * @throws IOException if the JSON string is invalid with respect to TickerResponse2Result
     */
    public static TickerResponse2Result fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TickerResponse2Result.class);
    }

    /**
     * Convert an instance of TickerResponse2Result to an JSON string
     *
     * @return JSON string
     */
