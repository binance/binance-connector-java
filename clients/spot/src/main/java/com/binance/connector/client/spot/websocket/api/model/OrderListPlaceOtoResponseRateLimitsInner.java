...
public class OrderListPlaceOtoResponseRateLimitsInner extends BaseDTO {
    ...
    public OrderListPlaceOtoResponseRateLimitsInner() {}

    public OrderListPlaceOtoResponseRateLimitsInner rateLimitType(
    ...
    public OrderListPlaceOtoResponseRateLimitsInner interval(
    ...
    public OrderListPlaceOtoResponseRateLimitsInner intervalNum(
    ...
    public OrderListPlaceOtoResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public OrderListPlaceOtoResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderListPlaceOtoResponseRateLimitsInner orderListPlaceOtoResponseRateLimitsInner =
                (OrderListPlaceOtoResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType, orderListPlaceOtoResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, orderListPlaceOtoResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, orderListPlaceOtoResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, orderListPlaceOtoResponseRateLimitsInner.limit)
                && Objects.equals(this.count, orderListPlaceOtoResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderListPlaceOtoResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderListPlaceOtoResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " OrderListPlaceOtoResponseRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                OrderListPlaceOtoResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderListPlaceOtoResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrderListPlaceOtoResponseRateLimitsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderListPlaceOtoResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'OrderListPlaceOtoResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderListPlaceOtoResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OrderListPlaceOtoResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderListPlaceOtoResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, OrderListPlaceOtoResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public OrderListPlaceOtoResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of OrderListPlaceOtoResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderListPlaceOtoResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OrderListPlaceOtoResponseRateLimitsInner
     */
    public static OrderListPlaceOtoResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderListPlaceOtoResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of OrderListPlaceOtoResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
