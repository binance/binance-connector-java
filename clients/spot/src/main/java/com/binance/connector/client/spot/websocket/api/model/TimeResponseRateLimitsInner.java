...
public class TimeResponseRateLimitsInner extends BaseDTO {
    ...
    public TimeResponseRateLimitsInner() {}

    public TimeResponseRateLimitsInner rateLimitType(
    ...
    public TimeResponseRateLimitsInner interval(@jakarta.annotation.Nullable String interval) {
    ...
    public TimeResponseRateLimitsInner intervalNum(@jakarta.annotation.Nullable Long intervalNum) {
    ...
    public TimeResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public TimeResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        TimeResponseRateLimitsInner timeResponseRateLimitsInner = (TimeResponseRateLimitsInner) o;
        return Objects.equals(this.rateLimitType, timeResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, timeResponseRateLimitsInner.interval)
                && Objects.equals(this.intervalNum, timeResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, timeResponseRateLimitsInner.limit)
                && Objects.equals(this.count, timeResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class TimeResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TimeResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TimeResponseRateLimitsInner is not"
                                        + " found in the empty JSON string",
                                TimeResponseRateLimitsInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TimeResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `TimeResponseRateLimitsInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TimeResponseRateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TimeResponseRateLimitsInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TimeResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(TimeResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TimeResponseRateLimitsInner>() {
                        @Override
                        public void write(JsonWriter out, TimeResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public TimeResponseRateLimitsInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of TimeResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TimeResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to TimeResponseRateLimitsInner
     */
    public static TimeResponseRateLimitsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TimeResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of TimeResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
