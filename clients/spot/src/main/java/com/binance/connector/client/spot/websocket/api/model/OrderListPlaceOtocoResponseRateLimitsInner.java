...
public class OrderListPlaceOtocoResponseRateLimitsInner extends BaseDTO {
    ...
    public OrderListPlaceOtocoResponseRateLimitsInner() {}

    public OrderListPlaceOtocoResponseRateLimitsInner rateLimitType(
    ...
    public OrderListPlaceOtocoResponseRateLimitsInner interval(
    ...
    public OrderListPlaceOtocoResponseRateLimitsInner intervalNum(
    ...
    public OrderListPlaceOtocoResponseRateLimitsInner limit(
    ...
    public OrderListPlaceOtocoResponseRateLimitsInner count(
    ...
    public boolean equals(Object o) {
        ...
        OrderListPlaceOtocoResponseRateLimitsInner orderListPlaceOtocoResponseRateLimitsInner =
                (OrderListPlaceOtocoResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType,
                        orderListPlaceOtocoResponseRateLimitsInner.rateLimitType)
                && Objects.equals(
                        this.interval, orderListPlaceOtocoResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, orderListPlaceOtocoResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, orderListPlaceOtocoResponseRateLimitsInner.limit)
                && Objects.equals(this.count, orderListPlaceOtocoResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderListPlaceOtocoResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderListPlaceOtocoResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " OrderListPlaceOtocoResponseRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                OrderListPlaceOtocoResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderListPlaceOtocoResponseRateLimitsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `OrderListPlaceOtocoResponseRateLimitsInner` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderListPlaceOtocoResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'OrderListPlaceOtocoResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderListPlaceOtocoResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OrderListPlaceOtocoResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderListPlaceOtocoResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, OrderListPlaceOtocoResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public OrderListPlaceOtocoResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of OrderListPlaceOtocoResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderListPlaceOtocoResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OrderListPlaceOtocoResponseRateLimitsInner
     */
    public static OrderListPlaceOtocoResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, OrderListPlaceOtocoResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of OrderListPlaceOtocoResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
