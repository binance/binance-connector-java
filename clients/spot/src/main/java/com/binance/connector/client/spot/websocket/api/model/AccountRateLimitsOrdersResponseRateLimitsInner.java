...
public class AccountRateLimitsOrdersResponseRateLimitsInner extends BaseDTO {
    ...
    public AccountRateLimitsOrdersResponseRateLimitsInner() {}

    public AccountRateLimitsOrdersResponseRateLimitsInner rateLimitType(
    ...
    public AccountRateLimitsOrdersResponseRateLimitsInner interval(
    ...
    public AccountRateLimitsOrdersResponseRateLimitsInner intervalNum(
    ...
    public AccountRateLimitsOrdersResponseRateLimitsInner limit(
    ...
    public AccountRateLimitsOrdersResponseRateLimitsInner count(
    ...
    public boolean equals(Object o) {
        ...
        AccountRateLimitsOrdersResponseRateLimitsInner
                accountRateLimitsOrdersResponseRateLimitsInner =
                        (AccountRateLimitsOrdersResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType,
                        accountRateLimitsOrdersResponseRateLimitsInner.rateLimitType)
                && Objects.equals(
                        this.interval, accountRateLimitsOrdersResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum,
                        accountRateLimitsOrdersResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, accountRateLimitsOrdersResponseRateLimitsInner.limit)
                && Objects.equals(this.count, accountRateLimitsOrdersResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountRateLimitsOrdersResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountRateLimitsOrdersResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountRateLimitsOrdersResponseRateLimitsInner is not found"
                                    + " in the empty JSON string",
                                AccountRateLimitsOrdersResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountRateLimitsOrdersResponseRateLimitsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountRateLimitsOrdersResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountRateLimitsOrdersResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountRateLimitsOrdersResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(AccountRateLimitsOrdersResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountRateLimitsOrdersResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                AccountRateLimitsOrdersResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountRateLimitsOrdersResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountRateLimitsOrdersResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountRateLimitsOrdersResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountRateLimitsOrdersResponseRateLimitsInner
     */
    public static AccountRateLimitsOrdersResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountRateLimitsOrdersResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of AccountRateLimitsOrdersResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
