...
public class RateLimitsInner extends BaseDTO {
    ...
    public RateLimitsInner() {}

    public RateLimitsInner rateLimitType(@jakarta.annotation.Nullable String rateLimitType) {
    ...
    public RateLimitsInner interval(@jakarta.annotation.Nullable String interval) {
    ...
    public RateLimitsInner intervalNum(@jakarta.annotation.Nullable Long intervalNum) {
    ...
    public RateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public RateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        RateLimitsInner rateLimitsInner = (RateLimitsInner) o;
        return Objects.equals(this.rateLimitType, rateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, rateLimitsInner.interval)
                && Objects.equals(this.intervalNum, rateLimitsInner.intervalNum)
                && Objects.equals(this.limit, rateLimitsInner.limit)
                && Objects.equals(this.count, rateLimitsInner.count);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to RateLimitsInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in RateLimitsInner is not found in the"
                                        + " empty JSON string",
                                RateLimitsInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `RateLimitsInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!RateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'RateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<RateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(RateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<RateLimitsInner>() {
                        @Override
                        ...
                        @Override
                        public RateLimitsInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of RateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of RateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to RateLimitsInner
     */
    public static RateLimitsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, RateLimitsInner.class);
    }

    /**
     * Convert an instance of RateLimitsInner to an JSON string
     *
     * @return JSON string
     */
