...
public class OrderPlaceResponse2Result extends BaseDTO {
    ...
    public OrderPlaceResponse2Result() {}

    public OrderPlaceResponse2Result symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public OrderPlaceResponse2Result orderId(@jakarta.annotation.Nullable Long orderId) {
    ...
    public OrderPlaceResponse2Result orderListId(@jakarta.annotation.Nullable Long orderListId) {
    ...
    public OrderPlaceResponse2Result clientOrderId(
    ...
    public OrderPlaceResponse2Result transactTime(@jakarta.annotation.Nullable Long transactTime) {
    ...
    public OrderPlaceResponse2Result price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public OrderPlaceResponse2Result origQty(@jakarta.annotation.Nullable String origQty) {
    ...
    public OrderPlaceResponse2Result executedQty(@jakarta.annotation.Nullable String executedQty) {
    ...
    public OrderPlaceResponse2Result origQuoteOrderQty(
    ...
    public OrderPlaceResponse2Result cummulativeQuoteQty(
    ...
    public OrderPlaceResponse2Result status(@jakarta.annotation.Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public OrderPlaceResponse2Result timeInForce(@jakarta.annotation.Nullable String timeInForce) {
    ...
    public OrderPlaceResponse2Result type(@jakarta.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public OrderPlaceResponse2Result side(@jakarta.annotation.Nullable String side) {
        this.side = side;
        return this;
    }
    ...
    public OrderPlaceResponse2Result workingTime(@jakarta.annotation.Nullable Long workingTime) {
    ...
    public OrderPlaceResponse2Result selfTradePreventionMode(
    ...
    public boolean equals(Object o) {
        ...
        OrderPlaceResponse2Result orderPlaceResponse2Result = (OrderPlaceResponse2Result) o;
        return Objects.equals(this.symbol, orderPlaceResponse2Result.symbol)
                && Objects.equals(this.orderId, orderPlaceResponse2Result.orderId)
                && Objects.equals(this.orderListId, orderPlaceResponse2Result.orderListId)
                && Objects.equals(this.clientOrderId, orderPlaceResponse2Result.clientOrderId)
                && Objects.equals(this.transactTime, orderPlaceResponse2Result.transactTime)
                && Objects.equals(this.price, orderPlaceResponse2Result.price)
                && Objects.equals(this.origQty, orderPlaceResponse2Result.origQty)
                && Objects.equals(this.executedQty, orderPlaceResponse2Result.executedQty)
                && Objects.equals(
                        this.origQuoteOrderQty, orderPlaceResponse2Result.origQuoteOrderQty)
                && Objects.equals(
                        this.cummulativeQuoteQty, orderPlaceResponse2Result.cummulativeQuoteQty)
                && Objects.equals(this.status, orderPlaceResponse2Result.status)
                && Objects.equals(this.timeInForce, orderPlaceResponse2Result.timeInForce)
                && Objects.equals(this.type, orderPlaceResponse2Result.type)
                && Objects.equals(this.side, orderPlaceResponse2Result.side)
                && Objects.equals(this.workingTime, orderPlaceResponse2Result.workingTime)
                && Objects.equals(
                        this.selfTradePreventionMode,
                        orderPlaceResponse2Result.selfTradePreventionMode);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderPlaceResponse2Result {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to OrderPlaceResponse2Result
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderPlaceResponse2Result.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderPlaceResponse2Result is not found"
                                        + " in the empty JSON string",
                                OrderPlaceResponse2Result.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderPlaceResponse2Result.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrderPlaceResponse2Result` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderPlaceResponse2Result.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderPlaceResponse2Result' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderPlaceResponse2Result> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OrderPlaceResponse2Result.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderPlaceResponse2Result>() {
                        @Override
                        public void write(JsonWriter out, OrderPlaceResponse2Result value)
                                throws IOException {
                        ...
                        @Override
                        public OrderPlaceResponse2Result read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OrderPlaceResponse2Result given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderPlaceResponse2Result
     * @throws IOException if the JSON string is invalid with respect to OrderPlaceResponse2Result
     */
    public static OrderPlaceResponse2Result fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderPlaceResponse2Result.class);
    }

    /**
     * Convert an instance of OrderPlaceResponse2Result to an JSON string
     *
     * @return JSON string
     */
