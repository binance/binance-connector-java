...
public class AvgPriceResponseRateLimitsInner extends BaseDTO {
    ...
    public AvgPriceResponseRateLimitsInner() {}

    public AvgPriceResponseRateLimitsInner rateLimitType(
    ...
    public AvgPriceResponseRateLimitsInner interval(@jakarta.annotation.Nullable String interval) {
    ...
    public AvgPriceResponseRateLimitsInner intervalNum(
    ...
    public AvgPriceResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public AvgPriceResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        AvgPriceResponseRateLimitsInner avgPriceResponseRateLimitsInner =
                (AvgPriceResponseRateLimitsInner) o;
        return Objects.equals(this.rateLimitType, avgPriceResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, avgPriceResponseRateLimitsInner.interval)
                && Objects.equals(this.intervalNum, avgPriceResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, avgPriceResponseRateLimitsInner.limit)
                && Objects.equals(this.count, avgPriceResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class AvgPriceResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AvgPriceResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AvgPriceResponseRateLimitsInner is not"
                                        + " found in the empty JSON string",
                                AvgPriceResponseRateLimitsInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AvgPriceResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AvgPriceResponseRateLimitsInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AvgPriceResponseRateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AvgPriceResponseRateLimitsInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AvgPriceResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AvgPriceResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AvgPriceResponseRateLimitsInner>() {
                        @Override
                        public void write(JsonWriter out, AvgPriceResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AvgPriceResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AvgPriceResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AvgPriceResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AvgPriceResponseRateLimitsInner
     */
    public static AvgPriceResponseRateLimitsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AvgPriceResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of AvgPriceResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
