...
public class OrderTestResponse2Discount {
    ...
    public OrderTestResponse2Discount() {}

    public OrderTestResponse2Discount enabledForAccount(
    ...
    public OrderTestResponse2Discount enabledForSymbol(
    ...
    public OrderTestResponse2Discount discountAsset(
    ...
    public OrderTestResponse2Discount discount(@jakarta.annotation.Nullable String discount) {
    ...
    public boolean equals(Object o) {
        ...
        OrderTestResponse2Discount orderTestResponse2Discount = (OrderTestResponse2Discount) o;
        return Objects.equals(this.enabledForAccount, orderTestResponse2Discount.enabledForAccount)
                && Objects.equals(
                        this.enabledForSymbol, orderTestResponse2Discount.enabledForSymbol)
                && Objects.equals(this.discountAsset, orderTestResponse2Discount.discountAsset)
                && Objects.equals(this.discount, orderTestResponse2Discount.discount);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderTestResponse2Discount {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to OrderTestResponse2Discount
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderTestResponse2Discount.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderTestResponse2Discount is not"
                                        + " found in the empty JSON string",
                                OrderTestResponse2Discount.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderTestResponse2Discount.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrderTestResponse2Discount` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderTestResponse2Discount.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderTestResponse2Discount' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderTestResponse2Discount> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OrderTestResponse2Discount.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderTestResponse2Discount>() {
                        @Override
                        public void write(JsonWriter out, OrderTestResponse2Discount value)
                                throws IOException {
                        ...
                        @Override
                        public OrderTestResponse2Discount read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OrderTestResponse2Discount given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderTestResponse2Discount
     * @throws IOException if the JSON string is invalid with respect to OrderTestResponse2Discount
     */
    public static OrderTestResponse2Discount fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderTestResponse2Discount.class);
    }

    /**
     * Convert an instance of OrderTestResponse2Discount to an JSON string
     *
     * @return JSON string
     */
