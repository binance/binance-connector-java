...
public class OrderListCancelRequest extends BaseDTO {
    ...
    public OrderListCancelRequest id(@jakarta.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, orderListCancelRequest.id)
                && Objects.equals(this.symbol, orderListCancelRequest.symbol)
    ...
    public int hashCode() {
        return Objects.hash(
                id, symbol, orderListId, listClientOrderId, newClientOrderId, recvWindow);
    }
