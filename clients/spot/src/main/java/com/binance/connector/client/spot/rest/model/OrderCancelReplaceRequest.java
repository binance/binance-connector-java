...
public class OrderCancelReplaceRequest {
    ...
    public String toUrlQueryString() {
        ...
        cancelReplaceModeValueAsString = cancelReplaceModeValue.toString();
        sb.append("cancelReplaceMode=")
                .append(urlEncode(cancelReplaceModeValueAsString))
                .append("");
        ...
        String cancelNewClientOrderIdValueAsString = "";
        cancelNewClientOrderIdValueAsString = cancelNewClientOrderIdValue.toString();
        sb.append("cancelNewClientOrderId=")
                .append(urlEncode(cancelNewClientOrderIdValueAsString))
                .append("");
        Object cancelOrigClientOrderIdValue = getCancelOrigClientOrderId();
        String cancelOrigClientOrderIdValueAsString = "";
        cancelOrigClientOrderIdValueAsString = cancelOrigClientOrderIdValue.toString();
        sb.append("cancelOrigClientOrderId=")
                .append(urlEncode(cancelOrigClientOrderIdValueAsString))
                .append("");
        Object cancelOrderIdValue = getCancelOrderId();
        String cancelOrderIdValueAsString = "";
        cancelOrderIdValueAsString = cancelOrderIdValue.toString();
        sb.append("cancelOrderId=").append(urlEncode(cancelOrderIdValueAsString)).append("");
        ...
        String cancelRestrictionsValueAsString = "";
        cancelRestrictionsValueAsString = cancelRestrictionsValue.toString();
        sb.append("cancelRestrictions=")
                .append(urlEncode(cancelRestrictionsValueAsString))
                .append("");
        Object orderRateLimitExceededModeValue = getOrderRateLimitExceededMode();
        String orderRateLimitExceededModeValueAsString = "";
        orderRateLimitExceededModeValueAsString = orderRateLimitExceededModeValue.toString();
        sb.append("orderRateLimitExceededMode=")
                .append(urlEncode(orderRateLimitExceededModeValueAsString))
                .append("");
