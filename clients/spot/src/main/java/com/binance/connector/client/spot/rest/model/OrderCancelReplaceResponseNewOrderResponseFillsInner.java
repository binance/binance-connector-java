...
public class OrderCancelReplaceResponseNewOrderResponseFillsInner {
    ...
    public OrderCancelReplaceResponseNewOrderResponseFillsInner price(
    ...
    public OrderCancelReplaceResponseNewOrderResponseFillsInner qty(
    ...
    public OrderCancelReplaceResponseNewOrderResponseFillsInner commission(
    ...
    public OrderCancelReplaceResponseNewOrderResponseFillsInner commissionAsset(
    ...
    public OrderCancelReplaceResponseNewOrderResponseFillsInner tradeId(
    ...
    public boolean equals(Object o) {
        ...
        OrderCancelReplaceResponseNewOrderResponseFillsInner
                orderCancelReplaceResponseNewOrderResponseFillsInner =
                        (OrderCancelReplaceResponseNewOrderResponseFillsInner) o;
        return Objects.equals(
                        this.price, orderCancelReplaceResponseNewOrderResponseFillsInner.price)
                && Objects.equals(
                        this.qty, orderCancelReplaceResponseNewOrderResponseFillsInner.qty)
                && Objects.equals(
                        this.commission,
                        orderCancelReplaceResponseNewOrderResponseFillsInner.commission)
                && Objects.equals(
                        this.commissionAsset,
                        orderCancelReplaceResponseNewOrderResponseFillsInner.commissionAsset)
                && Objects.equals(
                        this.tradeId, orderCancelReplaceResponseNewOrderResponseFillsInner.tradeId);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderCancelReplaceResponseNewOrderResponseFillsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderCancelReplaceResponseNewOrderResponseFillsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " OrderCancelReplaceResponseNewOrderResponseFillsInner is not"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderCancelReplaceResponseNewOrderResponseFillsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'OrderCancelReplaceResponseNewOrderResponseFillsInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderCancelReplaceResponseNewOrderResponseFillsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(
                                    OrderCancelReplaceResponseNewOrderResponseFillsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderCancelReplaceResponseNewOrderResponseFillsInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                OrderCancelReplaceResponseNewOrderResponseFillsInner value)
                                throws IOException {
                        ...
                        @Override
                        public OrderCancelReplaceResponseNewOrderResponseFillsInner read(
    ...
    /**
     * Create an instance of OrderCancelReplaceResponseNewOrderResponseFillsInner given an JSON
     * string
     *
     * @param jsonString JSON string
     * @return An instance of OrderCancelReplaceResponseNewOrderResponseFillsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OrderCancelReplaceResponseNewOrderResponseFillsInner
     */
    public static OrderCancelReplaceResponseNewOrderResponseFillsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, OrderCancelReplaceResponseNewOrderResponseFillsInner.class);
    }

    /**
     * Convert an instance of OrderCancelReplaceResponseNewOrderResponseFillsInner to an JSON string
     *
     * @return JSON string
     */
