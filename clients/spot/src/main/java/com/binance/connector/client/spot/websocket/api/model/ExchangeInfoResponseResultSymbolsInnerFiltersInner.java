...
public class ExchangeInfoResponseResultSymbolsInnerFiltersInner extends BaseDTO {
    ...
    public ExchangeInfoResponseResultSymbolsInnerFiltersInner() {}

    public ExchangeInfoResponseResultSymbolsInnerFiltersInner filterType(
    ...
    public ExchangeInfoResponseResultSymbolsInnerFiltersInner minPrice(
    ...
    public ExchangeInfoResponseResultSymbolsInnerFiltersInner maxPrice(
    ...
    public ExchangeInfoResponseResultSymbolsInnerFiltersInner tickSize(
    ...
    public boolean equals(Object o) {
        ...
        ExchangeInfoResponseResultSymbolsInnerFiltersInner
                exchangeInfoResponseResultSymbolsInnerFiltersInner =
                        (ExchangeInfoResponseResultSymbolsInnerFiltersInner) o;
        return Objects.equals(
                        this.filterType,
                        exchangeInfoResponseResultSymbolsInnerFiltersInner.filterType)
                && Objects.equals(
                        this.minPrice, exchangeInfoResponseResultSymbolsInnerFiltersInner.minPrice)
                && Objects.equals(
                        this.maxPrice, exchangeInfoResponseResultSymbolsInnerFiltersInner.maxPrice)
                && Objects.equals(
                        this.tickSize, exchangeInfoResponseResultSymbolsInnerFiltersInner.tickSize);
    }
    ...
    public String toString() {
        ...
        sb.append("class ExchangeInfoResponseResultSymbolsInnerFiltersInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ExchangeInfoResponseResultSymbolsInnerFiltersInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " ExchangeInfoResponseResultSymbolsInnerFiltersInner is not"
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!ExchangeInfoResponseResultSymbolsInnerFiltersInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExchangeInfoResponseResultSymbolsInnerFiltersInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'ExchangeInfoResponseResultSymbolsInnerFiltersInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ExchangeInfoResponseResultSymbolsInnerFiltersInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(
                                    ExchangeInfoResponseResultSymbolsInnerFiltersInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ExchangeInfoResponseResultSymbolsInnerFiltersInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                ExchangeInfoResponseResultSymbolsInnerFiltersInner value)
                                throws IOException {
                        ...
                        @Override
                        public ExchangeInfoResponseResultSymbolsInnerFiltersInner read(
    ...
    /**
     * Create an instance of ExchangeInfoResponseResultSymbolsInnerFiltersInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ExchangeInfoResponseResultSymbolsInnerFiltersInner
     * @throws IOException if the JSON string is invalid with respect to
     *     ExchangeInfoResponseResultSymbolsInnerFiltersInner
     */
    public static ExchangeInfoResponseResultSymbolsInnerFiltersInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, ExchangeInfoResponseResultSymbolsInnerFiltersInner.class);
    }

    /**
     * Convert an instance of ExchangeInfoResponseResultSymbolsInnerFiltersInner to an JSON string
     *
     * @return JSON string
     */
