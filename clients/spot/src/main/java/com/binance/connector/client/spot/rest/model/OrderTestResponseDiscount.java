...
public class OrderTestResponseDiscount {
    ...
    public OrderTestResponseDiscount() {}

    public OrderTestResponseDiscount enabledForAccount(
    ...
    public OrderTestResponseDiscount enabledForSymbol(
    ...
    public OrderTestResponseDiscount discountAsset(
    ...
    public OrderTestResponseDiscount discount(@jakarta.annotation.Nullable String discount) {
    ...
    public boolean equals(Object o) {
        ...
        OrderTestResponseDiscount orderTestResponseDiscount = (OrderTestResponseDiscount) o;
        return Objects.equals(this.enabledForAccount, orderTestResponseDiscount.enabledForAccount)
                && Objects.equals(this.enabledForSymbol, orderTestResponseDiscount.enabledForSymbol)
                && Objects.equals(this.discountAsset, orderTestResponseDiscount.discountAsset)
                && Objects.equals(this.discount, orderTestResponseDiscount.discount);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderTestResponseDiscount {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to OrderTestResponseDiscount
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderTestResponseDiscount.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderTestResponseDiscount is not found"
                                        + " in the empty JSON string",
                                OrderTestResponseDiscount.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderTestResponseDiscount.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrderTestResponseDiscount` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderTestResponseDiscount.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderTestResponseDiscount' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderTestResponseDiscount> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OrderTestResponseDiscount.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderTestResponseDiscount>() {
                        @Override
                        public void write(JsonWriter out, OrderTestResponseDiscount value)
                                throws IOException {
                        ...
                        @Override
                        public OrderTestResponseDiscount read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OrderTestResponseDiscount given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderTestResponseDiscount
     * @throws IOException if the JSON string is invalid with respect to OrderTestResponseDiscount
     */
    public static OrderTestResponseDiscount fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderTestResponseDiscount.class);
    }

    /**
     * Convert an instance of OrderTestResponseDiscount to an JSON string
     *
     * @return JSON string
     */
