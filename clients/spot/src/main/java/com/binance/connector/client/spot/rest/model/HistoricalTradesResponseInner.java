...
public class HistoricalTradesResponseInner {
    ...
    public HistoricalTradesResponseInner() {}

    public HistoricalTradesResponseInner id(@jakarta.annotation.Nullable Long id) {
        this.id = id;
        return this;
    }
    ...
    public HistoricalTradesResponseInner price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public HistoricalTradesResponseInner qty(@jakarta.annotation.Nullable String qty) {
        this.qty = qty;
        return this;
    }
    ...
    public HistoricalTradesResponseInner quoteQty(@jakarta.annotation.Nullable String quoteQty) {
    ...
    public HistoricalTradesResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public HistoricalTradesResponseInner isBuyerMaker(
    ...
    public HistoricalTradesResponseInner isBestMatch(
    ...
    public boolean equals(Object o) {
        ...
        HistoricalTradesResponseInner historicalTradesResponseInner =
                (HistoricalTradesResponseInner) o;
        return Objects.equals(this.id, historicalTradesResponseInner.id)
                && Objects.equals(this.price, historicalTradesResponseInner.price)
                && Objects.equals(this.qty, historicalTradesResponseInner.qty)
                && Objects.equals(this.quoteQty, historicalTradesResponseInner.quoteQty)
                && Objects.equals(this.time, historicalTradesResponseInner.time)
                && Objects.equals(this.isBuyerMaker, historicalTradesResponseInner.isBuyerMaker)
                && Objects.equals(this.isBestMatch, historicalTradesResponseInner.isBestMatch);
    }
    ...
    public String toString() {
        ...
        sb.append("class HistoricalTradesResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!HistoricalTradesResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in HistoricalTradesResponseInner is not"
                                        + " found in the empty JSON string",
                                HistoricalTradesResponseInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!HistoricalTradesResponseInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `HistoricalTradesResponseInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!HistoricalTradesResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'HistoricalTradesResponseInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<HistoricalTradesResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(HistoricalTradesResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<HistoricalTradesResponseInner>() {
                        @Override
                        ...
                        @Override
                        public HistoricalTradesResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of HistoricalTradesResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of HistoricalTradesResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     HistoricalTradesResponseInner
     */
    public static HistoricalTradesResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, HistoricalTradesResponseInner.class);
    }

    /**
     * Convert an instance of HistoricalTradesResponseInner to an JSON string
     *
     * @return JSON string
     */
