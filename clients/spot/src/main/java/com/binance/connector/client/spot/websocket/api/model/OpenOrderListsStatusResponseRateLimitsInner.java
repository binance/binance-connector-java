...
public class OpenOrderListsStatusResponseRateLimitsInner extends BaseDTO {
    ...
    public OpenOrderListsStatusResponseRateLimitsInner() {}

    public OpenOrderListsStatusResponseRateLimitsInner rateLimitType(
    ...
    public OpenOrderListsStatusResponseRateLimitsInner interval(
    ...
    public OpenOrderListsStatusResponseRateLimitsInner intervalNum(
    ...
    public OpenOrderListsStatusResponseRateLimitsInner limit(
    ...
    public OpenOrderListsStatusResponseRateLimitsInner count(
    ...
    public boolean equals(Object o) {
        ...
        OpenOrderListsStatusResponseRateLimitsInner openOrderListsStatusResponseRateLimitsInner =
                (OpenOrderListsStatusResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType,
                        openOrderListsStatusResponseRateLimitsInner.rateLimitType)
                && Objects.equals(
                        this.interval, openOrderListsStatusResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, openOrderListsStatusResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, openOrderListsStatusResponseRateLimitsInner.limit)
                && Objects.equals(this.count, openOrderListsStatusResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class OpenOrderListsStatusResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OpenOrderListsStatusResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " OpenOrderListsStatusResponseRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                OpenOrderListsStatusResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OpenOrderListsStatusResponseRateLimitsInner.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `OpenOrderListsStatusResponseRateLimitsInner` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OpenOrderListsStatusResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'OpenOrderListsStatusResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OpenOrderListsStatusResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OpenOrderListsStatusResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OpenOrderListsStatusResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, OpenOrderListsStatusResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public OpenOrderListsStatusResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of OpenOrderListsStatusResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OpenOrderListsStatusResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OpenOrderListsStatusResponseRateLimitsInner
     */
    public static OpenOrderListsStatusResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, OpenOrderListsStatusResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of OpenOrderListsStatusResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
