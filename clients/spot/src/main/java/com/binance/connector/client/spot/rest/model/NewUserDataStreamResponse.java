...
public class NewUserDataStreamResponse {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!NewUserDataStreamResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `NewUserDataStreamResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<NewUserDataStreamResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(NewUserDataStreamResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<NewUserDataStreamResponse>() {
                        @Override
