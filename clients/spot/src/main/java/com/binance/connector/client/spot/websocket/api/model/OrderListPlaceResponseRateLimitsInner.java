...
public class OrderListPlaceResponseRateLimitsInner extends BaseDTO {
    ...
    public OrderListPlaceResponseRateLimitsInner() {}

    public OrderListPlaceResponseRateLimitsInner rateLimitType(
    ...
    public OrderListPlaceResponseRateLimitsInner interval(
    ...
    public OrderListPlaceResponseRateLimitsInner intervalNum(
    ...
    public OrderListPlaceResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public OrderListPlaceResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderListPlaceResponseRateLimitsInner orderListPlaceResponseRateLimitsInner =
                (OrderListPlaceResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType, orderListPlaceResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, orderListPlaceResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, orderListPlaceResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, orderListPlaceResponseRateLimitsInner.limit)
                && Objects.equals(this.count, orderListPlaceResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderListPlaceResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderListPlaceResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrderListPlaceResponseRateLimitsInner"
                                        + " is not found in the empty JSON string",
                                OrderListPlaceResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderListPlaceResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `OrderListPlaceResponseRateLimitsInner` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderListPlaceResponseRateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderListPlaceResponseRateLimitsInner'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderListPlaceResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OrderListPlaceResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderListPlaceResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, OrderListPlaceResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public OrderListPlaceResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of OrderListPlaceResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderListPlaceResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OrderListPlaceResponseRateLimitsInner
     */
    public static OrderListPlaceResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderListPlaceResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of OrderListPlaceResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
