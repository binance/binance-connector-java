...
public class TickerBookTickerResponse1 {
    ...
    public TickerBookTickerResponse1() {}

    public TickerBookTickerResponse1 symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public TickerBookTickerResponse1 bidPrice(@jakarta.annotation.Nullable String bidPrice) {
    ...
    public TickerBookTickerResponse1 bidQty(@jakarta.annotation.Nullable String bidQty) {
        this.bidQty = bidQty;
        return this;
    }
    ...
    public TickerBookTickerResponse1 askPrice(@jakarta.annotation.Nullable String askPrice) {
    ...
    public TickerBookTickerResponse1 askQty(@jakarta.annotation.Nullable String askQty) {
        this.askQty = askQty;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        TickerBookTickerResponse1 tickerBookTickerResponse1 = (TickerBookTickerResponse1) o;
        return Objects.equals(this.symbol, tickerBookTickerResponse1.symbol)
                && Objects.equals(this.bidPrice, tickerBookTickerResponse1.bidPrice)
                && Objects.equals(this.bidQty, tickerBookTickerResponse1.bidQty)
                && Objects.equals(this.askPrice, tickerBookTickerResponse1.askPrice)
                && Objects.equals(this.askQty, tickerBookTickerResponse1.askQty);
    }
    ...
    public String toString() {
        ...
        sb.append("class TickerBookTickerResponse1 {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to TickerBookTickerResponse1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TickerBookTickerResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TickerBookTickerResponse1 is not found"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TickerBookTickerResponse1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TickerBookTickerResponse1' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TickerBookTickerResponse1> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(TickerBookTickerResponse1.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TickerBookTickerResponse1>() {
                        @Override
                        ...
                        @Override
                        public TickerBookTickerResponse1 read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of TickerBookTickerResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TickerBookTickerResponse1
     * @throws IOException if the JSON string is invalid with respect to TickerBookTickerResponse1
     */
    public static TickerBookTickerResponse1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TickerBookTickerResponse1.class);
    }

    /**
     * Convert an instance of TickerBookTickerResponse1 to an JSON string
     *
     * @return JSON string
     */
