...
public class AccountCommissionResponseSpecialCommission {
    ...
    public AccountCommissionResponseSpecialCommission() {}

    public AccountCommissionResponseSpecialCommission maker(
    ...
    public AccountCommissionResponseSpecialCommission taker(
    ...
    public AccountCommissionResponseSpecialCommission buyer(
    ...
    public AccountCommissionResponseSpecialCommission seller(
    ...
    public boolean equals(Object o) {
        ...
        AccountCommissionResponseSpecialCommission accountCommissionResponseSpecialCommission =
                (AccountCommissionResponseSpecialCommission) o;
        return Objects.equals(this.maker, accountCommissionResponseSpecialCommission.maker)
                && Objects.equals(this.taker, accountCommissionResponseSpecialCommission.taker)
                && Objects.equals(this.buyer, accountCommissionResponseSpecialCommission.buyer)
                && Objects.equals(this.seller, accountCommissionResponseSpecialCommission.seller);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountCommissionResponseSpecialCommission {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountCommissionResponseSpecialCommission.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountCommissionResponseSpecialCommission is not found in"
                                    + " the empty JSON string",
                                AccountCommissionResponseSpecialCommission.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountCommissionResponseSpecialCommission.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountCommissionResponseSpecialCommission' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountCommissionResponseSpecialCommission> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountCommissionResponseSpecialCommission.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountCommissionResponseSpecialCommission>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountCommissionResponseSpecialCommission value)
                                throws IOException {
                        ...
                        @Override
                        public AccountCommissionResponseSpecialCommission read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountCommissionResponseSpecialCommission given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountCommissionResponseSpecialCommission
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountCommissionResponseSpecialCommission
     */
    public static AccountCommissionResponseSpecialCommission fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountCommissionResponseSpecialCommission.class);
    }

    /**
     * Convert an instance of AccountCommissionResponseSpecialCommission to an JSON string
     *
     * @return JSON string
     */
