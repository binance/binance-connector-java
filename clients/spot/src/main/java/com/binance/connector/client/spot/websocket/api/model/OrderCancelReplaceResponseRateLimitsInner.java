...
public class OrderCancelReplaceResponseRateLimitsInner extends BaseDTO {
    ...
    public OrderCancelReplaceResponseRateLimitsInner() {}

    public OrderCancelReplaceResponseRateLimitsInner rateLimitType(
    ...
    public OrderCancelReplaceResponseRateLimitsInner interval(
    ...
    public OrderCancelReplaceResponseRateLimitsInner intervalNum(
    ...
    public OrderCancelReplaceResponseRateLimitsInner limit(
    ...
    public OrderCancelReplaceResponseRateLimitsInner count(
    ...
    public boolean equals(Object o) {
        ...
        OrderCancelReplaceResponseRateLimitsInner orderCancelReplaceResponseRateLimitsInner =
                (OrderCancelReplaceResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType, orderCancelReplaceResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, orderCancelReplaceResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, orderCancelReplaceResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, orderCancelReplaceResponseRateLimitsInner.limit)
                && Objects.equals(this.count, orderCancelReplaceResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class OrderCancelReplaceResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrderCancelReplaceResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " OrderCancelReplaceResponseRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                OrderCancelReplaceResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!OrderCancelReplaceResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `OrderCancelReplaceResponseRateLimitsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderCancelReplaceResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'OrderCancelReplaceResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderCancelReplaceResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OrderCancelReplaceResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrderCancelReplaceResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, OrderCancelReplaceResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public OrderCancelReplaceResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of OrderCancelReplaceResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderCancelReplaceResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     OrderCancelReplaceResponseRateLimitsInner
     */
    public static OrderCancelReplaceResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderCancelReplaceResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of OrderCancelReplaceResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
