...
public class AccountCommissionResponseStandardCommission {
    ...
    public AccountCommissionResponseStandardCommission() {}

    public AccountCommissionResponseStandardCommission maker(
    ...
    public AccountCommissionResponseStandardCommission taker(
    ...
    public AccountCommissionResponseStandardCommission buyer(
    ...
    public AccountCommissionResponseStandardCommission seller(
    ...
    public boolean equals(Object o) {
        ...
        AccountCommissionResponseStandardCommission accountCommissionResponseStandardCommission =
                (AccountCommissionResponseStandardCommission) o;
        return Objects.equals(this.maker, accountCommissionResponseStandardCommission.maker)
                && Objects.equals(this.taker, accountCommissionResponseStandardCommission.taker)
                && Objects.equals(this.buyer, accountCommissionResponseStandardCommission.buyer)
                && Objects.equals(this.seller, accountCommissionResponseStandardCommission.seller);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountCommissionResponseStandardCommission {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountCommissionResponseStandardCommission.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountCommissionResponseStandardCommission is not found in"
                                    + " the empty JSON string",
                                AccountCommissionResponseStandardCommission.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountCommissionResponseStandardCommission.openapiFields.contains(
                    entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `AccountCommissionResponseStandardCommission` properties."
                                    + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountCommissionResponseStandardCommission.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountCommissionResponseStandardCommission' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountCommissionResponseStandardCommission> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountCommissionResponseStandardCommission.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountCommissionResponseStandardCommission>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountCommissionResponseStandardCommission value)
                                throws IOException {
                        ...
                        @Override
                        public AccountCommissionResponseStandardCommission read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountCommissionResponseStandardCommission given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountCommissionResponseStandardCommission
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountCommissionResponseStandardCommission
     */
    public static AccountCommissionResponseStandardCommission fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, AccountCommissionResponseStandardCommission.class);
    }

    /**
     * Convert an instance of AccountCommissionResponseStandardCommission to an JSON string
     *
     * @return JSON string
     */
