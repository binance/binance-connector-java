...
public class GetTradesResponseInner {
    ...
    public GetTradesResponseInner id(@jakarta.annotation.Nullable Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetTradesResponseInner price(@jakarta.annotation.Nullable String price) {
        this.price = price;
        return this;
    }
    ...
    public GetTradesResponseInner qty(@jakarta.annotation.Nullable String qty) {
        this.qty = qty;
        return this;
    }
    ...
    public GetTradesResponseInner quoteQty(@jakarta.annotation.Nullable String quoteQty) {
    ...
    public GetTradesResponseInner time(@jakarta.annotation.Nullable Long time) {
        this.time = time;
        return this;
    }
    ...
    public GetTradesResponseInner isBuyerMaker(@jakarta.annotation.Nullable Boolean isBuyerMaker) {
    ...
    public GetTradesResponseInner isBestMatch(@jakarta.annotation.Nullable Boolean isBestMatch) {
    ...
    public boolean equals(Object o) {
        ...
        GetTradesResponseInner getTradesResponseInner = (GetTradesResponseInner) o;
        return Objects.equals(this.id, getTradesResponseInner.id)
                && Objects.equals(this.price, getTradesResponseInner.price)
                && Objects.equals(this.qty, getTradesResponseInner.qty)
                && Objects.equals(this.quoteQty, getTradesResponseInner.quoteQty)
                && Objects.equals(this.time, getTradesResponseInner.time)
                && Objects.equals(this.isBuyerMaker, getTradesResponseInner.isBuyerMaker)
                && Objects.equals(this.isBestMatch, getTradesResponseInner.isBestMatch);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetTradesResponseInner {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetTradesResponseInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetTradesResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetTradesResponseInner is not found in"
                                        + " the empty JSON string",
                                GetTradesResponseInner.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTradesResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTradesResponseInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetTradesResponseInner> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(GetTradesResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetTradesResponseInner>() {
                        @Override
                        public void write(JsonWriter out, GetTradesResponseInner value)
                                throws IOException {
                        ...
                        @Override
                        public GetTradesResponseInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetTradesResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetTradesResponseInner
     * @throws IOException if the JSON string is invalid with respect to GetTradesResponseInner
     */
    public static GetTradesResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetTradesResponseInner.class);
    }

    /**
     * Convert an instance of GetTradesResponseInner to an JSON string
     *
     * @return JSON string
     */
