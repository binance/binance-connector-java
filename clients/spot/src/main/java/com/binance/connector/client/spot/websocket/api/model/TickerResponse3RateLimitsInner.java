...
public class TickerResponse3RateLimitsInner extends BaseDTO {
    ...
    public TickerResponse3RateLimitsInner() {}

    public TickerResponse3RateLimitsInner rateLimitType(
    ...
    public TickerResponse3RateLimitsInner interval(@jakarta.annotation.Nullable String interval) {
    ...
    public TickerResponse3RateLimitsInner intervalNum(
    ...
    public TickerResponse3RateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public TickerResponse3RateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        TickerResponse3RateLimitsInner tickerResponse3RateLimitsInner =
                (TickerResponse3RateLimitsInner) o;
        return Objects.equals(this.rateLimitType, tickerResponse3RateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, tickerResponse3RateLimitsInner.interval)
                && Objects.equals(this.intervalNum, tickerResponse3RateLimitsInner.intervalNum)
                && Objects.equals(this.limit, tickerResponse3RateLimitsInner.limit)
                && Objects.equals(this.count, tickerResponse3RateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class TickerResponse3RateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TickerResponse3RateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TickerResponse3RateLimitsInner is not"
                                        + " found in the empty JSON string",
                                TickerResponse3RateLimitsInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TickerResponse3RateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `TickerResponse3RateLimitsInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TickerResponse3RateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TickerResponse3RateLimitsInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TickerResponse3RateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(TickerResponse3RateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TickerResponse3RateLimitsInner>() {
                        @Override
                        public void write(JsonWriter out, TickerResponse3RateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public TickerResponse3RateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of TickerResponse3RateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TickerResponse3RateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     TickerResponse3RateLimitsInner
     */
    public static TickerResponse3RateLimitsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TickerResponse3RateLimitsInner.class);
    }

    /**
     * Convert an instance of TickerResponse3RateLimitsInner to an JSON string
     *
     * @return JSON string
     */
