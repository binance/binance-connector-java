...
public class TickerResponse2RateLimitsInner extends BaseDTO {
    ...
    public TickerResponse2RateLimitsInner() {}

    public TickerResponse2RateLimitsInner rateLimitType(
    ...
    public TickerResponse2RateLimitsInner interval(@jakarta.annotation.Nullable String interval) {
    ...
    public TickerResponse2RateLimitsInner intervalNum(
    ...
    public TickerResponse2RateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public TickerResponse2RateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        TickerResponse2RateLimitsInner tickerResponse2RateLimitsInner =
                (TickerResponse2RateLimitsInner) o;
        return Objects.equals(this.rateLimitType, tickerResponse2RateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, tickerResponse2RateLimitsInner.interval)
                && Objects.equals(this.intervalNum, tickerResponse2RateLimitsInner.intervalNum)
                && Objects.equals(this.limit, tickerResponse2RateLimitsInner.limit)
                && Objects.equals(this.count, tickerResponse2RateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class TickerResponse2RateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TickerResponse2RateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TickerResponse2RateLimitsInner is not"
                                        + " found in the empty JSON string",
                                TickerResponse2RateLimitsInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TickerResponse2RateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `TickerResponse2RateLimitsInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TickerResponse2RateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TickerResponse2RateLimitsInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TickerResponse2RateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(TickerResponse2RateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TickerResponse2RateLimitsInner>() {
                        @Override
                        public void write(JsonWriter out, TickerResponse2RateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public TickerResponse2RateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of TickerResponse2RateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TickerResponse2RateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     TickerResponse2RateLimitsInner
     */
    public static TickerResponse2RateLimitsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TickerResponse2RateLimitsInner.class);
    }

    /**
     * Convert an instance of TickerResponse2RateLimitsInner to an JSON string
     *
     * @return JSON string
     */
