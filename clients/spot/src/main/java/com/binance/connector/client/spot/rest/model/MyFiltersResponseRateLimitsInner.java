...
public class MyFiltersResponseRateLimitsInner {
    ...
    public MyFiltersResponseRateLimitsInner() {}

    public MyFiltersResponseRateLimitsInner rateLimitType(
    ...
    public MyFiltersResponseRateLimitsInner interval(@jakarta.annotation.Nullable String interval) {
    ...
    public MyFiltersResponseRateLimitsInner intervalNum(
    ...
    public MyFiltersResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public MyFiltersResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        MyFiltersResponseRateLimitsInner myFiltersResponseRateLimitsInner =
                (MyFiltersResponseRateLimitsInner) o;
        return Objects.equals(this.rateLimitType, myFiltersResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, myFiltersResponseRateLimitsInner.interval)
                && Objects.equals(this.intervalNum, myFiltersResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, myFiltersResponseRateLimitsInner.limit)
                && Objects.equals(this.count, myFiltersResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class MyFiltersResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MyFiltersResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in MyFiltersResponseRateLimitsInner is"
                                        + " not found in the empty JSON string",
                                MyFiltersResponseRateLimitsInner.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MyFiltersResponseRateLimitsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MyFiltersResponseRateLimitsInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<MyFiltersResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(MyFiltersResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<MyFiltersResponseRateLimitsInner>() {
                        @Override
                        public void write(JsonWriter out, MyFiltersResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public MyFiltersResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of MyFiltersResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MyFiltersResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     MyFiltersResponseRateLimitsInner
     */
    public static MyFiltersResponseRateLimitsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, MyFiltersResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of MyFiltersResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
