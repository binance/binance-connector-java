...
public class RateLimitOrderResponseInner {
    ...
    public RateLimitOrderResponseInner() {}

    public RateLimitOrderResponseInner rateLimitType(
    ...
    public RateLimitOrderResponseInner interval(@jakarta.annotation.Nullable String interval) {
    ...
    public RateLimitOrderResponseInner intervalNum(@jakarta.annotation.Nullable Long intervalNum) {
    ...
    public RateLimitOrderResponseInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public RateLimitOrderResponseInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        RateLimitOrderResponseInner rateLimitOrderResponseInner = (RateLimitOrderResponseInner) o;
        return Objects.equals(this.rateLimitType, rateLimitOrderResponseInner.rateLimitType)
                && Objects.equals(this.interval, rateLimitOrderResponseInner.interval)
                && Objects.equals(this.intervalNum, rateLimitOrderResponseInner.intervalNum)
                && Objects.equals(this.limit, rateLimitOrderResponseInner.limit)
                && Objects.equals(this.count, rateLimitOrderResponseInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class RateLimitOrderResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RateLimitOrderResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in RateLimitOrderResponseInner is not"
                                        + " found in the empty JSON string",
                                RateLimitOrderResponseInner.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!RateLimitOrderResponseInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `RateLimitOrderResponseInner` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!RateLimitOrderResponseInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'RateLimitOrderResponseInner' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<RateLimitOrderResponseInner> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(RateLimitOrderResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<RateLimitOrderResponseInner>() {
                        @Override
                        ...
                        @Override
                        public RateLimitOrderResponseInner read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of RateLimitOrderResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of RateLimitOrderResponseInner
     * @throws IOException if the JSON string is invalid with respect to RateLimitOrderResponseInner
     */
    public static RateLimitOrderResponseInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, RateLimitOrderResponseInner.class);
    }

    /**
     * Convert an instance of RateLimitOrderResponseInner to an JSON string
     *
     * @return JSON string
     */
