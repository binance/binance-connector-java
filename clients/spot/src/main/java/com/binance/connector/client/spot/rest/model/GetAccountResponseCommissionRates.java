...
public class GetAccountResponseCommissionRates {
    ...
    public GetAccountResponseCommissionRates() {}

    public GetAccountResponseCommissionRates maker(@jakarta.annotation.Nullable String maker) {
        this.maker = maker;
        return this;
    }
    ...
    public GetAccountResponseCommissionRates taker(@jakarta.annotation.Nullable String taker) {
        this.taker = taker;
        return this;
    }
    ...
    public GetAccountResponseCommissionRates buyer(@jakarta.annotation.Nullable String buyer) {
        this.buyer = buyer;
        return this;
    }
    ...
    public GetAccountResponseCommissionRates seller(@jakarta.annotation.Nullable String seller) {
        this.seller = seller;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetAccountResponseCommissionRates getAccountResponseCommissionRates =
                (GetAccountResponseCommissionRates) o;
        return Objects.equals(this.maker, getAccountResponseCommissionRates.maker)
                && Objects.equals(this.taker, getAccountResponseCommissionRates.taker)
                && Objects.equals(this.buyer, getAccountResponseCommissionRates.buyer)
                && Objects.equals(this.seller, getAccountResponseCommissionRates.seller);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetAccountResponseCommissionRates {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetAccountResponseCommissionRates.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetAccountResponseCommissionRates is"
                                        + " not found in the empty JSON string",
                                GetAccountResponseCommissionRates.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetAccountResponseCommissionRates.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `GetAccountResponseCommissionRates` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAccountResponseCommissionRates.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAccountResponseCommissionRates' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetAccountResponseCommissionRates> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetAccountResponseCommissionRates.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetAccountResponseCommissionRates>() {
                        @Override
                        ...
                        @Override
                        public GetAccountResponseCommissionRates read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetAccountResponseCommissionRates given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetAccountResponseCommissionRates
     * @throws IOException if the JSON string is invalid with respect to
     *     GetAccountResponseCommissionRates
     */
    public static GetAccountResponseCommissionRates fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetAccountResponseCommissionRates.class);
    }

    /**
     * Convert an instance of GetAccountResponseCommissionRates to an JSON string
     *
     * @return JSON string
     */
