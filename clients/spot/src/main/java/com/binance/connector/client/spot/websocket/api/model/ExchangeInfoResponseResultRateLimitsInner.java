...
public class ExchangeInfoResponseResultRateLimitsInner extends BaseDTO {
    ...
    public ExchangeInfoResponseResultRateLimitsInner() {}

    public ExchangeInfoResponseResultRateLimitsInner rateLimitType(
    ...
    public ExchangeInfoResponseResultRateLimitsInner interval(
    ...
    public ExchangeInfoResponseResultRateLimitsInner intervalNum(
    ...
    public ExchangeInfoResponseResultRateLimitsInner limit(
    ...
    public boolean equals(Object o) {
        ...
        ExchangeInfoResponseResultRateLimitsInner exchangeInfoResponseResultRateLimitsInner =
                (ExchangeInfoResponseResultRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType, exchangeInfoResponseResultRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, exchangeInfoResponseResultRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, exchangeInfoResponseResultRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, exchangeInfoResponseResultRateLimitsInner.limit);
    }
    ...
    public String toString() {
        ...
        sb.append("class ExchangeInfoResponseResultRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ExchangeInfoResponseResultRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " ExchangeInfoResponseResultRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                ExchangeInfoResponseResultRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!ExchangeInfoResponseResultRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ExchangeInfoResponseResultRateLimitsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExchangeInfoResponseResultRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'ExchangeInfoResponseResultRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ExchangeInfoResponseResultRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ExchangeInfoResponseResultRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ExchangeInfoResponseResultRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, ExchangeInfoResponseResultRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public ExchangeInfoResponseResultRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of ExchangeInfoResponseResultRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ExchangeInfoResponseResultRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     ExchangeInfoResponseResultRateLimitsInner
     */
    public static ExchangeInfoResponseResultRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, ExchangeInfoResponseResultRateLimitsInner.class);
    }

    /**
     * Convert an instance of ExchangeInfoResponseResultRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
