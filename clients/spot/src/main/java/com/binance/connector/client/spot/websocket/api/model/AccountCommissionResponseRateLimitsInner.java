...
public class AccountCommissionResponseRateLimitsInner extends BaseDTO {
    ...
    public AccountCommissionResponseRateLimitsInner() {}

    public AccountCommissionResponseRateLimitsInner rateLimitType(
    ...
    public AccountCommissionResponseRateLimitsInner interval(
    ...
    public AccountCommissionResponseRateLimitsInner intervalNum(
    ...
    public AccountCommissionResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public AccountCommissionResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        AccountCommissionResponseRateLimitsInner accountCommissionResponseRateLimitsInner =
                (AccountCommissionResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType, accountCommissionResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, accountCommissionResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, accountCommissionResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, accountCommissionResponseRateLimitsInner.limit)
                && Objects.equals(this.count, accountCommissionResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountCommissionResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountCommissionResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " AccountCommissionResponseRateLimitsInner is not found in"
                                    + " the empty JSON string",
                                AccountCommissionResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AccountCommissionResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AccountCommissionResponseRateLimitsInner` properties."
                                        + " JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountCommissionResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'AccountCommissionResponseRateLimitsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccountCommissionResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AccountCommissionResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AccountCommissionResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, AccountCommissionResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public AccountCommissionResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AccountCommissionResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountCommissionResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AccountCommissionResponseRateLimitsInner
     */
    public static AccountCommissionResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, AccountCommissionResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of AccountCommissionResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
