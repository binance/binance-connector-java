...
public class Ticker24hrResponse2Result extends BaseDTO {
    ...
    public Ticker24hrResponse2Result() {}

    public Ticker24hrResponse2Result symbol(@jakarta.annotation.Nullable String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public Ticker24hrResponse2Result openPrice(@jakarta.annotation.Nullable String openPrice) {
    ...
    public Ticker24hrResponse2Result highPrice(@jakarta.annotation.Nullable String highPrice) {
    ...
    public Ticker24hrResponse2Result lowPrice(@jakarta.annotation.Nullable String lowPrice) {
    ...
    public Ticker24hrResponse2Result lastPrice(@jakarta.annotation.Nullable String lastPrice) {
    ...
    public Ticker24hrResponse2Result volume(@jakarta.annotation.Nullable String volume) {
        this.volume = volume;
        return this;
    }
    ...
    public Ticker24hrResponse2Result quoteVolume(@jakarta.annotation.Nullable String quoteVolume) {
    ...
    public Ticker24hrResponse2Result openTime(@jakarta.annotation.Nullable Long openTime) {
    ...
    public Ticker24hrResponse2Result closeTime(@jakarta.annotation.Nullable Long closeTime) {
    ...
    public Ticker24hrResponse2Result firstId(@jakarta.annotation.Nullable Long firstId) {
    ...
    public Ticker24hrResponse2Result lastId(@jakarta.annotation.Nullable Long lastId) {
        this.lastId = lastId;
        return this;
    }
    ...
    public Ticker24hrResponse2Result count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Ticker24hrResponse2Result ticker24hrResponse2Result = (Ticker24hrResponse2Result) o;
        return Objects.equals(this.symbol, ticker24hrResponse2Result.symbol)
                && Objects.equals(this.openPrice, ticker24hrResponse2Result.openPrice)
                && Objects.equals(this.highPrice, ticker24hrResponse2Result.highPrice)
                && Objects.equals(this.lowPrice, ticker24hrResponse2Result.lowPrice)
                && Objects.equals(this.lastPrice, ticker24hrResponse2Result.lastPrice)
                && Objects.equals(this.volume, ticker24hrResponse2Result.volume)
                && Objects.equals(this.quoteVolume, ticker24hrResponse2Result.quoteVolume)
                && Objects.equals(this.openTime, ticker24hrResponse2Result.openTime)
                && Objects.equals(this.closeTime, ticker24hrResponse2Result.closeTime)
                && Objects.equals(this.firstId, ticker24hrResponse2Result.firstId)
                && Objects.equals(this.lastId, ticker24hrResponse2Result.lastId)
                && Objects.equals(this.count, ticker24hrResponse2Result.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class Ticker24hrResponse2Result {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to Ticker24hrResponse2Result
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Ticker24hrResponse2Result.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Ticker24hrResponse2Result is not found"
                                        + " in the empty JSON string",
                                Ticker24hrResponse2Result.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!Ticker24hrResponse2Result.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Ticker24hrResponse2Result` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Ticker24hrResponse2Result.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Ticker24hrResponse2Result' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Ticker24hrResponse2Result> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(Ticker24hrResponse2Result.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<Ticker24hrResponse2Result>() {
                        @Override
                        public void write(JsonWriter out, Ticker24hrResponse2Result value)
                                throws IOException {
                        ...
                        @Override
                        public Ticker24hrResponse2Result read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of Ticker24hrResponse2Result given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Ticker24hrResponse2Result
     * @throws IOException if the JSON string is invalid with respect to Ticker24hrResponse2Result
     */
    public static Ticker24hrResponse2Result fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Ticker24hrResponse2Result.class);
    }

    /**
     * Convert an instance of Ticker24hrResponse2Result to an JSON string
     *
     * @return JSON string
     */
