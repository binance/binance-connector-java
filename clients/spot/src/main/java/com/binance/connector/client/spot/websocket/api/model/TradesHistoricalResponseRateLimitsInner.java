...
public class TradesHistoricalResponseRateLimitsInner extends BaseDTO {
    ...
    public TradesHistoricalResponseRateLimitsInner() {}

    public TradesHistoricalResponseRateLimitsInner rateLimitType(
    ...
    public TradesHistoricalResponseRateLimitsInner interval(
    ...
    public TradesHistoricalResponseRateLimitsInner intervalNum(
    ...
    public TradesHistoricalResponseRateLimitsInner limit(@jakarta.annotation.Nullable Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public TradesHistoricalResponseRateLimitsInner count(@jakarta.annotation.Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        TradesHistoricalResponseRateLimitsInner tradesHistoricalResponseRateLimitsInner =
                (TradesHistoricalResponseRateLimitsInner) o;
        return Objects.equals(
                        this.rateLimitType, tradesHistoricalResponseRateLimitsInner.rateLimitType)
                && Objects.equals(this.interval, tradesHistoricalResponseRateLimitsInner.interval)
                && Objects.equals(
                        this.intervalNum, tradesHistoricalResponseRateLimitsInner.intervalNum)
                && Objects.equals(this.limit, tradesHistoricalResponseRateLimitsInner.limit)
                && Objects.equals(this.count, tradesHistoricalResponseRateLimitsInner.count);
    }
    ...
    public String toString() {
        ...
        sb.append("class TradesHistoricalResponseRateLimitsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TradesHistoricalResponseRateLimitsInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " TradesHistoricalResponseRateLimitsInner is not found in the"
                                    + " empty JSON string",
                                TradesHistoricalResponseRateLimitsInner.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TradesHistoricalResponseRateLimitsInner.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `TradesHistoricalResponseRateLimitsInner` properties. JSON:"
                                    + " %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TradesHistoricalResponseRateLimitsInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes 'TradesHistoricalResponseRateLimitsInner'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TradesHistoricalResponseRateLimitsInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(TradesHistoricalResponseRateLimitsInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TradesHistoricalResponseRateLimitsInner>() {
                        @Override
                        public void write(
                                JsonWriter out, TradesHistoricalResponseRateLimitsInner value)
                                throws IOException {
                        ...
                        @Override
                        public TradesHistoricalResponseRateLimitsInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of TradesHistoricalResponseRateLimitsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TradesHistoricalResponseRateLimitsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     TradesHistoricalResponseRateLimitsInner
     */
    public static TradesHistoricalResponseRateLimitsInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, TradesHistoricalResponseRateLimitsInner.class);
    }

    /**
     * Convert an instance of TradesHistoricalResponseRateLimitsInner to an JSON string
     *
     * @return JSON string
     */
