...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-spot)](https://central.sonatype.com/artifact/io.github.binance/binance-spot)
...
- [REST API](./src/main/java/com/binance/connector/client/spot/rest/api)
- [Websocket API](./src/main/java/com/binance/connector/client/spot/websocket/api)
- [Websocket Stream](./src/main/java/com/binance/connector/client/spot/websocket/stream)
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/spot/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/spot/src/main/java/com/binance/connector/client/spot/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl spot test
```
