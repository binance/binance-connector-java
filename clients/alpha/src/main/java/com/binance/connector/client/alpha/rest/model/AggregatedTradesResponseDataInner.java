...
public class AggregatedTradesResponseDataInner {
    ...
    public AggregatedTradesResponseDataInner() {}

    public AggregatedTradesResponseDataInner aLowerCase(
    ...
    public AggregatedTradesResponseDataInner pLowerCase(
    ...
    public AggregatedTradesResponseDataInner qLowerCase(
    ...
    public AggregatedTradesResponseDataInner fLowerCase(
    ...
    public AggregatedTradesResponseDataInner lLowerCase(
    ...
    public AggregatedTradesResponseDataInner T(@jakarta.annotation.Nullable Long T) {
        this.T = T;
        return this;
    }
    ...
    public AggregatedTradesResponseDataInner mLowerCase(
    ...
    public boolean equals(Object o) {
        ...
        AggregatedTradesResponseDataInner aggregatedTradesResponseDataInner =
                (AggregatedTradesResponseDataInner) o;
        return Objects.equals(this.aLowerCase, aggregatedTradesResponseDataInner.aLowerCase)
                && Objects.equals(this.pLowerCase, aggregatedTradesResponseDataInner.pLowerCase)
                && Objects.equals(this.qLowerCase, aggregatedTradesResponseDataInner.qLowerCase)
                && Objects.equals(this.fLowerCase, aggregatedTradesResponseDataInner.fLowerCase)
                && Objects.equals(this.lLowerCase, aggregatedTradesResponseDataInner.lLowerCase)
                && Objects.equals(this.T, aggregatedTradesResponseDataInner.T)
                && Objects.equals(this.mLowerCase, aggregatedTradesResponseDataInner.mLowerCase);
    }
    ...
    public String toString() {
        ...
        sb.append("class AggregatedTradesResponseDataInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AggregatedTradesResponseDataInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AggregatedTradesResponseDataInner is"
                                        + " not found in the empty JSON string",
                                AggregatedTradesResponseDataInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AggregatedTradesResponseDataInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AggregatedTradesResponseDataInner' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AggregatedTradesResponseDataInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AggregatedTradesResponseDataInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AggregatedTradesResponseDataInner>() {
                        @Override
                        public void write(JsonWriter out, AggregatedTradesResponseDataInner value)
                                throws IOException {
                        ...
                        @Override
                        public AggregatedTradesResponseDataInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of AggregatedTradesResponseDataInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AggregatedTradesResponseDataInner
     * @throws IOException if the JSON string is invalid with respect to
     *     AggregatedTradesResponseDataInner
     */
    public static AggregatedTradesResponseDataInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AggregatedTradesResponseDataInner.class);
    }

    /**
     * Convert an instance of AggregatedTradesResponseDataInner to an JSON string
     *
     * @return JSON string
     */
