...
public class KlinesResponseDataItem extends ArrayList<String> {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<KlinesResponseDataItem> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(KlinesResponseDataItem.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<KlinesResponseDataItem>() {
                        @Override
