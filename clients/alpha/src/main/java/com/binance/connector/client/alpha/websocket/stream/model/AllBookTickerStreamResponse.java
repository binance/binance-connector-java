...
public class AllBookTickerStreamResponse extends BaseDTO {
    ...
    public AllBookTickerStreamResponse() {}

    public AllBookTickerStreamResponse eLowerCase(@jakarta.annotation.Nullable String eLowerCase) {
    ...
    public AllBookTickerStreamResponse E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public AllBookTickerStreamResponse T(@jakarta.annotation.Nullable Long T) {
        this.T = T;
        return this;
    }
    ...
    public AllBookTickerStreamResponse uLowerCase(@jakarta.annotation.Nullable Long uLowerCase) {
    ...
    public AllBookTickerStreamResponse sLowerCase(@jakarta.annotation.Nullable String sLowerCase) {
    ...
    public AllBookTickerStreamResponse bLowerCase(@jakarta.annotation.Nullable String bLowerCase) {
    ...
    public AllBookTickerStreamResponse B(@jakarta.annotation.Nullable String B) {
        this.B = B;
        return this;
    }
    ...
    public AllBookTickerStreamResponse aLowerCase(@jakarta.annotation.Nullable String aLowerCase) {
    ...
    public AllBookTickerStreamResponse A(@jakarta.annotation.Nullable String A) {
        this.A = A;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        AllBookTickerStreamResponse allBookTickerStreamResponse = (AllBookTickerStreamResponse) o;
        return Objects.equals(this.eLowerCase, allBookTickerStreamResponse.eLowerCase)
                && Objects.equals(this.E, allBookTickerStreamResponse.E)
                && Objects.equals(this.T, allBookTickerStreamResponse.T)
                && Objects.equals(this.uLowerCase, allBookTickerStreamResponse.uLowerCase)
                && Objects.equals(this.sLowerCase, allBookTickerStreamResponse.sLowerCase)
                && Objects.equals(this.bLowerCase, allBookTickerStreamResponse.bLowerCase)
                && Objects.equals(this.B, allBookTickerStreamResponse.B)
                && Objects.equals(this.aLowerCase, allBookTickerStreamResponse.aLowerCase)
                && Objects.equals(this.A, allBookTickerStreamResponse.A);
    }

    @Override
    public int hashCode() {
        return Objects.hash(eLowerCase, E, T, uLowerCase, sLowerCase, bLowerCase, B, aLowerCase, A);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class AllBookTickerStreamResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AllBookTickerStreamResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AllBookTickerStreamResponse is not"
                                        + " found in the empty JSON string",
                                AllBookTickerStreamResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AllBookTickerStreamResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AllBookTickerStreamResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AllBookTickerStreamResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AllBookTickerStreamResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AllBookTickerStreamResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(AllBookTickerStreamResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AllBookTickerStreamResponse>() {
                        @Override
                        public void write(JsonWriter out, AllBookTickerStreamResponse value)
                                throws IOException {
                        ...
                        @Override
                        public AllBookTickerStreamResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of AllBookTickerStreamResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AllBookTickerStreamResponse
     * @throws IOException if the JSON string is invalid with respect to AllBookTickerStreamResponse
     */
    public static AllBookTickerStreamResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AllBookTickerStreamResponse.class);
    }

    /**
     * Convert an instance of AllBookTickerStreamResponse to an JSON string
     *
     * @return JSON string
     */
