...
public class MiniTickerStreamResponse extends BaseDTO {
    ...
    public MiniTickerStreamResponse eLowerCase(@jakarta.annotation.Nullable String eLowerCase) {
    ...
    public MiniTickerStreamResponse E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public MiniTickerStreamResponse sLowerCase(@jakarta.annotation.Nullable String sLowerCase) {
    ...
    public MiniTickerStreamResponse cLowerCase(@jakarta.annotation.Nullable String cLowerCase) {
    ...
    public MiniTickerStreamResponse oLowerCase(@jakarta.annotation.Nullable String oLowerCase) {
    ...
    public MiniTickerStreamResponse hLowerCase(@jakarta.annotation.Nullable String hLowerCase) {
    ...
    public MiniTickerStreamResponse lLowerCase(@jakarta.annotation.Nullable String lLowerCase) {
    ...
    public MiniTickerStreamResponse vLowerCase(@jakarta.annotation.Nullable String vLowerCase) {
    ...
    public MiniTickerStreamResponse qLowerCase(@jakarta.annotation.Nullable String qLowerCase) {
    ...
    public boolean equals(Object o) {
        ...
        MiniTickerStreamResponse miniTickerStreamResponse = (MiniTickerStreamResponse) o;
        return Objects.equals(this.eLowerCase, miniTickerStreamResponse.eLowerCase)
                && Objects.equals(this.E, miniTickerStreamResponse.E)
                && Objects.equals(this.sLowerCase, miniTickerStreamResponse.sLowerCase)
                && Objects.equals(this.cLowerCase, miniTickerStreamResponse.cLowerCase)
                && Objects.equals(this.oLowerCase, miniTickerStreamResponse.oLowerCase)
                && Objects.equals(this.hLowerCase, miniTickerStreamResponse.hLowerCase)
                && Objects.equals(this.lLowerCase, miniTickerStreamResponse.lLowerCase)
                && Objects.equals(this.vLowerCase, miniTickerStreamResponse.vLowerCase)
                && Objects.equals(this.qLowerCase, miniTickerStreamResponse.qLowerCase);
    }
    ...
    public String toString() {
        ...
        sb.append("class MiniTickerStreamResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to MiniTickerStreamResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MiniTickerStreamResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in MiniTickerStreamResponse is not found"
                                        + " in the empty JSON string",
                                MiniTickerStreamResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!MiniTickerStreamResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `MiniTickerStreamResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MiniTickerStreamResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MiniTickerStreamResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<MiniTickerStreamResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(MiniTickerStreamResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<MiniTickerStreamResponse>() {
                        @Override
                        public void write(JsonWriter out, MiniTickerStreamResponse value)
                                throws IOException {
                        ...
                        @Override
                        public MiniTickerStreamResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of MiniTickerStreamResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MiniTickerStreamResponse
     * @throws IOException if the JSON string is invalid with respect to MiniTickerStreamResponse
     */
    public static MiniTickerStreamResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, MiniTickerStreamResponse.class);
    }

    /**
     * Convert an instance of MiniTickerStreamResponse to an JSON string
     *
     * @return JSON string
     */
