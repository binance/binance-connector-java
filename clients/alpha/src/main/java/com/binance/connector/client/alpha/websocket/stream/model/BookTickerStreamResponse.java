...
public class BookTickerStreamResponse extends BaseDTO {
    ...
    public BookTickerStreamResponse eLowerCase(@jakarta.annotation.Nullable String eLowerCase) {
    ...
    public BookTickerStreamResponse E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public BookTickerStreamResponse T(@jakarta.annotation.Nullable Long T) {
        this.T = T;
        return this;
    }
    ...
    public BookTickerStreamResponse uLowerCase(@jakarta.annotation.Nullable Long uLowerCase) {
    ...
    public BookTickerStreamResponse sLowerCase(@jakarta.annotation.Nullable String sLowerCase) {
    ...
    public BookTickerStreamResponse bLowerCase(@jakarta.annotation.Nullable String bLowerCase) {
    ...
    public BookTickerStreamResponse B(@jakarta.annotation.Nullable String B) {
        this.B = B;
        return this;
    }
    ...
    public BookTickerStreamResponse aLowerCase(@jakarta.annotation.Nullable String aLowerCase) {
    ...
    public BookTickerStreamResponse A(@jakarta.annotation.Nullable String A) {
        this.A = A;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        BookTickerStreamResponse bookTickerStreamResponse = (BookTickerStreamResponse) o;
        return Objects.equals(this.eLowerCase, bookTickerStreamResponse.eLowerCase)
                && Objects.equals(this.E, bookTickerStreamResponse.E)
                && Objects.equals(this.T, bookTickerStreamResponse.T)
                && Objects.equals(this.uLowerCase, bookTickerStreamResponse.uLowerCase)
                && Objects.equals(this.sLowerCase, bookTickerStreamResponse.sLowerCase)
                && Objects.equals(this.bLowerCase, bookTickerStreamResponse.bLowerCase)
                && Objects.equals(this.B, bookTickerStreamResponse.B)
                && Objects.equals(this.aLowerCase, bookTickerStreamResponse.aLowerCase)
                && Objects.equals(this.A, bookTickerStreamResponse.A);
    }
    ...
    public String toString() {
        ...
        sb.append("class BookTickerStreamResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to BookTickerStreamResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!BookTickerStreamResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in BookTickerStreamResponse is not found"
                                        + " in the empty JSON string",
                                BookTickerStreamResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!BookTickerStreamResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `BookTickerStreamResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BookTickerStreamResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BookTickerStreamResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<BookTickerStreamResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(BookTickerStreamResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<BookTickerStreamResponse>() {
                        @Override
                        public void write(JsonWriter out, BookTickerStreamResponse value)
                                throws IOException {
                        ...
                        @Override
                        public BookTickerStreamResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of BookTickerStreamResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of BookTickerStreamResponse
     * @throws IOException if the JSON string is invalid with respect to BookTickerStreamResponse
     */
    public static BookTickerStreamResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, BookTickerStreamResponse.class);
    }

    /**
     * Convert an instance of BookTickerStreamResponse to an JSON string
     *
     * @return JSON string
     */
