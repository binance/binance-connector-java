...
public class AggregateTradeStreamResponse extends BaseDTO {
    ...
    public AggregateTradeStreamResponse eLowerCase(@jakarta.annotation.Nullable String eLowerCase) {
    ...
    public AggregateTradeStreamResponse E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public AggregateTradeStreamResponse T(@jakarta.annotation.Nullable Long T) {
        this.T = T;
        return this;
    }
    ...
    public AggregateTradeStreamResponse aLowerCase(@jakarta.annotation.Nullable Long aLowerCase) {
    ...
    public AggregateTradeStreamResponse fLowerCase(@jakarta.annotation.Nullable Long fLowerCase) {
    ...
    public AggregateTradeStreamResponse lLowerCase(@jakarta.annotation.Nullable Long lLowerCase) {
    ...
    public AggregateTradeStreamResponse mLowerCase(
    ...
    public AggregateTradeStreamResponse pLowerCase(@jakarta.annotation.Nullable String pLowerCase) {
    ...
    public AggregateTradeStreamResponse qLowerCase(@jakarta.annotation.Nullable String qLowerCase) {
    ...
    public AggregateTradeStreamResponse sLowerCase(@jakarta.annotation.Nullable String sLowerCase) {
    ...
    public boolean equals(Object o) {
        ...
        AggregateTradeStreamResponse aggregateTradeStreamResponse =
                (AggregateTradeStreamResponse) o;
        return Objects.equals(this.eLowerCase, aggregateTradeStreamResponse.eLowerCase)
                && Objects.equals(this.E, aggregateTradeStreamResponse.E)
                && Objects.equals(this.T, aggregateTradeStreamResponse.T)
                && Objects.equals(this.aLowerCase, aggregateTradeStreamResponse.aLowerCase)
                && Objects.equals(this.fLowerCase, aggregateTradeStreamResponse.fLowerCase)
                && Objects.equals(this.lLowerCase, aggregateTradeStreamResponse.lLowerCase)
                && Objects.equals(this.mLowerCase, aggregateTradeStreamResponse.mLowerCase)
                && Objects.equals(this.pLowerCase, aggregateTradeStreamResponse.pLowerCase)
                && Objects.equals(this.qLowerCase, aggregateTradeStreamResponse.qLowerCase)
                && Objects.equals(this.sLowerCase, aggregateTradeStreamResponse.sLowerCase);
    }
    ...
    public String toString() {
        ...
        sb.append("class AggregateTradeStreamResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AggregateTradeStreamResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AggregateTradeStreamResponse is not"
                                        + " found in the empty JSON string",
                                AggregateTradeStreamResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AggregateTradeStreamResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AggregateTradeStreamResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AggregateTradeStreamResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AggregateTradeStreamResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AggregateTradeStreamResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AggregateTradeStreamResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AggregateTradeStreamResponse>() {
                        @Override
                        public void write(JsonWriter out, AggregateTradeStreamResponse value)
                                throws IOException {
                        ...
                        @Override
                        public AggregateTradeStreamResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of AggregateTradeStreamResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AggregateTradeStreamResponse
     * @throws IOException if the JSON string is invalid with respect to
     *     AggregateTradeStreamResponse
     */
    public static AggregateTradeStreamResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AggregateTradeStreamResponse.class);
    }

    /**
     * Convert an instance of AggregateTradeStreamResponse to an JSON string
     *
     * @return JSON string
     */
