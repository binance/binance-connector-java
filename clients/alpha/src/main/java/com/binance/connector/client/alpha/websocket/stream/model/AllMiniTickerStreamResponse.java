...
public class AllMiniTickerStreamResponse extends BaseDTO {
    ...
    public AllMiniTickerStreamResponse eLowerCase(@jakarta.annotation.Nullable String eLowerCase) {
    ...
    public AllMiniTickerStreamResponse E(@jakarta.annotation.Nullable Long E) {
        this.E = E;
        return this;
    }
    ...
    public AllMiniTickerStreamResponse sLowerCase(@jakarta.annotation.Nullable String sLowerCase) {
    ...
    public AllMiniTickerStreamResponse cLowerCase(@jakarta.annotation.Nullable String cLowerCase) {
    ...
    public AllMiniTickerStreamResponse oLowerCase(@jakarta.annotation.Nullable String oLowerCase) {
    ...
    public AllMiniTickerStreamResponse hLowerCase(@jakarta.annotation.Nullable String hLowerCase) {
    ...
    public AllMiniTickerStreamResponse lLowerCase(@jakarta.annotation.Nullable String lLowerCase) {
    ...
    public AllMiniTickerStreamResponse vLowerCase(@jakarta.annotation.Nullable String vLowerCase) {
    ...
    public AllMiniTickerStreamResponse qLowerCase(@jakarta.annotation.Nullable String qLowerCase) {
    ...
    public boolean equals(Object o) {
        ...
        AllMiniTickerStreamResponse allMiniTickerStreamResponse = (AllMiniTickerStreamResponse) o;
        return Objects.equals(this.eLowerCase, allMiniTickerStreamResponse.eLowerCase)
                && Objects.equals(this.E, allMiniTickerStreamResponse.E)
                && Objects.equals(this.sLowerCase, allMiniTickerStreamResponse.sLowerCase)
                && Objects.equals(this.cLowerCase, allMiniTickerStreamResponse.cLowerCase)
                && Objects.equals(this.oLowerCase, allMiniTickerStreamResponse.oLowerCase)
                && Objects.equals(this.hLowerCase, allMiniTickerStreamResponse.hLowerCase)
                && Objects.equals(this.lLowerCase, allMiniTickerStreamResponse.lLowerCase)
                && Objects.equals(this.vLowerCase, allMiniTickerStreamResponse.vLowerCase)
                && Objects.equals(this.qLowerCase, allMiniTickerStreamResponse.qLowerCase);
    }
    ...
    public String toString() {
        ...
        sb.append("class AllMiniTickerStreamResponse {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AllMiniTickerStreamResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AllMiniTickerStreamResponse is not"
                                        + " found in the empty JSON string",
                                AllMiniTickerStreamResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!AllMiniTickerStreamResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AllMiniTickerStreamResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AllMiniTickerStreamResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AllMiniTickerStreamResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AllMiniTickerStreamResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(AllMiniTickerStreamResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AllMiniTickerStreamResponse>() {
                        @Override
                        public void write(JsonWriter out, AllMiniTickerStreamResponse value)
                                throws IOException {
                        ...
                        @Override
                        public AllMiniTickerStreamResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of AllMiniTickerStreamResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AllMiniTickerStreamResponse
     * @throws IOException if the JSON string is invalid with respect to AllMiniTickerStreamResponse
     */
    public static AllMiniTickerStreamResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AllMiniTickerStreamResponse.class);
    }

    /**
     * Convert an instance of AllMiniTickerStreamResponse to an JSON string
     *
     * @return JSON string
     */
