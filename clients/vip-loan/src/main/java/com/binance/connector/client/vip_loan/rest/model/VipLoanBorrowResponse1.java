...
public class VipLoanBorrowResponse1 {
    ...
    public VipLoanBorrowResponse1() {}

    public VipLoanBorrowResponse1 loanAccountId(@jakarta.annotation.Nullable String loanAccountId) {
    ...
    public VipLoanBorrowResponse1 requestId(@jakarta.annotation.Nullable String requestId) {
    ...
    public VipLoanBorrowResponse1 loanCoin(@jakarta.annotation.Nullable String loanCoin) {
    ...
    public VipLoanBorrowResponse1 isFlexibleRate(
    ...
    public VipLoanBorrowResponse1 loanAmount(@jakarta.annotation.Nullable String loanAmount) {
    ...
    public VipLoanBorrowResponse1 collateralAccountId(
    ...
    public VipLoanBorrowResponse1 collateralCoin(
    ...
    public VipLoanBorrowResponse1 loanTerm(@jakarta.annotation.Nullable String loanTerm) {
    ...
    public boolean equals(Object o) {
        ...
        VipLoanBorrowResponse1 vipLoanBorrowResponse1 = (VipLoanBorrowResponse1) o;
        return Objects.equals(this.loanAccountId, vipLoanBorrowResponse1.loanAccountId)
                && Objects.equals(this.requestId, vipLoanBorrowResponse1.requestId)
                && Objects.equals(this.loanCoin, vipLoanBorrowResponse1.loanCoin)
                && Objects.equals(this.isFlexibleRate, vipLoanBorrowResponse1.isFlexibleRate)
                && Objects.equals(this.loanAmount, vipLoanBorrowResponse1.loanAmount)
                && Objects.equals(
                        this.collateralAccountId, vipLoanBorrowResponse1.collateralAccountId)
                && Objects.equals(this.collateralCoin, vipLoanBorrowResponse1.collateralCoin)
                && Objects.equals(this.loanTerm, vipLoanBorrowResponse1.loanTerm);
    }
    ...
    public String toString() {
        ...
        sb.append("class VipLoanBorrowResponse1 {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to VipLoanBorrowResponse1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!VipLoanBorrowResponse1.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in VipLoanBorrowResponse1 is not found in"
                                        + " the empty JSON string",
                                VipLoanBorrowResponse1.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!VipLoanBorrowResponse1.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `VipLoanBorrowResponse1` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!VipLoanBorrowResponse1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'VipLoanBorrowResponse1' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<VipLoanBorrowResponse1> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(VipLoanBorrowResponse1.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<VipLoanBorrowResponse1>() {
                        @Override
                        public void write(JsonWriter out, VipLoanBorrowResponse1 value)
                                throws IOException {
                        ...
                        @Override
                        public VipLoanBorrowResponse1 read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of VipLoanBorrowResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of VipLoanBorrowResponse1
     * @throws IOException if the JSON string is invalid with respect to VipLoanBorrowResponse1
     */
    public static VipLoanBorrowResponse1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, VipLoanBorrowResponse1.class);
    }

    /**
     * Convert an instance of VipLoanBorrowResponse1 to an JSON string
     *
     * @return JSON string
     */
