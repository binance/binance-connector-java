# Binance Java VipLoan Connector
...
More examples can be found in the [`examples/rest-api`](./examples/vip-loan/src/main/java/com/binance/connector/client/vip-loan/rest) folder.
