# Binance Java Vip Loan Connector
...
[![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-vip-loan)](https://central.sonatype.com/artifact/io.github.binance/binance-vip-loan)
...
- [REST API](./src/main/java/com/binance/connector/client/vip_loan/rest/api)
...
<dependency>
  ...
  <artifactId>binance-vip-loan</artifactId>
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/vip_loan/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/vip-loan/src/main/java/com/binance/connector/client/vip_loan/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl vip-loan test
```
