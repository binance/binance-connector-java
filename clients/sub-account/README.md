# Binance Java SubAccount Connector
...
![Maven Central Version](https://img.shields.io/maven-central/v/io.github.binance/binance-sub-account)
...
More examples can be found in the [`examples/rest-api`](./examples/sub-account/src/main/java/com/binance/connector/client/sub-account/rest) folder.
...
```bash
mvn -f clients/pom.xml -pl sub-account
```
