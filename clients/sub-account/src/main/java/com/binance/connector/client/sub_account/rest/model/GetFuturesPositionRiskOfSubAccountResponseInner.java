...
public class GetFuturesPositionRiskOfSubAccountResponseInner {
    ...
    public GetFuturesPositionRiskOfSubAccountResponseInner() {}

    public GetFuturesPositionRiskOfSubAccountResponseInner entryPrice(
    ...
    public GetFuturesPositionRiskOfSubAccountResponseInner leverage(
    ...
    public GetFuturesPositionRiskOfSubAccountResponseInner maxNotional(
    ...
    public GetFuturesPositionRiskOfSubAccountResponseInner liquidationPrice(
    ...
    public GetFuturesPositionRiskOfSubAccountResponseInner positionAmount(
    ...
    public GetFuturesPositionRiskOfSubAccountResponseInner symbol(
    ...
    public GetFuturesPositionRiskOfSubAccountResponseInner unrealizedProfit(
    ...
    public boolean equals(Object o) {
        ...
        GetFuturesPositionRiskOfSubAccountResponseInner
                getFuturesPositionRiskOfSubAccountResponseInner =
                        (GetFuturesPositionRiskOfSubAccountResponseInner) o;
        return Objects.equals(
                        this.entryPrice, getFuturesPositionRiskOfSubAccountResponseInner.entryPrice)
                && Objects.equals(
                        this.leverage, getFuturesPositionRiskOfSubAccountResponseInner.leverage)
                && Objects.equals(
                        this.maxNotional,
                        getFuturesPositionRiskOfSubAccountResponseInner.maxNotional)
                && Objects.equals(
                        this.liquidationPrice,
                        getFuturesPositionRiskOfSubAccountResponseInner.liquidationPrice)
                && Objects.equals(
                        this.markPrice, getFuturesPositionRiskOfSubAccountResponseInner.markPrice)
                && Objects.equals(
                        this.positionAmount,
                        getFuturesPositionRiskOfSubAccountResponseInner.positionAmount)
                && Objects.equals(
                        this.symbol, getFuturesPositionRiskOfSubAccountResponseInner.symbol)
                && Objects.equals(
                        this.unrealizedProfit,
                        getFuturesPositionRiskOfSubAccountResponseInner.unrealizedProfit);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetFuturesPositionRiskOfSubAccountResponseInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetFuturesPositionRiskOfSubAccountResponseInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                        + " GetFuturesPositionRiskOfSubAccountResponseInner is not"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFuturesPositionRiskOfSubAccountResponseInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'GetFuturesPositionRiskOfSubAccountResponseInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetFuturesPositionRiskOfSubAccountResponseInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(GetFuturesPositionRiskOfSubAccountResponseInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetFuturesPositionRiskOfSubAccountResponseInner>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                GetFuturesPositionRiskOfSubAccountResponseInner value)
                                throws IOException {
                        ...
                        @Override
                        public GetFuturesPositionRiskOfSubAccountResponseInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetFuturesPositionRiskOfSubAccountResponseInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetFuturesPositionRiskOfSubAccountResponseInner
     * @throws IOException if the JSON string is invalid with respect to
     *     GetFuturesPositionRiskOfSubAccountResponseInner
     */
    public static GetFuturesPositionRiskOfSubAccountResponseInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, GetFuturesPositionRiskOfSubAccountResponseInner.class);
    }

    /**
     * Convert an instance of GetFuturesPositionRiskOfSubAccountResponseInner to an JSON string
     *
     * @return JSON string
     */
