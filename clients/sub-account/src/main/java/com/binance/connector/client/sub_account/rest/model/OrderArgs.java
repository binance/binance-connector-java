...
public class OrderArgs extends ArrayList<Object> {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderArgs.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderArgs' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrderArgs> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OrderArgs.class));
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<OrderArgs>() {
                        ...
                        @Override
                        public OrderArgs read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of OrderArgs given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderArgs
     * @throws IOException if the JSON string is invalid with respect to OrderArgs
     */
    public static OrderArgs fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderArgs.class);
    }

    /**
     * Convert an instance of OrderArgs to an JSON string
     *
     * @return JSON string
     */
