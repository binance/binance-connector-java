...
public class QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner {
    ...
    public QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner() {}

    public QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner asset(
    ...
    public QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner borrowed(
    ...
    public QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner free(
    ...
    public QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner interest(
    ...
    public QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner locked(
    ...
    public QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner netAsset(
    ...
    public boolean equals(Object o) {
        ...
        QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner
                queryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner =
                        (QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner) o;
        return Objects.equals(
                        this.asset,
                        queryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.asset)
                && Objects.equals(
                        this.borrowed,
                        queryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.borrowed)
                && Objects.equals(
                        this.free,
                        queryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.free)
                && Objects.equals(
                        this.interest,
                        queryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.interest)
                && Objects.equals(
                        this.locked,
                        queryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.locked)
                && Objects.equals(
                        this.netAsset,
                        queryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.netAsset);
    }
    ...
    public String toString() {
        ...
        sb.append("class QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.openapiFields
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.class
            ...
            final TypeAdapter<QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner>
                    thisAdapter =
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<
                        ...
                        @Override
                        public QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner read(
    ...
    /**
     * Create an instance of QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner given
     * an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner
     * @throws IOException if the JSON string is invalid with respect to
     *     QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner
     */
    public static QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner fromJson(
            String jsonString) throws IOException {
        return JSON.getGson()
                .fromJson(
                        jsonString,
                        QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner.class);
    }

    /**
     * Convert an instance of QueryManagedSubAccountMarginAssetDetailsResponseUserAssetsInner to an
     * JSON string
     *
     * @return JSON string
     */
