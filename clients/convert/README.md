# Binance Java Convert Connector
...
- [REST API](./src/main/java/com/binance/connector/client/convert/rest/api)
...
All REST API endpoints are available through the [`rest`](./src/main/java/com/binance/connector/client/convert/rest) module. Note that some endpoints require authentication using your Binance API credentials.
...
More examples can be found in the [`examples/rest`](./../../examples/convert/src/main/java/com/binance/connector/client/convert/rest) folder.
