...
public class GetConvertTradeHistoryResponseListInner {
    ...
    public GetConvertTradeHistoryResponseListInner() {}

    public GetConvertTradeHistoryResponseListInner quoteId(
    ...
    public GetConvertTradeHistoryResponseListInner orderId(
    ...
    public GetConvertTradeHistoryResponseListInner orderStatus(
    ...
    public GetConvertTradeHistoryResponseListInner fromAsset(
    ...
    public GetConvertTradeHistoryResponseListInner fromAmount(
    ...
    public GetConvertTradeHistoryResponseListInner toAsset(
    ...
    public GetConvertTradeHistoryResponseListInner toAmount(
    ...
    public GetConvertTradeHistoryResponseListInner ratio(
            @jakarta.annotation.Nullable String ratio) {
        this.ratio = ratio;
        return this;
    }
    ...
    public GetConvertTradeHistoryResponseListInner inverseRatio(
    ...
    public GetConvertTradeHistoryResponseListInner createTime(
    ...
    public boolean equals(Object o) {
        ...
        GetConvertTradeHistoryResponseListInner getConvertTradeHistoryResponseListInner =
                (GetConvertTradeHistoryResponseListInner) o;
        return Objects.equals(this.quoteId, getConvertTradeHistoryResponseListInner.quoteId)
                && Objects.equals(this.orderId, getConvertTradeHistoryResponseListInner.orderId)
                && Objects.equals(
                        this.orderStatus, getConvertTradeHistoryResponseListInner.orderStatus)
                && Objects.equals(this.fromAsset, getConvertTradeHistoryResponseListInner.fromAsset)
                && Objects.equals(
                        this.fromAmount, getConvertTradeHistoryResponseListInner.fromAmount)
                && Objects.equals(this.toAsset, getConvertTradeHistoryResponseListInner.toAsset)
                && Objects.equals(this.toAmount, getConvertTradeHistoryResponseListInner.toAmount)
                && Objects.equals(this.ratio, getConvertTradeHistoryResponseListInner.ratio)
                && Objects.equals(
                        this.inverseRatio, getConvertTradeHistoryResponseListInner.inverseRatio)
                && Objects.equals(
                        this.createTime, getConvertTradeHistoryResponseListInner.createTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetConvertTradeHistoryResponseListInner {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetConvertTradeHistoryResponseListInner.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                    + " GetConvertTradeHistoryResponseListInner is not found in the"
                                    + " empty JSON string",
                                GetConvertTradeHistoryResponseListInner.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetConvertTradeHistoryResponseListInner.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes 'GetConvertTradeHistoryResponseListInner'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetConvertTradeHistoryResponseListInner> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(GetConvertTradeHistoryResponseListInner.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetConvertTradeHistoryResponseListInner>() {
                        @Override
                        public void write(
                        ...
                        @Override
                        public GetConvertTradeHistoryResponseListInner read(JsonReader in)
                                throws IOException {
    ...
    /**
     * Create an instance of GetConvertTradeHistoryResponseListInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetConvertTradeHistoryResponseListInner
     * @throws IOException if the JSON string is invalid with respect to
     *     GetConvertTradeHistoryResponseListInner
     */
    public static GetConvertTradeHistoryResponseListInner fromJson(String jsonString)
            throws IOException {
        return JSON.getGson().fromJson(jsonString, GetConvertTradeHistoryResponseListInner.class);
    }

    /**
     * Convert an instance of GetConvertTradeHistoryResponseListInner to an JSON string
     *
     * @return JSON string
     */
